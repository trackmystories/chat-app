 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */Cn(XC,ZC,"app");const eb={apiKey:"AIzaSyBIl-7WJ3mpH-ki6AcahjdSQpQSzp3G2RQ",authDomain:"chat-app-vue-9ca58.firebaseapp.com",projectId:"chat-app-vue-9ca58",storageBucket:"chat-app-vue-9ca58.appspot.com",messagingSenderId:"787531609366",appId:"1:787531609366:web:fc31d70b02c3cd25cdcc37"},ry=Qp(eb),tb=Sp("user",{state:()=>({email:"",password:"",username:"",isSignUp:!1,isGuest:!1}),actions:{updateEmail(t){this.email=t},updatePassword(t){this.password=t},updateUsername(t){this.username=t},toggleSignUp(){this.isSignUp=!this.isSignUp},async signInAsGuest(){const t=Br(ry);try{await yg(t),this.isGuest=!0}catch(e){console.error("Guest login error:",e),this.isGuest=!1}}}}),nb={name:"LoginView",setup(){const t=Up(),e=Br(ry),n=tb();return{handleSubmit:async()=>{try{if(n.isSignUp){const i=await cA(e,n.email,n.password),o=Mo(oo(),"users",i.user.uid);await $C(o,{username:n.username})}else await lA(e,n.email,n.password);t.push("/chat")}catch(i){console.error("Authentication error:",i)}},handleGuestLogin:async()=>{try{await yg(e),t.push("/chat")}catch(i){console.error("Guest login error:",i)}},userStore:n}}},rb={id:"login"},sb=Re("h1",null,"WELCOME TO CHAT APP",-1),ib={key:0},ob={key:1,type:"submit"},ab={key:2,type:"submit"};function cb(t,e,n,r,s,i){return st(),gt("div",rb,[sb,Re("form",{onSubmit:e[5]||(e[5]=Ip((...o)=>r.handleSubmit&&r.handleSubmit(...o),["prevent"]))},[r.userStore.isSignUp?(st(),gt("div",ib,[Gi(Re("input",{placeholder:"username",type:"text",id:"username","onUpdate:modelValue":e[0]||(e[0]=o=>r.userStore.username=o),required:""},null,512),[[Xi,r.userStore.username]])])):As("",!0),Re("div",null,[Gi(Re("input",{placeholder:"email",type:"email",id:"email","onUpdate:modelValue":e[1]||(e[1]=o=>r.userStore.email=o),required:""},null,512),[[Xi,r.userStore.email]])]),Re("div",null,[Gi(Re("input",{placeholder:"password",type:"password",id:"password","onUpdate:modelValue":e[2]||(e[2]=o=>r.userStore.password=o),required:""},null,512),[[Xi,r.userStore.password]])]),r.userStore.isSignUp?As("",!0):(st(),gt("button",ob,"Login")),r.userStore.isSignUp?(st(),gt("button",ab,"Sign Up")):As("",!0),Re("button",{onClick:e[3]||(e[3]=(...o)=>r.userStore.toggleSignUp&&r.userStore.toggleSignUp(...o))},er(r.userStore.isSignUp?"Already have an account? Login":"Need an account? Sign Up"),1),Re("button",{onClick:e[4]||(e[4]=(...o)=>r.handleGuestLogin&&r.handleGuestLogin(...o))},"Login as Guest")],32)])}const lb=ia(nb,[["render",cb]]),ub=[{path:"/chat",name:"chat",component:JC,meta:{requiresAuth:!0}},{path:"/login",name:"login",component:lb},{path:"/",redirect:"/login"}],sy=OI({history:QE("/chat-app/"),routes:ub});sy.beforeEach((t,e,n)=>{const r=t.matched.some(i=>i.meta.requiresAuth),s=Br();Ul(s,i=>{r&&!i?n("/login"):!r&&i?n("/chat"):n()})});const qu=wE(NI);qu.use(SE());qu.use(sy);qu.mount("#app");
