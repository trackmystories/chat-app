...
* @license MIT
**/function cl(t,e){const n=new Set(t.split(","));return e?r=>n.has(r.toLowerCase()):r=>n.has(r)}const ve={},Pr=[],wt=()=>{},oy=()=>!1,Fo=t=>t.charCodeAt(0)===111&&t.charCodeAt(1)===110&&(t.charCodeAt(2)>122||t.charCodeAt(2)<97),ll=t=>t.startsWith("onUpdate:"),Ke=Object.assign,ul=(t,e)=>{const n=t.indexOf(e);n>-1&&t.splice(n,1)},ay=Object.prototype.hasOwnProperty,oe=(t,e)=>ay.call(t,e),W=Array.isArray,Cr=t=>Uo(t)==="[object Map]",vf=t=>Uo(t)==="[object Set]",X=t=>typeof t=="function",Ve=t=>typeof t=="string",Jr=t=>typeof t=="symbol",Re=t=>t!==null&&typeof t=="object",Ef=t=>(Re(t)||X(t))&&X(t.then)&&X(t.catch),If=Object.prototype.toString,Uo=t=>If.call(t),cy=t=>Uo(t).slice(8,-1),wf=t=>Uo(t)==="[object Object]",hl=t=>Ve(t)&&t!=="NaN"&&t[0]!=="-"&&""+parseInt(t,10)===t,Ki=cl(",key,ref,ref_for,ref_key,onVnodeBeforeMount,onVnodeMounted,onVnodeBeforeUpdate,onVnodeUpdated,onVnodeBeforeUnmount,onVnodeUnmounted"),Bo=t=>{const e=Object.create(null);return n=>e[n]||(e[n]=t(n))},ly=/-(\w)/g,Mr=Bo(t=>t.replace(ly,(e,n)=>n?n.toUpperCase():"")),uy=/\B([A-Z])/g,Xr=Bo(t=>t.replace(uy,"-$1").toLowerCase()),Tf=Bo(t=>t.charAt(0).toUpperCase()+t.slice(1)),Na=Bo(t=>t?`on${Tf(t)}`:""),Dn=(t,e)=>!Object.is(t,e),Wi=(t,e)=>{for(let n=0;n<t.length;n++)t[n](e)},co=(t,e,n)=>{Object.defineProperty(t,e,{configurable:!0,enumerable:!1,value:n})},hc=t=>{const e=parseFloat(t);return isNaN(e)?t:e};let Qu;const Af=()=>Qu||(Qu=typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{});function dl(t){if(W(t)){const e={};for(let n=0;n<t.length;n++){const r=t[n],s=Ve(r)?py(r):dl(r);if(s)for(const i in s)e[i]=s[i]}return e}else if(Ve(t)||Re(t))return t}const hy=/;(?![^(]*\))/g,dy=/:([^]+)/,fy=/\/\*[^]*?\*\//g;function py(t){const e={};return t.replace(fy,"").split(hy).forEach(n=>{if(n){const r=n.split(dy);r.length>1&&(e[r[0].trim()]=r[1].trim())}}),e}function oi(t){let e="";if(Ve(t))e=t;else if(W(t))for(let n=0;n<t.length;n++){const r=oi(t[n]);r&&(e+=r+" ")}else if(Re(t))for(const n in t)t[n]&&(e+=n+" ");return e.trim()}const gy="itemscope,allowfullscreen,formnovalidate,ismap,nomodule,novalidate,readonly",my=cl(gy);function Rf(t){return!!t||t===""}const Zt=t=>Ve(t)?t:t==null?"":W(t)||Re(t)&&(t.toString===If||!X(t.toString))?JSON.stringify(t,Sf,2):String(t),Sf=(t,e)=>e&&e.__v_isRef?Sf(t,e.value):Cr(e)?{[`Map(${e.size})`]:[...e.entries()].reduce((n,[r,s],i)=>(n[Ma(r,i)+" =>"]=s,n),{})}:vf(e)?{[`Set(${e.size})`]:[...e.values()].map(n=>Ma(n))}:Jr(e)?Ma(e):Re(e)&&!W(e)&&!wf(e)?String(e):e,Ma=(t,e="")=>{var n;return Jr(t)?`Symbol(${(n=t.description)!=null?n:e})`:t};/**
* @vue/reactivity v3.4.15
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/let gt;class Pf{constructor(e=!1){this.detached=e,this._active=!0,this.effects=[],this.cleanups=[],this.parent=gt,!e&&gt&&(this.index=(gt.scopes||(gt.scopes=[])).push(this)-1)}get active(){return this._active}run(e){if(this._active){const n=gt;try{return gt=this,e()}finally{gt=n}}}on(){gt=this}off(){gt=this.parent}stop(e){if(this._active){let n,r;for(n=0,r=this.effects.length;n<r;n++)this.effects[n].stop();for(n=0,r=this.cleanups.length;n<r;n++)this.cleanups[n]();if(this.scopes)for(n=0,r=this.scopes.length;n<r;n++)this.scopes[n].stop(!0);if(!this.detached&&this.parent&&!e){const s=this.parent.scopes.pop();s&&s!==this&&(this.parent.scopes[this.index]=s,s.index=this.index)}this.parent=void 0,this._active=!1}}}function Cf(t){return new Pf(t)}function _y(t,e=gt){e&&e.active&&e.effects.push(t)}function bf(){return gt}function yy(t){gt&&gt.cleanups.push(t)}let Jn;class fl{constructor(e,n,r,s){this.fn=e,this.trigger=n,this.scheduler=r,this.active=!0,this.deps=[],this._dirtyLevel=2,this._trackId=0,this._runnings=0,this._shouldSchedule=!1,this._depsLength=0,_y(this,s)}get dirty(){if(this._dirtyLevel===1){cr();for(let e=0;e<this._depsLength;e++){const n=this.deps[e];if(n.computed&&(vy(n.computed),this._dirtyLevel>=2))break}this._dirtyLevel<2&&(this._dirtyLevel=0),lr()}return this._dirtyLevel>=2}set dirty(e){this._dirtyLevel=e?2:0}run(){if(this._dirtyLevel=0,!this.active)return this.fn();let e=An,n=Jn;try{return An=!0,Jn=this,this._runnings++,Yu(this),this.fn()}finally{Ju(this),this._runnings--,Jn=n,An=e}}stop(){var e;this.active&&(Yu(this),Ju(this),(e=this.onStop)==null||e.call(this),this.active=!1)}}function vy(t){return t.value}function Yu(t){t._trackId++,t._depsLength=0}function Ju(t){if(t.deps&&t.deps.length>t._depsLength){for(let e=t._depsLength;e<t.deps.length;e++)kf(t.deps[e],t);t.deps.length=t._depsLength}}function kf(t,e){const n=t.get(e);n!==void 0&&e._trackId!==n&&(t.delete(e),t.size===0&&t.cleanup())}let An=!0,dc=0;const Df=[];function cr(){Df.push(An),An=!1}function lr(){const t=Df.pop();An=t===void 0?!0:t}function pl(){dc++}function gl(){for(dc--;!dc&&fc.length;)fc.shift()()}function Of(t,e,n){if(e.get(t)!==t._trackId){e.set(t,t._trackId);const r=t.deps[t._depsLength];r!==e?(r&&kf(r,t),t.deps[t._depsLength++]=e):t._depsLength++}}const fc=[];function Vf(t,e,n){pl();for(const r of t.keys())if(r._dirtyLevel<e&&t.get(r)===r._trackId){const s=r._dirtyLevel;r._dirtyLevel=e,s===0&&(r._shouldSchedule=!0,r.trigger())}Nf(t),gl()}function Nf(t){for(const e of t.keys())e.scheduler&&e._shouldSchedule&&(!e._runnings||e.allowRecurse)&&t.get(e)===e._trackId&&(e._shouldSchedule=!1,fc.push(e.scheduler))}const Mf=(t,e)=>{const n=new Map;return n.cleanup=t,n.computed=e,n},lo=new WeakMap,Xn=Symbol(""),pc=Symbol("");function dt(t,e,n){if(An&&Jn){let r=lo.get(t);r||lo.set(t,r=new Map);let s=r.get(n);s||r.set(n,s=Mf(()=>r.delete(n))),Of(Jn,s)}}function en(t,e,n,r,s,i){const o=lo.get(t);if(!o)return;let a=[];if(e==="clear")a=[...o.values()];else if(n==="length"&&W(t)){const c=Number(r);o.forEach((l,u)=>{(u==="length"||!Jr(u)&&u>=c)&&a.push(l)})}else switch(n!==void 0&&a.push(o.get(n)),e){case"add":W(t)?hl(n)&&a.push(o.get("length")):(a.push(o.get(Xn)),Cr(t)&&a.push(o.get(pc)));break;case"delete":W(t)||(a.push(o.get(Xn)),Cr(t)&&a.push(o.get(pc)));break;case"set":Cr(t)&&a.push(o.get(Xn));break}pl();for(const c of a)c&&Vf(c,2);gl()}function Ey(t,e){var n;return(n=lo.get(t))==null?void 0:n.get(e)}const Iy=cl("__proto__,__v_isRef,__isVue"),xf=new Set(Object.getOwnPropertyNames(Symbol).filter(t=>t!=="arguments"&&t!=="caller").map(t=>Symbol[t]).filter(Jr)),Xu=wy();function wy(){const t={};return["includes","indexOf","lastIndexOf"].forEach(e=>{t[e]=function(...n){const r=ae(this);for(let i=0,o=this.length;i<o;i++)dt(r,"get",i+"");const s=r[e](...n);return s===-1||s===!1?r[e](...n.map(ae)):s}}),["push","pop","shift","unshift","splice"].forEach(e=>{t[e]=function(...n){cr(),pl();const r=ae(this)[e].apply(this,n);return gl(),lr(),r}}),t}function Ty(t){const e=ae(this);return dt(e,"has",t),e.hasOwnProperty(t)}class Lf{constructor(e=!1,n=!1){this._isReadonly=e,this._shallow=n}get(e,n,r){const s=this._isReadonly,i=this._shallow;if(n==="__v_isReactive")return!s;if(n==="__v_isReadonly")return s;if(n==="__v_isShallow")return i;if(n==="__v_raw")return r===(s?i?xy:jf:i?Bf:Uf).get(e)||Object.getPrototypeOf(e)===Object.getPrototypeOf(r)?e:void 0;const o=W(e);if(!s){if(o&&oe(Xu,n))return Reflect.get(Xu,n,r);if(n==="hasOwnProperty")return Ty}const a=Reflect.get(e,n,r);return(Jr(n)?xf.has(n):Iy(n))||(s||dt(e,"get",n),i)?a:Ne(a)?o&&hl(n)?a:a.value:Re(a)?s?qf(a):ai(a):a}}class Ff extends Lf{constructor(e=!1){super(!1,e)}set(e,n,r,s){let i=e[n];if(!this._shallow){const c=xr(i);if(!uo(r)&&!xr(r)&&(i=ae(i),r=ae(r)),!W(e)&&Ne(i)&&!Ne(r))return c?!1:(i.value=r,!0)}const o=W(e)&&hl(n)?Number(n)<e.length:oe(e,n),a=Reflect.set(e,n,r,s);return e===ae(s)&&(o?Dn(r,i)&&en(e,"set",n,r):en(e,"add",n,r)),a}deleteProperty(e,n){const r=oe(e,n);e[n];const s=Reflect.deleteProperty(e,n);return s&&r&&en(e,"delete",n,void 0),s}has(e,n){const r=Reflect.has(e,n);return(!Jr(n)||!xf.has(n))&&dt(e,"has",n),r}ownKeys(e){return dt(e,"iterate",W(e)?"length":Xn),Reflect.ownKeys(e)}}class Ay extends Lf{constructor(e=!1){super(!0,e)}set(e,n){return!0}deleteProperty(e,n){return!0}}const Ry=new Ff,Sy=new Ay,Py=new Ff(!0),ml=t=>t,jo=t=>Reflect.getPrototypeOf(t);function ki(t,e,n=!1,r=!1){t=t.__v_raw;const s=ae(t),i=ae(e);n||(Dn(e,i)&&dt(s,"get",e),dt(s,"get",i));const{has:o}=jo(s),a=r?ml:n?vl:Ms;if(o.call(s,e))return a(t.get(e));if(o.call(s,i))return a(t.get(i));t!==s&&t.get(e)}function Di(t,e=!1){const n=this.__v_raw,r=ae(n),s=ae(t);return e||(Dn(t,s)&&dt(r,"has",t),dt(r,"has",s)),t===s?n.has(t):n.has(t)||n.has(s)}function Oi(t,e=!1){return t=t.__v_raw,!e&&dt(ae(t),"iterate",Xn),Reflect.get(t,"size",t)}function Zu(t){t=ae(t);const e=ae(this);return jo(e).has.call(e,t)||(e.add(t),en(e,"add",t,t)),this}function eh(t,e){e=ae(e);const n=ae(this),{has:r,get:s}=jo(n);let i=r.call(n,t);i||(t=ae(t),i=r.call(n,t));const o=s.call(n,t);return n.set(t,e),i?Dn(e,o)&&en(n,"set",t,e):en(n,"add",t,e),this}function th(t){const e=ae(this),{has:n,get:r}=jo(e);let s=n.call(e,t);s||(t=ae(t),s=n.call(e,t)),r&&r.call(e,t);const i=e.delete(t);return s&&en(e,"delete",t,void 0),i}function nh(){const t=ae(this),e=t.size!==0,n=t.clear();return e&&en(t,"clear",void 0,void 0),n}function Vi(t,e){return function(r,s){const i=this,o=i.__v_raw,a=ae(o),c=e?ml:t?vl:Ms;return!t&&dt(a,"iterate",Xn),o.forEach((l,u)=>r.call(s,c(l),c(u),i))}}function Ni(t,e,n){return function(...r){const s=this.__v_raw,i=ae(s),o=Cr(i),a=t==="entries"||t===Symbol.iterator&&o,c=t==="keys"&&o,l=s[t](...r),u=n?ml:e?vl:Ms;return!e&&dt(i,"iterate",c?pc:Xn),{next(){const{value:h,done:d}=l.next();return d?{value:h,done:d}:{value:a?[u(h[0]),u(h[1])]:u(h),done:d}},[Symbol.iterator](){return this}}}}function hn(t){return function(...e){return t==="delete"?!1:t==="clear"?void 0:this}}function Cy(){const t={get(i){return ki(this,i)},get size(){return Oi(this)},has:Di,add:Zu,set:eh,delete:th,clear:nh,forEach:Vi(!1,!1)},e={get(i){return ki(this,i,!1,!0)},get size(){return Oi(this)},has:Di,add:Zu,set:eh,delete:th,clear:nh,forEach:Vi(!1,!0)},n={get(i){return ki(this,i,!0)},get size(){return Oi(this,!0)},has(i){return Di.call(this,i,!0)},add:hn("add"),set:hn("set"),delete:hn("delete"),clear:hn("clear"),forEach:Vi(!0,!1)},r={get(i){return ki(this,i,!0,!0)},get size(){return Oi(this,!0)},has(i){return Di.call(this,i,!0)},add:hn("add"),set:hn("set"),delete:hn("delete"),clear:hn("clear"),forEach:Vi(!0,!0)};return["keys","values","entries",Symbol.iterator].forEach(i=>{t[i]=Ni(i,!1,!1),n[i]=Ni(i,!0,!1),e[i]=Ni(i,!1,!0),r[i]=Ni(i,!0,!0)}),[t,n,e,r]}const[by,ky,Dy,Oy]=Cy();function _l(t,e){const n=e?t?Oy:Dy:t?ky:by;return(r,s,i)=>s==="__v_isReactive"?!t:s==="__v_isReadonly"?t:s==="__v_raw"?r:Reflect.get(oe(n,s)&&s in r?n:r,s,i)}const Vy={get:_l(!1,!1)},Ny={get:_l(!1,!0)},My={get:_l(!0,!1)},Uf=new WeakMap,Bf=new WeakMap,jf=new WeakMap,xy=new WeakMap;function Ly(t){switch(t){case"Object":case"Array":return 1;case"Map":case"Set":case"WeakMap":case"WeakSet":return 2;default:return 0}}function Fy(t){return t.__v_skip||!Object.isExtensible(t)?0:Ly(cy(t))}function ai(t){return xr(t)?t:yl(t,!1,Ry,Vy,Uf)}function $f(t){return yl(t,!1,Py,Ny,Bf)}function qf(t){return yl(t,!0,Sy,My,jf)}function yl(t,e,n,r,s){if(!Re(t)||t.__v_raw&&!(e&&t.__v_isReactive))return t;const i=s.get(t);if(i)return i;const o=Fy(t);if(o===0)return t;const a=new Proxy(t,o===2?r:n);return s.set(t,a),a}function Rn(t){return xr(t)?Rn(t.__v_raw):!!(t&&t.__v_isReactive)}function xr(t){return!!(t&&t.__v_isReadonly)}function uo(t){return!!(t&&t.__v_isShallow)}function Hf(t){return Rn(t)||xr(t)}function ae(t){const e=t&&t.__v_raw;return e?ae(e):t}function $o(t){return co(t,"__v_skip",!0),t}const Ms=t=>Re(t)?ai(t):t,vl=t=>Re(t)?qf(t):t;class Kf{constructor(e,n,r,s){this._setter=n,this.dep=void 0,this.__v_isRef=!0,this.__v_isReadonly=!1,this.effect=new fl(()=>e(this._value),()=>zi(this,1),()=>this.dep&&Nf(this.dep)),this.effect.computed=this,this.effect.active=this._cacheable=!s,this.__v_isReadonly=r}get value(){const e=ae(this);return(!e._cacheable||e.effect.dirty)&&Dn(e._value,e._value=e.effect.run())&&zi(e,2),Wf(e),e.effect._dirtyLevel>=1&&zi(e,1),e._value}set value(e){this._setter(e)}get _dirty(){return this.effect.dirty}set _dirty(e){this.effect.dirty=e}}function Uy(t,e,n=!1){let r,s;const i=X(t);return i?(r=t,s=wt):(r=t.get,s=t.set),new Kf(r,s,i||!s,n)}function Wf(t){An&&Jn&&(t=ae(t),Of(Jn,t.dep||(t.dep=Mf(()=>t.dep=void 0,t instanceof Kf?t:void 0))))}function zi(t,e=2,n){t=ae(t);const r=t.dep;r&&Vf(r,e)}function Ne(t){return!!(t&&t.__v_isRef===!0)}function qo(t){return zf(t,!1)}function By(t){return zf(t,!0)}function zf(t,e){return Ne(t)?t:new jy(t,e)}class jy{constructor(e,n){this.__v_isShallow=n,this.dep=void 0,this.__v_isRef=!0,this._rawValue=n?e:ae(e),this._value=n?e:Ms(e)}get value(){return Wf(this),this._value}set value(e){const n=this.__v_isShallow||uo(e)||xr(e);e=n?e:ae(e),Dn(e,this._rawValue)&&(this._rawValue=e,this._value=n?e:Ms(e),zi(this,2))}}function xe(t){return Ne(t)?t.value:t}const $y={get:(t,e,n)=>xe(Reflect.get(t,e,n)),set:(t,e,n,r)=>{const s=t[e];return Ne(s)&&!Ne(n)?(s.value=n,!0):Reflect.set(t,e,n,r)}};function Gf(t){return Rn(t)?t:new Proxy(t,$y)}function qy(t){const e=W(t)?new Array(t.length):{};for(const n in t)e[n]=Ky(t,n);return e}class Hy{constructor(e,n,r){this._object=e,this._key=n,this._defaultValue=r,this.__v_isRef=!0}get value(){const e=this._object[this._key];return e===void 0?this._defaultValue:e}set value(e){this._object[this._key]=e}get dep(){return Ey(ae(this._object),this._key)}}function Ky(t,e,n){const r=t[e];return Ne(r)?r:new Hy(t,e,n)}/**
* @vue/runtime-core v3.4.15
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/function Sn(t,e,n,r){let s;try{s=r?t(...r):t()}catch(i){Ho(i,e,n)}return s}function Pt(t,e,n,r){if(X(t)){const i=Sn(t,e,n,r);return i&&Ef(i)&&i.catch(o=>{Ho(o,e,n)}),i}const s=[];for(let i=0;i<t.length;i++)s.push(Pt(t[i],e,n,r));return s}function Ho(t,e,n,r=!0){const s=e?e.vnode:null;if(e){let i=e.parent;const o=e.proxy,a=`https://vuejs.org/error-reference/#runtime-${n}`;for(;i;){const l=i.ec;if(l){for(let u=0;u<l.length;u++)if(l[u](t,o,a)===!1)return}i=i.parent}const c=e.appContext.config.errorHandler;if(c){Sn(c,null,10,[t,o,a]);return}}Wy(t,n,s,r)}function Wy(t,e,n,r=!0){console.error(t)}let xs=!1,gc=!1;const Je=[];let Lt=0;const br=[];let gn=null,Hn=0;const Qf=Promise.resolve();let El=null;function Il(t){const e=El||Qf;return t?e.then(this?t.bind(this):t):e}function zy(t){let e=Lt+1,n=Je.length;for(;e<n;){const r=e+n>>>1,s=Je[r],i=Ls(s);i<t||i===t&&s.pre?e=r+1:n=r}return e}function wl(t){(!Je.length||!Je.includes(t,xs&&t.allowRecurse?Lt+1:Lt))&&(t.id==null?Je.push(t):Je.splice(zy(t.id),0,t),Yf())}function Yf(){!xs&&!gc&&(gc=!0,El=Qf.then(Xf))}function Gy(t){const e=Je.indexOf(t);e>Lt&&Je.splice(e,1)}function Qy(t){W(t)?br.push(...t):(!gn||!gn.includes(t,t.allowRecurse?Hn+1:Hn))&&br.push(t),Yf()}function rh(t,e,n=xs?Lt+1:0){for(;n<Je.length;n++){const r=Je[n];if(r&&r.pre){if(t&&r.id!==t.uid)continue;Je.splice(n,1),n--,r()}}}function Jf(t){if(br.length){const e=[...new Set(br)].sort((n,r)=>Ls(n)-Ls(r));if(br.length=0,gn){gn.push(...e);return}for(gn=e,Hn=0;Hn<gn.length;Hn++)gn[Hn]();gn=null,Hn=0}}const Ls=t=>t.id==null?1/0:t.id,Yy=(t,e)=>{const n=Ls(t)-Ls(e);if(n===0){if(t.pre&&!e.pre)return-1;if(e.pre&&!t.pre)return 1}return n};function Xf(t){gc=!1,xs=!0,Je.sort(Yy);try{for(Lt=0;Lt<Je.length;Lt++){const e=Je[Lt];e&&e.active!==!1&&Sn(e,null,14)}}finally{Lt=0,Je.length=0,Jf(),xs=!1,El=null,(Je.length||br.length)&&Xf()}}function Jy(t,e,...n){if(t.isUnmounted)return;const r=t.vnode.props||ve;let s=n;const i=e.startsWith("update:"),o=i&&e.slice(7);if(o&&o in r){const u=`${o==="modelValue"?"model":o}Modifiers`,{number:h,trim:d}=r[u]||ve;d&&(s=n.map(g=>Ve(g)?g.trim():g)),h&&(s=n.map(hc))}let a,c=r[a=Na(e)]||r[a=Na(Mr(e))];!c&&i&&(c=r[a=Na(Xr(e))]),c&&Pt(c,t,6,s);const l=r[a+"Once"];if(l){if(!t.emitted)t.emitted={};else if(t.emitted[a])return;t.emitted[a]=!0,Pt(l,t,6,s)}}function Zf(t,e,n=!1){const r=e.emitsCache,s=r.get(t);if(s!==void 0)return s;const i=t.emits;let o={},a=!1;if(!X(t)){const c=l=>{const u=Zf(l,e,!0);u&&(a=!0,Ke(o,u))};!n&&e.mixins.length&&e.mixins.forEach(c),t.extends&&c(t.extends),t.mixins&&t.mixins.forEach(c)}return!i&&!a?(Re(t)&&r.set(t,null),null):(W(i)?i.forEach(c=>o[c]=null):Ke(o,i),Re(t)&&r.set(t,o),o)}function Ko(t,e){return!t||!Fo(e)?!1:(e=e.slice(2).replace(/Once$/,""),oe(t,e[0].toLowerCase()+e.slice(1))||oe(t,Xr(e))||oe(t,e))}let ht=null,Wo=null;function ho(t){const e=ht;return ht=t,Wo=t&&t.type.__scopeId||null,e}function Tl(t){Wo=t}function Al(){Wo=null}function Xy(t,e=ht,n){if(!e||t._n)return t;const r=(...s)=>{r._d&&fh(-1);const i=ho(e);let o;try{o=t(...s)}finally{ho(i),r._d&&fh(1)}return o};return r._n=!0,r._c=!0,r._d=!0,r}function xa(t){const{type:e,vnode:n,proxy:r,withProxy:s,props:i,propsOptions:[o],slots:a,attrs:c,emit:l,render:u,renderCache:h,data:d,setupState:g,ctx:E,inheritAttrs:R}=t;let T,P;const M=ho(t);try{if(n.shapeFlag&4){const z=s||r,Z=z;T=xt(u.call(Z,z,h,i,g,d,E)),P=c}else{const z=e;T=xt(z.length>1?z(i,{attrs:c,slots:a,emit:l}):z(i,null)),P=e.props?c:Zy(c)}}catch(z){As.length=0,Ho(z,t,1),T=it(tr)}let F=T;if(P&&R!==!1){const z=Object.keys(P),{shapeFlag:Z}=F;z.length&&Z&7&&(o&&z.some(ll)&&(P=ev(P,o)),F=Lr(F,P))}return n.dirs&&(F=Lr(F),F.dirs=F.dirs?F.dirs.concat(n.dirs):n.dirs),n.transition&&(F.transition=n.transition),T=F,ho(M),T}const Zy=t=>{let e;for(const n in t)(n==="class"||n==="style"||Fo(n))&&((e||(e={}))[n]=t[n]);return e},ev=(t,e)=>{const n={};for(const r in t)(!ll(r)||!(r.slice(9)in e))&&(n[r]=t[r]);return n};function tv(t,e,n){const{props:r,children:s,component:i}=t,{props:o,children:a,patchFlag:c}=e,l=i.emitsOptions;if(e.dirs||e.transition)return!0;if(n&&c>=0){if(c&1024)return!0;if(c&16)return r?sh(r,o,l):!!o;if(c&8){const u=e.dynamicProps;for(let h=0;h<u.length;h++){const d=u[h];if(o[d]!==r[d]&&!Ko(l,d))return!0}}}else return(s||a)&&(!a||!a.$stable)?!0:r===o?!1:r?o?sh(r,o,l):!0:!!o;return!1}function sh(t,e,n){const r=Object.keys(e);if(r.length!==Object.keys(t).length)return!0;for(let s=0;s<r.length;s++){const i=r[s];if(e[i]!==t[i]&&!Ko(n,i))return!0}return!1}function nv({vnode:t,parent:e},n){for(;e;){const r=e.subTree;if(r.suspense&&r.suspense.activeBranch===t&&(r.el=t.el),r===t)(t=e.vnode).el=n,e=e.parent;else break}}const rv=Symbol.for("v-ndc"),sv=t=>t.__isSuspense;function iv(t,e){e&&e.pendingBranch?W(t)?e.effects.push(...t):e.effects.push(t):Qy(t)}const ov=Symbol.for("v-scx"),av=()=>Ct(ov),Mi={};function ws(t,e,n){return ep(t,e,n)}function ep(t,e,{immediate:n,deep:r,flush:s,once:i,onTrack:o,onTrigger:a}=ve){if(e&&i){const $=e;e=(...de)=>{$(...de),Z()}}const c=Ze,l=$=>r===!0?$:Wn($,r===!1?1:void 0);let u,h=!1,d=!1;if(Ne(t)?(u=()=>t.value,h=uo(t)):Rn(t)?(u=()=>l(t),h=!0):W(t)?(d=!0,h=t.some($=>Rn($)||uo($)),u=()=>t.map($=>{if(Ne($))return $.value;if(Rn($))return l($);if(X($))return Sn($,c,2)})):X(t)?e?u=()=>Sn(t,c,2):u=()=>(g&&g(),Pt(t,c,3,[E])):u=wt,e&&r){const $=u;u=()=>Wn($())}let g,E=$=>{g=F.onStop=()=>{Sn($,c,4),g=F.onStop=void 0}},R;if(Yo)if(E=wt,e?n&&Pt(e,c,3,[u(),d?[]:void 0,E]):u(),s==="sync"){const $=av();R=$.__watcherHandles||($.__watcherHandles=[])}else return wt;let T=d?new Array(t.length).fill(Mi):Mi;const P=()=>{if(!(!F.active||!F.dirty))if(e){const $=F.run();(r||h||(d?$.some((de,te)=>Dn(de,T[te])):Dn($,T)))&&(g&&g(),Pt(e,c,3,[$,T===Mi?void 0:d&&T[0]===Mi?[]:T,E]),T=$)}else F.run()};P.allowRecurse=!!e;let M;s==="sync"?M=P:s==="post"?M=()=>lt(P,c&&c.suspense):(P.pre=!0,c&&(P.id=c.uid),M=()=>wl(P));const F=new fl(u,wt,M),z=bf(),Z=()=>{F.stop(),z&&ul(z.effects,F)};return e?n?P():T=F.run():s==="post"?lt(F.run.bind(F),c&&c.suspense):F.run(),R&&R.push(Z),Z}function cv(t,e,n){const r=this.proxy,s=Ve(t)?t.includes(".")?tp(r,t):()=>r[t]:t.bind(r,r);let i;X(e)?i=e:(i=e.handler,n=e);const o=ci(this),a=ep(s,i.bind(r),n);return o(),a}function tp(t,e){const n=e.split(".");return()=>{let r=t;for(let s=0;s<n.length&&r;s++)r=r[n[s]];return r}}function Wn(t,e,n=0,r){if(!Re(t)||t.__v_skip)return t;if(e&&e>0){if(n>=e)return t;n++}if(r=r||new Set,r.has(t))return t;if(r.add(t),Ne(t))Wn(t.value,e,n,r);else if(W(t))for(let s=0;s<t.length;s++)Wn(t[s],e,n,r);else if(vf(t)||Cr(t))t.forEach(s=>{Wn(s,e,n,r)});else if(wf(t))for(const s in t)Wn(t[s],e,n,r);return t}function Gi(t,e){if(ht===null)return t;const n=Jo(ht)||ht.proxy,r=t.dirs||(t.dirs=[]);for(let s=0;s<e.length;s++){let[i,o,a,c=ve]=e[s];i&&(X(i)&&(i={mounted:i,updated:i}),i.deep&&Wn(o),r.push({dir:i,instance:n,value:o,oldValue:void 0,arg:a,modifiers:c}))}return t}function jn(t,e,n,r){const s=t.dirs,i=e&&e.dirs;for(let o=0;o<s.length;o++){const a=s[o];i&&(a.oldValue=i[o].value);let c=a.dir[r];c&&(cr(),Pt(c,n,8,[t.el,a,t,e]),lr())}}/*! #__NO_SIDE_EFFECTS__ */function Rl(t,e){return X(t)?Ke({name:t.name},e,{setup:t}):t}const Qi=t=>!!t.type.__asyncLoader,np=t=>t.type.__isKeepAlive;function lv(t,e){rp(t,"a",e)}function uv(t,e){rp(t,"da",e)}function rp(t,e,n=Ze){const r=t.__wdc||(t.__wdc=()=>{let s=n;for(;s;){if(s.isDeactivated)return;s=s.parent}return t()});if(zo(e,r,n),n){let s=n.parent;for(;s&&s.parent;)np(s.parent.vnode)&&hv(r,e,n,s),s=s.parent}}function hv(t,e,n,r){const s=zo(e,t,r,!0);Sl(()=>{ul(r[e],s)},n)}function zo(t,e,n=Ze,r=!1){if(n){const s=n[t]||(n[t]=[]),i=e.__weh||(e.__weh=(...o)=>{if(n.isUnmounted)return;cr();const a=ci(n),c=Pt(e,n,t,o);return a(),lr(),c});return r?s.unshift(i):s.push(i),i}}const cn=t=>(e,n=Ze)=>(!Yo||t==="sp")&&zo(t,(...r)=>e(...r),n),dv=cn("bm"),sp=cn("m"),fv=cn("bu"),pv=cn("u"),gv=cn("bum"),Sl=cn("um"),mv=cn("sp"),_v=cn("rtg"),yv=cn("rtc");function vv(t,e=Ze){zo("ec",t,e)}function ip(t,e,n,r){let s;const i=n&&n[r];if(W(t)||Ve(t)){s=new Array(t.length);for(let o=0,a=t.length;o<a;o++)s[o]=e(t[o],o,void 0,i&&i[o])}else if(typeof t=="number"){s=new Array(t);for(let o=0;o<t;o++)s[o]=e(o+1,o,void 0,i&&i[o])}else if(Re(t))if(t[Symbol.iterator])s=Array.from(t,(o,a)=>e(o,a,void 0,i&&i[a]));else{const o=Object.keys(t);s=new Array(o.length);for(let a=0,c=o.length;a<c;a++){const l=o[a];s[a]=e(t[l],l,a,i&&i[a])}}else s=[];return n&&(n[r]=s),s}const mc=t=>t?vp(t)?Jo(t)||t.proxy:mc(t.parent):null,Ts=Ke(Object.create(null),{$:t=>t,$el:t=>t.vnode.el,$data:t=>t.data,$props:t=>t.props,$attrs:t=>t.attrs,$slots:t=>t.slots,$refs:t=>t.refs,$parent:t=>mc(t.parent),$root:t=>mc(t.root),$emit:t=>t.emit,$options:t=>Pl(t),$forceUpdate:t=>t.f||(t.f=()=>{t.effect.dirty=!0,wl(t.update)}),$nextTick:t=>t.n||(t.n=Il.bind(t.proxy)),$watch:t=>cv.bind(t)}),La=(t,e)=>t!==ve&&!t.__isScriptSetup&&oe(t,e),Ev={get({_:t},e){const{ctx:n,setupState:r,data:s,props:i,accessCache:o,type:a,appContext:c}=t;let l;if(e[0]!=="$"){const g=o[e];if(g!==void 0)switch(g){case 1:return r[e];case 2:return s[e];case 4:return n[e];case 3:return i[e]}else{if(La(r,e))return o[e]=1,r[e];if(s!==ve&&oe(s,e))return o[e]=2,s[e];if((l=t.propsOptions[0])&&oe(l,e))return o[e]=3,i[e];if(n!==ve&&oe(n,e))return o[e]=4,n[e];_c&&(o[e]=0)}}const u=Ts[e];let h,d;if(u)return e==="$attrs"&&dt(t,"get",e),u(t);if((h=a.__cssModules)&&(h=h[e]))return h;if(n!==ve&&oe(n,e))return o[e]=4,n[e];if(d=c.config.globalProperties,oe(d,e))return d[e]},set({_:t},e,n){const{data:r,setupState:s,ctx:i}=t;return La(s,e)?(s[e]=n,!0):r!==ve&&oe(r,e)?(r[e]=n,!0):oe(t.props,e)||e[0]==="$"&&e.slice(1)in t?!1:(i[e]=n,!0)},has({_:{data:t,setupState:e,accessCache:n,ctx:r,appContext:s,propsOptions:i}},o){let a;return!!n[o]||t!==ve&&oe(t,o)||La(e,o)||(a=i[0])&&oe(a,o)||oe(r,o)||oe(Ts,o)||oe(s.config.globalProperties,o)},defineProperty(t,e,n){return n.get!=null?t._.accessCache[e]=0:oe(n,"value")&&this.set(t,e,n.value,null),Reflect.defineProperty(t,e,n)}};function ih(t){return W(t)?t.reduce((e,n)=>(e[n]=null,e),{}):t}let _c=!0;function Iv(t){const e=Pl(t),n=t.proxy,r=t.ctx;_c=!1,e.beforeCreate&&oh(e.beforeCreate,t,"bc");const{data:s,computed:i,methods:o,watch:a,provide:c,inject:l,created:u,beforeMount:h,mounted:d,beforeUpdate:g,updated:E,activated:R,deactivated:T,beforeDestroy:P,beforeUnmount:M,destroyed:F,unmounted:z,render:Z,renderTracked:$,renderTriggered:de,errorCaptured:te,serverPrefetch:ee,expose:_e,inheritAttrs:We,components:ft,directives:_t,filters:Bn}=e;if(l&&wv(l,r,null),o)for(const ge in o){const ue=o[ge];X(ue)&&(r[ge]=ue.bind(n))}if(s){const ge=s.call(n,n);Re(ge)&&(t.data=ai(ge))}if(_c=!0,i)for(const ge in i){const ue=i[ge],Gt=X(ue)?ue.bind(n,n):X(ue.get)?ue.get.bind(n,n):wt,un=!X(ue)&&X(ue.set)?ue.set.bind(n):wt,Vt=vt({get:Gt,set:un});Object.defineProperty(r,ge,{enumerable:!0,configurable:!0,get:()=>Vt.value,set:ct=>Vt.value=ct})}if(a)for(const ge in a)op(a[ge],r,n,ge);if(c){const ge=X(c)?c.call(n):c;Reflect.ownKeys(ge).forEach(ue=>{Yi(ue,ge[ue])})}u&&oh(u,t,"c");function ce(ge,ue){W(ue)?ue.forEach(Gt=>ge(Gt.bind(n))):ue&&ge(ue.bind(n))}if(ce(dv,h),ce(sp,d),ce(fv,g),ce(pv,E),ce(lv,R),ce(uv,T),ce(vv,te),ce(yv,$),ce(_v,de),ce(gv,M),ce(Sl,z),ce(mv,ee),W(_e))if(_e.length){const ge=t.exposed||(t.exposed={});_e.forEach(ue=>{Object.defineProperty(ge,ue,{get:()=>n[ue],set:Gt=>n[ue]=Gt})})}else t.exposed||(t.exposed={});Z&&t.render===wt&&(t.render=Z),We!=null&&(t.inheritAttrs=We),ft&&(t.components=ft),_t&&(t.directives=_t)}function wv(t,e,n=wt){W(t)&&(t=yc(t));for(const r in t){const s=t[r];let i;Re(s)?"default"in s?i=Ct(s.from||r,s.default,!0):i=Ct(s.from||r):i=Ct(s),Ne(i)?Object.defineProperty(e,r,{enumerable:!0,configurable:!0,get:()=>i.value,set:o=>i.value=o}):e[r]=i}}function oh(t,e,n){Pt(W(t)?t.map(r=>r.bind(e.proxy)):t.bind(e.proxy),e,n)}function op(t,e,n,r){const s=r.includes(".")?tp(n,r):()=>n[r];if(Ve(t)){const i=e[t];X(i)&&ws(s,i)}else if(X(t))ws(s,t.bind(n));else if(Re(t))if(W(t))t.forEach(i=>op(i,e,n,r));else{const i=X(t.handler)?t.handler.bind(n):e[t.handler];X(i)&&ws(s,i,t)}}function Pl(t){const e=t.type,{mixins:n,extends:r}=e,{mixins:s,optionsCache:i,config:{optionMergeStrategies:o}}=t.appContext,a=i.get(e);let c;return a?c=a:!s.length&&!n&&!r?c=e:(c={},s.length&&s.forEach(l=>fo(c,l,o,!0)),fo(c,e,o)),Re(e)&&i.set(e,c),c}function fo(t,e,n,r=!1){const{mixins:s,extends:i}=e;i&&fo(t,i,n,!0),s&&s.forEach(o=>fo(t,o,n,!0));for(const o in e)if(!(r&&o==="expose")){const a=Tv[o]||n&&n[o];t[o]=a?a(t[o],e[o]):e[o]}return t}const Tv={data:ah,props:ch,emits:ch,methods:ps,computed:ps,beforeCreate:st,created:st,beforeMount:st,mounted:st,beforeUpdate:st,updated:st,beforeDestroy:st,beforeUnmount:st,destroyed:st,unmounted:st,activated:st,deactivated:st,errorCaptured:st,serverPrefetch:st,components:ps,directives:ps,watch:Rv,provide:ah,inject:Av};function ah(t,e){return e?t?function(){return Ke(X(t)?t.call(this,this):t,X(e)?e.call(this,this):e)}:e:t}function Av(t,e){return ps(yc(t),yc(e))}function yc(t){if(W(t)){const e={};for(let n=0;n<t.length;n++)e[t[n]]=t[n];return e}return t}function st(t,e){return t?[...new Set([].concat(t,e))]:e}function ps(t,e){return t?Ke(Object.create(null),t,e):e}function ch(t,e){return t?W(t)&&W(e)?[...new Set([...t,...e])]:Ke(Object.create(null),ih(t),ih(e??{})):e}function Rv(t,e){if(!t)return e;if(!e)return t;const n=Ke(Object.create(null),t);for(const r in e)n[r]=st(t[r],e[r]);return n}function ap(){return{app:null,config:{isNativeTag:oy,performance:!1,globalProperties:{},optionMergeStrategies:{},errorHandler:void 0,warnHandler:void 0,compilerOptions:{}},mixins:[],components:{},directives:{},provides:Object.create(null),optionsCache:new WeakMap,propsCache:new WeakMap,emitsCache:new WeakMap}}let Sv=0;function Pv(t,e){return function(r,s=null){X(r)||(r=Ke({},r)),s!=null&&!Re(s)&&(s=null);const i=ap(),o=new WeakSet;let a=!1;const c=i.app={_uid:Sv++,_component:r,_props:s,_container:null,_context:i,_instance:null,version:Jv,get config(){return i.config},set config(l){},use(l,...u){return o.has(l)||(l&&X(l.install)?(o.add(l),l.install(c,...u)):X(l)&&(o.add(l),l(c,...u))),c},mixin(l){return i.mixins.includes(l)||i.mixins.push(l),c},component(l,u){return u?(i.components[l]=u,c):i.components[l]},directive(l,u){return u?(i.directives[l]=u,c):i.directives[l]},mount(l,u,h){if(!a){const d=it(r,s);return d.appContext=i,h===!0?h="svg":h===!1&&(h=void 0),u&&e?e(d,l):t(d,l,h),a=!0,c._container=l,l.__vue_app__=c,Jo(d.component)||d.component.proxy}},unmount(){a&&(t(null,c._container),delete c._container.__vue_app__)},provide(l,u){return i.provides[l]=u,c},runWithContext(l){Fs=c;try{return l()}finally{Fs=null}}};return c}}let Fs=null;function Yi(t,e){if(Ze){let n=Ze.provides;const r=Ze.parent&&Ze.parent.provides;r===n&&(n=Ze.provides=Object.create(r)),n[t]=e}}function Ct(t,e,n=!1){const r=Ze||ht;if(r||Fs){const s=r?r.parent==null?r.vnode.appContext&&r.vnode.appContext.provides:r.parent.provides:Fs._context.provides;if(s&&t in s)return s[t];if(arguments.length>1)return n&&X(e)?e.call(r&&r.proxy):e}}function Cv(){return!!(Ze||ht||Fs)}function bv(t,e,n,r=!1){const s={},i={};co(i,Qo,1),t.propsDefaults=Object.create(null),cp(t,e,s,i);for(const o in t.propsOptions[0])o in s||(s[o]=void 0);n?t.props=r?s:$f(s):t.type.props?t.props=s:t.props=i,t.attrs=i}function kv(t,e,n,r){const{props:s,attrs:i,vnode:{patchFlag:o}}=t,a=ae(s),[c]=t.propsOptions;let l=!1;if((r||o>0)&&!(o&16)){if(o&8){const u=t.vnode.dynamicProps;for(let h=0;h<u.length;h++){let d=u[h];if(Ko(t.emitsOptions,d))continue;const g=e[d];if(c)if(oe(i,d))g!==i[d]&&(i[d]=g,l=!0);else{const E=Mr(d);s[E]=vc(c,a,E,g,t,!1)}else g!==i[d]&&(i[d]=g,l=!0)}}}else{cp(t,e,s,i)&&(l=!0);let u;for(const h in a)(!e||!oe(e,h)&&((u=Xr(h))===h||!oe(e,u)))&&(c?n&&(n[h]!==void 0||n[u]!==void 0)&&(s[h]=vc(c,a,h,void 0,t,!0)):delete s[h]);if(i!==a)for(const h in i)(!e||!oe(e,h))&&(delete i[h],l=!0)}l&&en(t,"set","$attrs")}function cp(t,e,n,r){const[s,i]=t.propsOptions;let o=!1,a;if(e)for(let c in e){if(Ki(c))continue;const l=e[c];let u;s&&oe(s,u=Mr(c))?!i||!i.includes(u)?n[u]=l:(a||(a={}))[u]=l:Ko(t.emitsOptions,c)||(!(c in r)||l!==r[c])&&(r[c]=l,o=!0)}if(i){const c=ae(n),l=a||ve;for(let u=0;u<i.length;u++){const h=i[u];n[h]=vc(s,c,h,l[h],t,!oe(l,h))}}return o}function vc(t,e,n,r,s,i){const o=t[n];if(o!=null){const a=oe(o,"default");if(a&&r===void 0){const c=o.default;if(o.type!==Function&&!o.skipFactory&&X(c)){const{propsDefaults:l}=s;if(n in l)r=l[n];else{const u=ci(s);r=l[n]=c.call(null,e),u()}}else r=c}o[0]&&(i&&!a?r=!1:o[1]&&(r===""||r===Xr(n))&&(r=!0))}return r}function lp(t,e,n=!1){const r=e.propsCache,s=r.get(t);if(s)return s;const i=t.props,o={},a=[];let c=!1;if(!X(t)){const u=h=>{c=!0;const[d,g]=lp(h,e,!0);Ke(o,d),g&&a.push(...g)};!n&&e.mixins.length&&e.mixins.forEach(u),t.extends&&u(t.extends),t.mixins&&t.mixins.forEach(u)}if(!i&&!c)return Re(t)&&r.set(t,Pr),Pr;if(W(i))for(let u=0;u<i.length;u++){const h=Mr(i[u]);lh(h)&&(o[h]=ve)}else if(i)for(const u in i){const h=Mr(u);if(lh(h)){const d=i[u],g=o[h]=W(d)||X(d)?{type:d}:Ke({},d);if(g){const E=dh(Boolean,g.type),R=dh(String,g.type);g[0]=E>-1,g[1]=R<0||E<R,(E>-1||oe(g,"default"))&&a.push(h)}}}const l=[o,a];return Re(t)&&r.set(t,l),l}function lh(t){return t[0]!=="$"}function uh(t){const e=t&&t.toString().match(/^\s*(function|class) (\w+)/);return e?e[2]:t===null?"null":""}function hh(t,e){return uh(t)===uh(e)}function dh(t,e){return W(e)?e.findIndex(n=>hh(n,t)):X(e)&&hh(e,t)?0:-1}const up=t=>t[0]==="_"||t==="$stable",Cl=t=>W(t)?t.map(xt):[xt(t)],Dv=(t,e,n)=>{if(e._n)return e;const r=Xy((...s)=>Cl(e(...s)),n);return r._c=!1,r},hp=(t,e,n)=>{const r=t._ctx;for(const s in t){if(up(s))continue;const i=t[s];if(X(i))e[s]=Dv(s,i,r);else if(i!=null){const o=Cl(i);e[s]=()=>o}}},dp=(t,e)=>{const n=Cl(e);t.slots.default=()=>n},Ov=(t,e)=>{if(t.vnode.shapeFlag&32){const n=e._;n?(t.slots=ae(e),co(e,"_",n)):hp(e,t.slots={})}else t.slots={},e&&dp(t,e);co(t.slots,Qo,1)},Vv=(t,e,n)=>{const{vnode:r,slots:s}=t;let i=!0,o=ve;if(r.shapeFlag&32){const a=e._;a?n&&a===1?i=!1:(Ke(s,e),!n&&a===1&&delete s._):(i=!e.$stable,hp(e,s)),o=e}else e&&(dp(t,e),o={default:1});if(i)for(const a in s)!up(a)&&o[a]==null&&delete s[a]};function Ec(t,e,n,r,s=!1){if(W(t)){t.forEach((d,g)=>Ec(d,e&&(W(e)?e[g]:e),n,r,s));return}if(Qi(r)&&!s)return;const i=r.shapeFlag&4?Jo(r.component)||r.component.proxy:r.el,o=s?null:i,{i:a,r:c}=t,l=e&&e.r,u=a.refs===ve?a.refs={}:a.refs,h=a.setupState;if(l!=null&&l!==c&&(Ve(l)?(u[l]=null,oe(h,l)&&(h[l]=null)):Ne(l)&&(l.value=null)),X(c))Sn(c,a,12,[o,u]);else{const d=Ve(c),g=Ne(c),E=t.f;if(d||g){const R=()=>{if(E){const T=d?oe(h,c)?h[c]:u[c]:c.value;s?W(T)&&ul(T,i):W(T)?T.includes(i)||T.push(i):d?(u[c]=[i],oe(h,c)&&(h[c]=u[c])):(c.value=[i],t.k&&(u[t.k]=c.value))}else d?(u[c]=o,oe(h,c)&&(h[c]=o)):g&&(c.value=o,t.k&&(u[t.k]=o))};s||E?R():(R.id=-1,lt(R,n))}}}const lt=iv;function Nv(t){return Mv(t)}function Mv(t,e){const n=Af();n.__VUE__=!0;const{insert:r,remove:s,patchProp:i,createElement:o,createText:a,createComment:c,setText:l,setElementText:u,parentNode:h,nextSibling:d,setScopeId:g=wt,insertStaticContent:E}=t,R=(f,p,m,I=null,_=null,C=null,V=void 0,S=null,b=!!p.dynamicChildren)=>{if(f===p)return;f&&!ls(f,p)&&(I=y(f),ct(f,_,C,!0),f=null),p.patchFlag===-2&&(b=!1,p.dynamicChildren=null);const{type:A,ref:L,shapeFlag:q}=p;switch(A){case Go:T(f,p,m,I);break;case tr:P(f,p,m,I);break;case Ua:f==null&&M(p,m,I,V);break;case At:ft(f,p,m,I,_,C,V,S,b);break;default:q&1?Z(f,p,m,I,_,C,V,S,b):q&6?_t(f,p,m,I,_,C,V,S,b):(q&64||q&128)&&A.process(f,p,m,I,_,C,V,S,b,U)}L!=null&&_&&Ec(L,f&&f.ref,C,p||f,!p)},T=(f,p,m,I)=>{if(f==null)r(p.el=a(p.children),m,I);else{const _=p.el=f.el;p.children!==f.children&&l(_,p.children)}},P=(f,p,m,I)=>{f==null?r(p.el=c(p.children||""),m,I):p.el=f.el},M=(f,p,m,I)=>{[f.el,f.anchor]=E(f.children,p,m,I,f.el,f.anchor)},F=({el:f,anchor:p},m,I)=>{let _;for(;f&&f!==p;)_=d(f),r(f,m,I),f=_;r(p,m,I)},z=({el:f,anchor:p})=>{let m;for(;f&&f!==p;)m=d(f),s(f),f=m;s(p)},Z=(f,p,m,I,_,C,V,S,b)=>{p.type==="svg"?V="svg":p.type==="math"&&(V="mathml"),f==null?$(p,m,I,_,C,V,S,b):ee(f,p,_,C,V,S,b)},$=(f,p,m,I,_,C,V,S)=>{let b,A;const{props:L,shapeFlag:q,transition:B,dirs:Q}=f;if(b=f.el=o(f.type,C,L&&L.is,L),q&8?u(b,f.children):q&16&&te(f.children,b,null,I,_,Fa(f,C),V,S),Q&&jn(f,null,I,"created"),de(b,f,f.scopeId,V,I),L){for(const me in L)me!=="value"&&!Ki(me)&&i(b,me,null,L[me],C,f.children,I,_,ze);"value"in L&&i(b,"value",null,L.value,C),(A=L.onVnodeBeforeMount)&&Mt(A,I,f)}Q&&jn(f,null,I,"beforeMount");const ne=xv(_,B);ne&&B.beforeEnter(b),r(b,p,m),((A=L&&L.onVnodeMounted)||ne||Q)&&lt(()=>{A&&Mt(A,I,f),ne&&B.enter(b),Q&&jn(f,null,I,"mounted")},_)},de=(f,p,m,I,_)=>{if(m&&g(f,m),I)for(let C=0;C<I.length;C++)g(f,I[C]);if(_){let C=_.subTree;if(p===C){const V=_.vnode;de(f,V,V.scopeId,V.slotScopeIds,_.parent)}}},te=(f,p,m,I,_,C,V,S,b=0)=>{for(let A=b;A<f.length;A++){const L=f[A]=S?mn(f[A]):xt(f[A]);R(null,L,p,m,I,_,C,V,S)}},ee=(f,p,m,I,_,C,V)=>{const S=p.el=f.el;let{patchFlag:b,dynamicChildren:A,dirs:L}=p;b|=f.patchFlag&16;const q=f.props||ve,B=p.props||ve;let Q;if(m&&$n(m,!1),(Q=B.onVnodeBeforeUpdate)&&Mt(Q,m,p,f),L&&jn(p,f,m,"beforeUpdate"),m&&$n(m,!0),A?_e(f.dynamicChildren,A,S,m,I,Fa(p,_),C):V||ue(f,p,S,null,m,I,Fa(p,_),C,!1),b>0){if(b&16)We(S,p,q,B,m,I,_);else if(b&2&&q.class!==B.class&&i(S,"class",null,B.class,_),b&4&&i(S,"style",q.style,B.style,_),b&8){const ne=p.dynamicProps;for(let me=0;me<ne.length;me++){const Te=ne[me],Me=q[Te],Tt=B[Te];(Tt!==Me||Te==="value")&&i(S,Te,Me,Tt,_,f.children,m,I,ze)}}b&1&&f.children!==p.children&&u(S,p.children)}else!V&&A==null&&We(S,p,q,B,m,I,_);((Q=B.onVnodeUpdated)||L)&&lt(()=>{Q&&Mt(Q,m,p,f),L&&jn(p,f,m,"updated")},I)},_e=(f,p,m,I,_,C,V)=>{for(let S=0;S<p.length;S++){const b=f[S],A=p[S],L=b.el&&(b.type===At||!ls(b,A)||b.shapeFlag&70)?h(b.el):m;R(b,A,L,null,I,_,C,V,!0)}},We=(f,p,m,I,_,C,V)=>{if(m!==I){if(m!==ve)for(const S in m)!Ki(S)&&!(S in I)&&i(f,S,m[S],null,V,p.children,_,C,ze);for(const S in I){if(Ki(S))continue;const b=I[S],A=m[S];b!==A&&S!=="value"&&i(f,S,A,b,V,p.children,_,C,ze)}"value"in I&&i(f,"value",m.value,I.value,V)}},ft=(f,p,m,I,_,C,V,S,b)=>{const A=p.el=f?f.el:a(""),L=p.anchor=f?f.anchor:a("");let{patchFlag:q,dynamicChildren:B,slotScopeIds:Q}=p;Q&&(S=S?S.concat(Q):Q),f==null?(r(A,m,I),r(L,m,I),te(p.children||[],m,L,_,C,V,S,b)):q>0&&q&64&&B&&f.dynamicChildren?(_e(f.dynamicChildren,B,m,_,C,V,S),(p.key!=null||_&&p===_.subTree)&&fp(f,p,!0)):ue(f,p,m,L,_,C,V,S,b)},_t=(f,p,m,I,_,C,V,S,b)=>{p.slotScopeIds=S,f==null?p.shapeFlag&512?_.ctx.activate(p,m,I,V,b):Bn(p,m,I,_,C,V,b):yt(f,p,b)},Bn=(f,p,m,I,_,C,V)=>{const S=f.component=Kv(f,I,_);if(np(f)&&(S.ctx.renderer=U),Wv(S),S.asyncDep){if(_&&_.registerDep(S,ce),!f.el){const b=S.subTree=it(tr);P(null,b,p,m)}}else ce(S,f,p,m,_,C,V)},yt=(f,p,m)=>{const I=p.component=f.component;if(tv(f,p,m))if(I.asyncDep&&!I.asyncResolved){ge(I,p,m);return}else I.next=p,Gy(I.update),I.effect.dirty=!0,I.update();else p.el=f.el,I.vnode=p},ce=(f,p,m,I,_,C,V)=>{const S=()=>{if(f.isMounted){let{next:L,bu:q,u:B,parent:Q,vnode:ne}=f;{const mr=pp(f);if(mr){L&&(L.el=ne.el,ge(f,L,V)),mr.asyncDep.then(()=>{f.isUnmounted||S()});return}}let me=L,Te;$n(f,!1),L?(L.el=ne.el,ge(f,L,V)):L=ne,q&&Wi(q),(Te=L.props&&L.props.onVnodeBeforeUpdate)&&Mt(Te,Q,L,ne),$n(f,!0);const Me=xa(f),Tt=f.subTree;f.subTree=Me,R(Tt,Me,h(Tt.el),y(Tt),f,_,C),L.el=Me.el,me===null&&nv(f,Me.el),B&&lt(B,_),(Te=L.props&&L.props.onVnodeUpdated)&&lt(()=>Mt(Te,Q,L,ne),_)}else{let L;const{el:q,props:B}=p,{bm:Q,m:ne,parent:me}=f,Te=Qi(p);if($n(f,!1),Q&&Wi(Q),!Te&&(L=B&&B.onVnodeBeforeMount)&&Mt(L,me,p),$n(f,!0),q&&we){const Me=()=>{f.subTree=xa(f),we(q,f.subTree,f,_,null)};Te?p.type.__asyncLoader().then(()=>!f.isUnmounted&&Me()):Me()}else{const Me=f.subTree=xa(f);R(null,Me,m,I,f,_,C),p.el=Me.el}if(ne&&lt(ne,_),!Te&&(L=B&&B.onVnodeMounted)){const Me=p;lt(()=>Mt(L,me,Me),_)}(p.shapeFlag&256||me&&Qi(me.vnode)&&me.vnode.shapeFlag&256)&&f.a&&lt(f.a,_),f.isMounted=!0,p=m=I=null}},b=f.effect=new fl(S,wt,()=>wl(A),f.scope),A=f.update=()=>{b.dirty&&b.run()};A.id=f.uid,$n(f,!0),A()},ge=(f,p,m)=>{p.component=f;const I=f.vnode.props;f.vnode=p,f.next=null,kv(f,p.props,I,m),Vv(f,p.children,m),cr(),rh(f),lr()},ue=(f,p,m,I,_,C,V,S,b=!1)=>{const A=f&&f.children,L=f?f.shapeFlag:0,q=p.children,{patchFlag:B,shapeFlag:Q}=p;if(B>0){if(B&128){un(A,q,m,I,_,C,V,S,b);return}else if(B&256){Gt(A,q,m,I,_,C,V,S,b);return}}Q&8?(L&16&&ze(A,_,C),q!==A&&u(m,q)):L&16?Q&16?un(A,q,m,I,_,C,V,S,b):ze(A,_,C,!0):(L&8&&u(m,""),Q&16&&te(q,m,I,_,C,V,S,b))},Gt=(f,p,m,I,_,C,V,S,b)=>{f=f||Pr,p=p||Pr;const A=f.length,L=p.length,q=Math.min(A,L);let B;for(B=0;B<q;B++){const Q=p[B]=b?mn(p[B]):xt(p[B]);R(f[B],Q,m,null,_,C,V,S,b)}A>L?ze(f,_,C,!0,!1,q):te(p,m,I,_,C,V,S,b,q)},un=(f,p,m,I,_,C,V,S,b)=>{let A=0;const L=p.length;let q=f.length-1,B=L-1;for(;A<=q&&A<=B;){const Q=f[A],ne=p[A]=b?mn(p[A]):xt(p[A]);if(ls(Q,ne))R(Q,ne,m,null,_,C,V,S,b);else break;A++}for(;A<=q&&A<=B;){const Q=f[q],ne=p[B]=b?mn(p[B]):xt(p[B]);if(ls(Q,ne))R(Q,ne,m,null,_,C,V,S,b);else break;q--,B--}if(A>q){if(A<=B){const Q=B+1,ne=Q<L?p[Q].el:I;for(;A<=B;)R(null,p[A]=b?mn(p[A]):xt(p[A]),m,ne,_,C,V,S,b),A++}}else if(A>B)for(;A<=q;)ct(f[A],_,C,!0),A++;else{const Q=A,ne=A,me=new Map;for(A=ne;A<=B;A++){const pt=p[A]=b?mn(p[A]):xt(p[A]);pt.key!=null&&me.set(pt.key,A)}let Te,Me=0;const Tt=B-ne+1;let mr=!1,Wu=0;const cs=new Array(Tt);for(A=0;A<Tt;A++)cs[A]=0;for(A=Q;A<=q;A++){const pt=f[A];if(Me>=Tt){ct(pt,_,C,!0);continue}let Nt;if(pt.key!=null)Nt=me.get(pt.key);else for(Te=ne;Te<=B;Te++)if(cs[Te-ne]===0&&ls(pt,p[Te])){Nt=Te;break}Nt===void 0?ct(pt,_,C,!0):(cs[Nt-ne]=A+1,Nt>=Wu?Wu=Nt:mr=!0,R(pt,p[Nt],m,null,_,C,V,S,b),Me++)}const zu=mr?Lv(cs):Pr;for(Te=zu.length-1,A=Tt-1;A>=0;A--){const pt=ne+A,Nt=p[pt],Gu=pt+1<L?p[pt+1].el:I;cs[A]===0?R(null,Nt,m,Gu,_,C,V,S,b):mr&&(Te<0||A!==zu[Te]?Vt(Nt,m,Gu,2):Te--)}}},Vt=(f,p,m,I,_=null)=>{const{el:C,type:V,transition:S,children:b,shapeFlag:A}=f;if(A&6){Vt(f.component.subTree,p,m,I);return}if(A&128){f.suspense.move(p,m,I);return}if(A&64){V.move(f,p,m,U);return}if(V===At){r(C,p,m);for(let q=0;q<b.length;q++)Vt(b[q],p,m,I);r(f.anchor,p,m);return}if(V===Ua){F(f,p,m);return}if(I!==2&&A&1&&S)if(I===0)S.beforeEnter(C),r(C,p,m),lt(()=>S.enter(C),_);else{const{leave:q,delayLeave:B,afterLeave:Q}=S,ne=()=>r(C,p,m),me=()=>{q(C,()=>{ne(),Q&&Q()})};B?B(C,ne,me):me()}else r(C,p,m)},ct=(f,p,m,I=!1,_=!1)=>{const{type:C,props:V,ref:S,children:b,dynamicChildren:A,shapeFlag:L,patchFlag:q,dirs:B}=f;if(S!=null&&Ec(S,null,m,f,!0),L&256){p.ctx.deactivate(f);return}const Q=L&1&&B,ne=!Qi(f);let me;if(ne&&(me=V&&V.onVnodeBeforeUnmount)&&Mt(me,p,f),L&6)bi(f.component,m,I);else{if(L&128){f.suspense.unmount(m,I);return}Q&&jn(f,null,p,"beforeUnmount"),L&64?f.type.remove(f,p,m,_,U,I):A&&(C!==At||q>0&&q&64)?ze(A,p,m,!1,!0):(C===At&&q&384||!_&&L&16)&&ze(b,p,m),I&&pr(f)}(ne&&(me=V&&V.onVnodeUnmounted)||Q)&&lt(()=>{me&&Mt(me,p,f),Q&&jn(f,null,p,"unmounted")},m)},pr=f=>{const{type:p,el:m,anchor:I,transition:_}=f;if(p===At){gr(m,I);return}if(p===Ua){z(f);return}const C=()=>{s(m),_&&!_.persisted&&_.afterLeave&&_.afterLeave()};if(f.shapeFlag&1&&_&&!_.persisted){const{leave:V,delayLeave:S}=_,b=()=>V(m,C);S?S(f.el,C,b):b()}else C()},gr=(f,p)=>{let m;for(;f!==p;)m=d(f),s(f),f=m;s(p)},bi=(f,p,m)=>{const{bum:I,scope:_,update:C,subTree:V,um:S}=f;I&&Wi(I),_.stop(),C&&(C.active=!1,ct(V,f,p,m)),S&&lt(S,p),lt(()=>{f.isUnmounted=!0},p),p&&p.pendingBranch&&!p.isUnmounted&&f.asyncDep&&!f.asyncResolved&&f.suspenseId===p.pendingId&&(p.deps--,p.deps===0&&p.resolve())},ze=(f,p,m,I=!1,_=!1,C=0)=>{for(let V=C;V<f.length;V++)ct(f[V],p,m,I,_)},y=f=>f.shapeFlag&6?y(f.component.subTree):f.shapeFlag&128?f.suspense.next():d(f.anchor||f.el);let x=!1;const O=(f,p,m)=>{f==null?p._vnode&&ct(p._vnode,null,null,!0):R(p._vnode||null,f,p,null,null,null,m),x||(x=!0,rh(),Jf(),x=!1),p._vnode=f},U={p:R,um:ct,m:Vt,r:pr,mt:Bn,mc:te,pc:ue,pbc:_e,n:y,o:t};let he,we;return e&&([he,we]=e(U)),{render:O,hydrate:he,createApp:Pv(O,he)}}function Fa({type:t,props:e},n){return n==="svg"&&t==="foreignObject"||n==="mathml"&&t==="annotation-xml"&&e&&e.encoding&&e.encoding.includes("html")?void 0:n}function $n({effect:t,update:e},n){t.allowRecurse=e.allowRecurse=n}function xv(t,e){return(!t||t&&!t.pendingBranch)&&e&&!e.persisted}function fp(t,e,n=!1){const r=t.children,s=e.children;if(W(r)&&W(s))for(let i=0;i<r.length;i++){const o=r[i];let a=s[i];a.shapeFlag&1&&!a.dynamicChildren&&((a.patchFlag<=0||a.patchFlag===32)&&(a=s[i]=mn(s[i]),a.el=o.el),n||fp(o,a)),a.type===Go&&(a.el=o.el)}}function Lv(t){const e=t.slice(),n=[0];let r,s,i,o,a;const c=t.length;for(r=0;r<c;r++){const l=t[r];if(l!==0){if(s=n[n.length-1],t[s]<l){e[r]=s,n.push(r);continue}for(i=0,o=n.length-1;i<o;)a=i+o>>1,t[n[a]]<l?i=a+1:o=a;l<t[n[i]]&&(i>0&&(e[r]=n[i-1]),n[i]=r)}}for(i=n.length,o=n[i-1];i-- >0;)n[i]=o,o=e[o];return n}function pp(t){const e=t.subTree.component;if(e)return e.asyncDep&&!e.asyncResolved?e:pp(e)}const Fv=t=>t.__isTeleport,At=Symbol.for("v-fgt"),Go=Symbol.for("v-txt"),tr=Symbol.for("v-cmt"),Ua=Symbol.for("v-stc"),As=[];let Rt=null;function Xe(t=!1){As.push(Rt=t?null:[])}function Uv(){As.pop(),Rt=As[As.length-1]||null}let Us=1;function fh(t){Us+=t}function gp(t){return t.dynamicChildren=Us>0?Rt||Pr:null,Uv(),Us>0&&Rt&&Rt.push(t),t}function ut(t,e,n,r,s,i){return gp(Ae(t,e,n,r,s,i,!0))}function mp(t,e,n,r,s){return gp(it(t,e,n,r,s,!0))}function Ic(t){return t?t.__v_isVNode===!0:!1}function ls(t,e){return t.type===e.type&&t.key===e.key}const Qo="__vInternal",_p=({key:t})=>t??null,Ji=({ref:t,ref_key:e,ref_for:n})=>(typeof t=="number"&&(t=""+t),t!=null?Ve(t)||Ne(t)||X(t)?{i:ht,r:t,k:e,f:!!n}:t:null);function Ae(t,e=null,n=null,r=0,s=null,i=t===At?0:1,o=!1,a=!1){const c={__v_isVNode:!0,__v_skip:!0,type:t,props:e,key:e&&_p(e),ref:e&&Ji(e),scopeId:Wo,slotScopeIds:null,children:n,component:null,suspense:null,ssContent:null,ssFallback:null,dirs:null,transition:null,el:null,anchor:null,target:null,targetAnchor:null,staticCount:0,shapeFlag:i,patchFlag:r,dynamicProps:s,dynamicChildren:null,appContext:null,ctx:ht};return a?(bl(c,n),i&128&&t.normalize(c)):n&&(c.shapeFlag|=Ve(n)?8:16),Us>0&&!o&&Rt&&(c.patchFlag>0||i&6)&&c.patchFlag!==32&&Rt.push(c),c}const it=Bv;function Bv(t,e=null,n=null,r=0,s=null,i=!1){if((!t||t===rv)&&(t=tr),Ic(t)){const a=Lr(t,e,!0);return n&&bl(a,n),Us>0&&!i&&Rt&&(a.shapeFlag&6?Rt[Rt.indexOf(t)]=a:Rt.push(a)),a.patchFlag|=-2,a}if(Yv(t)&&(t=t.__vccOpts),e){e=jv(e);let{class:a,style:c}=e;a&&!Ve(a)&&(e.class=oi(a)),Re(c)&&(Hf(c)&&!W(c)&&(c=Ke({},c)),e.style=dl(c))}const o=Ve(t)?1:sv(t)?128:Fv(t)?64:Re(t)?4:X(t)?2:0;return Ae(t,e,n,r,s,o,i,!0)}function jv(t){return t?Hf(t)||Qo in t?Ke({},t):t:null}function Lr(t,e,n=!1){const{props:r,ref:s,patchFlag:i,children:o}=t,a=e?$v(r||{},e):r;return{__v_isVNode:!0,__v_skip:!0,type:t.type,props:a,key:a&&_p(a),ref:e&&e.ref?n&&s?W(s)?s.concat(Ji(e)):[s,Ji(e)]:Ji(e):s,scopeId:t.scopeId,slotScopeIds:t.slotScopeIds,children:o,target:t.target,targetAnchor:t.targetAnchor,staticCount:t.staticCount,shapeFlag:t.shapeFlag,patchFlag:e&&t.type!==At?i===-1?16:i|16:i,dynamicProps:t.dynamicProps,dynamicChildren:t.dynamicChildren,appContext:t.appContext,dirs:t.dirs,transition:t.transition,component:t.component,suspense:t.suspense,ssContent:t.ssContent&&Lr(t.ssContent),ssFallback:t.ssFallback&&Lr(t.ssFallback),el:t.el,anchor:t.anchor,ctx:t.ctx,ce:t.ce}}function yp(t=" ",e=0){return it(Go,null,t,e)}function Ar(t="",e=!1){return e?(Xe(),mp(tr,null,t)):it(tr,null,t)}function xt(t){return t==null||typeof t=="boolean"?it(tr):W(t)?it(At,null,t.slice()):typeof t=="object"?mn(t):it(Go,null,String(t))}function mn(t){return t.el===null&&t.patchFlag!==-1||t.memo?t:Lr(t)}function bl(t,e){let n=0;const{shapeFlag:r}=t;if(e==null)e=null;else if(W(e))n=16;else if(typeof e=="object")if(r&65){const s=e.default;s&&(s._c&&(s._d=!1),bl(t,s()),s._c&&(s._d=!0));return}else{n=32;const s=e._;!s&&!(Qo in e)?e._ctx=ht:s===3&&ht&&(ht.slots._===1?e._=1:(e._=2,t.patchFlag|=1024))}else X(e)?(e={default:e,_ctx:ht},n=32):(e=String(e),r&64?(n=16,e=[yp(e)]):n=8);t.children=e,t.shapeFlag|=n}function $v(...t){const e={};for(let n=0;n<t.length;n++){const r=t[n];for(const s in r)if(s==="class")e.class!==r.class&&(e.class=oi([e.class,r.class]));else if(s==="style")e.style=dl([e.style,r.style]);else if(Fo(s)){const i=e[s],o=r[s];o&&i!==o&&!(W(i)&&i.includes(o))&&(e[s]=i?[].concat(i,o):o)}else s!==""&&(e[s]=r[s])}return e}function Mt(t,e,n,r=null){Pt(t,e,7,[n,r])}const qv=ap();let Hv=0;function Kv(t,e,n){const r=t.type,s=(e?e.appContext:t.appContext)||qv,i={uid:Hv++,vnode:t,type:r,parent:e,appContext:s,root:null,next:null,subTree:null,effect:null,update:null,scope:new Pf(!0),render:null,proxy:null,exposed:null,exposeProxy:null,withProxy:null,provides:e?e.provides:Object.create(s.provides),accessCache:null,renderCache:[],components:null,directives:null,propsOptions:lp(r,s),emitsOptions:Zf(r,s),emit:null,emitted:null,propsDefaults:ve,inheritAttrs:r.inheritAttrs,ctx:ve,data:ve,props:ve,attrs:ve,slots:ve,refs:ve,setupState:ve,setupContext:null,attrsProxy:null,slotsProxy:null,suspense:n,suspenseId:n?n.pendingId:0,asyncDep:null,asyncResolved:!1,isMounted:!1,isUnmounted:!1,isDeactivated:!1,bc:null,c:null,bm:null,m:null,bu:null,u:null,um:null,bum:null,da:null,a:null,rtg:null,rtc:null,ec:null,sp:null};return i.ctx={_:i},i.root=e?e.root:i,i.emit=Jy.bind(null,i),t.ce&&t.ce(i),i}let Ze=null,po,wc;{const t=Af(),e=(n,r)=>{let s;return(s=t[n])||(s=t[n]=[]),s.push(r),i=>{s.length>1?s.forEach(o=>o(i)):s[0](i)}};po=e("__VUE_INSTANCE_SETTERS__",n=>Ze=n),wc=e("__VUE_SSR_SETTERS__",n=>Yo=n)}const ci=t=>{const e=Ze;return po(t),t.scope.on(),()=>{t.scope.off(),po(e)}},ph=()=>{Ze&&Ze.scope.off(),po(null)};function vp(t){return t.vnode.shapeFlag&4}let Yo=!1;function Wv(t,e=!1){e&&wc(e);const{props:n,children:r}=t.vnode,s=vp(t);bv(t,n,s,e),Ov(t,r);const i=s?zv(t,e):void 0;return e&&wc(!1),i}function zv(t,e){const n=t.type;t.accessCache=Object.create(null),t.proxy=$o(new Proxy(t.ctx,Ev));const{setup:r}=n;if(r){const s=t.setupContext=r.length>1?Qv(t):null,i=ci(t);cr();const o=Sn(r,t,0,[t.props,s]);if(lr(),i(),Ef(o)){if(o.then(ph,ph),e)return o.then(a=>{gh(t,a,e)}).catch(a=>{Ho(a,t,0)});t.asyncDep=o}else gh(t,o,e)}else Ep(t,e)}function gh(t,e,n){X(e)?t.type.__ssrInlineRender?t.ssrRender=e:t.render=e:Re(e)&&(t.setupState=Gf(e)),Ep(t,n)}let mh;function Ep(t,e,n){const r=t.type;if(!t.render){if(!e&&mh&&!r.render){const s=r.template||Pl(t).template;if(s){const{isCustomElement:i,compilerOptions:o}=t.appContext.config,{delimiters:a,compilerOptions:c}=r,l=Ke(Ke({isCustomElement:i,delimiters:a},o),c);r.render=mh(s,l)}}t.render=r.render||wt}{const s=ci(t);cr();try{Iv(t)}finally{lr(),s()}}}function Gv(t){return t.attrsProxy||(t.attrsProxy=new Proxy(t.attrs,{get(e,n){return dt(t,"get","$attrs"),e[n]}}))}function Qv(t){const e=n=>{t.exposed=n||{}};return{get attrs(){return Gv(t)},slots:t.slots,emit:t.emit,expose:e}}function Jo(t){if(t.exposed)return t.exposeProxy||(t.exposeProxy=new Proxy(Gf($o(t.exposed)),{get(e,n){if(n in e)return e[n];if(n in Ts)return Ts[n](t)},has(e,n){return n in e||n in Ts}}))}function Yv(t){return X(t)&&"__vccOpts"in t}const vt=(t,e)=>Uy(t,e,Yo);function Ip(t,e,n){const r=arguments.length;return r===2?Re(e)&&!W(e)?Ic(e)?it(t,null,[e]):it(t,e):it(t,null,e):(r>3?n=Array.prototype.slice.call(arguments,2):r===3&&Ic(n)&&(n=[n]),it(t,e,n))}const Jv="3.4.15";/**
* @vue/runtime-dom v3.4.15
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/const Xv="http://www.w3.org/2000/svg",Zv="http://www.w3.org/1998/Math/MathML",_n=typeof document<"u"?document:null,_h=_n&&_n.createElement("template"),eE={insert:(t,e,n)=>{e.insertBefore(t,n||null)},remove:t=>{const e=t.parentNode;e&&e.removeChild(t)},createElement:(t,e,n,r)=>{const s=e==="svg"?_n.createElementNS(Xv,t):e==="mathml"?_n.createElementNS(Zv,t):_n.createElement(t,n?{is:n}:void 0);return t==="select"&&r&&r.multiple!=null&&s.setAttribute("multiple",r.multiple),s},createText:t=>_n.createTextNode(t),createComment:t=>_n.createComment(t),setText:(t,e)=>{t.nodeValue=e},setElementText:(t,e)=>{t.textContent=e},parentNode:t=>t.parentNode,nextSibling:t=>t.nextSibling,querySelector:t=>_n.querySelector(t),setScopeId(t,e){t.setAttribute(e,"")},insertStaticContent(t,e,n,r,s,i){const o=n?n.previousSibling:e.lastChild;if(s&&(s===i||s.nextSibling))for(;e.insertBefore(s.cloneNode(!0),n),!(s===i||!(s=s.nextSibling)););else{_h.innerHTML=r==="svg"?`<svg>${t}</svg>`:r==="mathml"?`<math>${t}</math>`:t;const a=_h.content;if(r==="svg"||r==="mathml"){const c=a.firstChild;for(;c.firstChild;)a.appendChild(c.firstChild);a.removeChild(c)}e.insertBefore(a,n)}return[o?o.nextSibling:e.firstChild,n?n.previousSibling:e.lastChild]}},tE=Symbol("_vtc");function nE(t,e,n){const r=t[tE];r&&(e=(e?[e,...r]:[...r]).join(" ")),e==null?t.removeAttribute("class"):n?t.setAttribute("class",e):t.className=e}const rE=Symbol("_vod"),sE=Symbol("");function iE(t,e,n){const r=t.style,s=r.display,i=Ve(n);if(n&&!i){if(e&&!Ve(e))for(const o in e)n[o]==null&&Tc(r,o,"");for(const o in n)Tc(r,o,n[o])}else if(i){if(e!==n){const o=r[sE];o&&(n+=";"+o),r.cssText=n}}else e&&t.removeAttribute("style");rE in t&&(r.display=s)}const yh=/\s*!important$/;function Tc(t,e,n){if(W(n))n.forEach(r=>Tc(t,e,r));else if(n==null&&(n=""),e.startsWith("--"))t.setProperty(e,n);else{const r=oE(t,e);yh.test(n)?t.setProperty(Xr(r),n.replace(yh,""),"important"):t[r]=n}}const vh=["Webkit","Moz","ms"],Ba={};function oE(t,e){const n=Ba[e];if(n)return n;let r=Mr(e);if(r!=="filter"&&r in t)return Ba[e]=r;r=Tf(r);for(let s=0;s<vh.length;s++){const i=vh[s]+r;if(i in t)return Ba[e]=i}return e}const Eh="http://www.w3.org/1999/xlink";function aE(t,e,n,r,s){if(r&&e.startsWith("xlink:"))n==null?t.removeAttributeNS(Eh,e.slice(6,e.length)):t.setAttributeNS(Eh,e,n);else{const i=my(e);n==null||i&&!Rf(n)?t.removeAttribute(e):t.setAttribute(e,i?"":n)}}function cE(t,e,n,r,s,i,o){if(e==="innerHTML"||e==="textContent"){r&&o(r,s,i),t[e]=n??"";return}const a=t.tagName;if(e==="value"&&a!=="PROGRESS"&&!a.includes("-")){t._value=n;const l=a==="OPTION"?t.getAttribute("value"):t.value,u=n??"";l!==u&&(t.value=u),n==null&&t.removeAttribute(e);return}let c=!1;if(n===""||n==null){const l=typeof t[e];l==="boolean"?n=Rf(n):n==null&&l==="string"?(n="",c=!0):l==="number"&&(n=0,c=!0)}try{t[e]=n}catch{}c&&t.removeAttribute(e)}function vr(t,e,n,r){t.addEventListener(e,n,r)}function lE(t,e,n,r){t.removeEventListener(e,n,r)}const Ih=Symbol("_vei");function uE(t,e,n,r,s=null){const i=t[Ih]||(t[Ih]={}),o=i[e];if(r&&o)o.value=r;else{const[a,c]=hE(e);if(r){const l=i[e]=pE(r,s);vr(t,a,l,c)}else o&&(lE(t,a,o,c),i[e]=void 0)}}const wh=/(?:Once|Passive|Capture)$/;function hE(t){let e;if(wh.test(t)){e={};let r;for(;r=t.match(wh);)t=t.slice(0,t.length-r[0].length),e[r[0].toLowerCase()]=!0}return[t[2]===":"?t.slice(3):Xr(t.slice(2)),e]}let ja=0;const dE=Promise.resolve(),fE=()=>ja||(dE.then(()=>ja=0),ja=Date.now());function pE(t,e){const n=r=>{if(!r._vts)r._vts=Date.now();else if(r._vts<=n.attached)return;Pt(gE(r,n.value),e,5,[r])};return n.value=t,n.attached=fE(),n}function gE(t,e){if(W(e)){const n=t.stopImmediatePropagation;return t.stopImmediatePropagation=()=>{n.call(t),t._stopped=!0},e.map(r=>s=>!s._stopped&&r&&r(s))}else return e}const Th=t=>t.charCodeAt(0)===111&&t.charCodeAt(1)===110&&t.charCodeAt(2)>96&&t.charCodeAt(2)<123,mE=(t,e,n,r,s,i,o,a,c)=>{const l=s==="svg";e==="class"?nE(t,r,l):e==="style"?iE(t,n,r):Fo(e)?ll(e)||uE(t,e,n,r,o):(e[0]==="."?(e=e.slice(1),!0):e[0]==="^"?(e=e.slice(1),!1):_E(t,e,r,l))?cE(t,e,r,i,o,a,c):(e==="true-value"?t._trueValue=r:e==="false-value"&&(t._falseValue=r),aE(t,e,r,l))};function _E(t,e,n,r){if(r)return!!(e==="innerHTML"||e==="textContent"||e in t&&Th(e)&&X(n));if(e==="spellcheck"||e==="draggable"||e==="translate"||e==="form"||e==="list"&&t.tagName==="INPUT"||e==="type"&&t.tagName==="TEXTAREA")return!1;if(e==="width"||e==="height"){const s=t.tagName;if(s==="IMG"||s==="VIDEO"||s==="CANVAS"||s==="SOURCE")return!1}return Th(e)&&Ve(n)?!1:e in t}const Ah=t=>{const e=t.props["onUpdate:modelValue"]||!1;return W(e)?n=>Wi(e,n):e};function yE(t){t.target.composing=!0}function Rh(t){const e=t.target;e.composing&&(e.composing=!1,e.dispatchEvent(new Event("input")))}const $a=Symbol("_assign"),Xi={created(t,{modifiers:{lazy:e,trim:n,number:r}},s){t[$a]=Ah(s);const i=r||s.props&&s.props.type==="number";vr(t,e?"change":"input",o=>{if(o.target.composing)return;let a=t.value;n&&(a=a.trim()),i&&(a=hc(a)),t[$a](a)}),n&&vr(t,"change",()=>{t.value=t.value.trim()}),e||(vr(t,"compositionstart",yE),vr(t,"compositionend",Rh),vr(t,"change",Rh))},mounted(t,{value:e}){t.value=e??""},beforeUpdate(t,{value:e,modifiers:{lazy:n,trim:r,number:s}},i){if(t[$a]=Ah(i),t.composing)return;const o=s||t.type==="number"?hc(t.value):t.value,a=e??"";o!==a&&(document.activeElement===t&&t.type!=="range"&&(n||r&&t.value.trim()===a)||(t.value=a))}},vE=["ctrl","shift","alt","meta"],EE={stop:t=>t.stopPropagation(),prevent:t=>t.preventDefault(),self:t=>t.target!==t.currentTarget,ctrl:t=>!t.ctrlKey,shift:t=>!t.shiftKey,alt:t=>!t.altKey,meta:t=>!t.metaKey,left:t=>"button"in t&&t.button!==0,middle:t=>"button"in t&&t.button!==1,right:t=>"button"in t&&t.button!==2,exact:(t,e)=>vE.some(n=>t[`${n}Key`]&&!e.includes(n))},wp=(t,e)=>{const n=t._withMods||(t._withMods={}),r=e.join(".");return n[r]||(n[r]=(s,...i)=>{for(let o=0;o<e.length;o++){const a=EE[e[o]];if(a&&a(s,e))return}return t(s,...i)})},IE=Ke({patchProp:mE},eE);let Sh;function wE(){return Sh||(Sh=Nv(IE))}const TE=(...t)=>{const e=wE().createApp(...t),{mount:n}=e;return e.mount=r=>{const s=RE(r);if(!s)return;const i=e._component;!X(i)&&!i.render&&!i.template&&(i.template=s.innerHTML),s.innerHTML="";const o=n(s,!1,AE(s));return s instanceof Element&&(s.removeAttribute("v-cloak"),s.setAttribute("data-v-app","")),o},e};function AE(t){if(t instanceof SVGElement)return"svg";if(typeof MathMLElement=="function"&&t instanceof MathMLElement)return"mathml"}function RE(t){return Ve(t)?document.querySelector(t):t}var SE=!1;/*!
 * pinia v2.1.7
 * (c) 2023 Eduardo San Martin Morote
 * @license MIT
 */let Tp;const Xo=t=>Tp=t,Ap=Symbol();function Ac(t){return t&&typeof t=="object"&&Object.prototype.toString.call(t)==="[object Object]"&&typeof t.toJSON!="function"}var Rs;(function(t){t.direct="direct",t.patchObject="patch object",t.patchFunction="patch function"})(Rs||(Rs={}));function PE(){const t=Cf(!0),e=t.run(()=>qo({}));let n=[],r=[];const s=$o({install(i){Xo(s),s._a=i,i.provide(Ap,s),i.config.globalProperties.$pinia=s,r.forEach(o=>n.push(o)),r=[]},use(i){return!this._a&&!SE?r.push(i):n.push(i),this},_p:n,_a:null,_e:t,_s:new Map,state:e});return s}const Rp=()=>{};function Ph(t,e,n,r=Rp){t.push(e);const s=()=>{const i=t.indexOf(e);i>-1&&(t.splice(i,1),r())};return!n&&bf()&&yy(s),s}function _r(t,...e){t.slice().forEach(n=>{n(...e)})}const CE=t=>t();function Rc(t,e){t instanceof Map&&e instanceof Map&&e.forEach((n,r)=>t.set(r,n)),t instanceof Set&&e instanceof Set&&e.forEach(t.add,t);for(const n in e){if(!e.hasOwnProperty(n))continue;const r=e[n],s=t[n];Ac(s)&&Ac(r)&&t.hasOwnProperty(n)&&!Ne(r)&&!Rn(r)?t[n]=Rc(s,r):t[n]=r}return t}const bE=Symbol();function kE(t){return!Ac(t)||!t.hasOwnProperty(bE)}const{assign:pn}=Object;function DE(t){return!!(Ne(t)&&t.effect)}function OE(t,e,n,r){const{state:s,actions:i,getters:o}=e,a=n.state.value[t];let c;function l(){a||(n.state.value[t]=s?s():{});const u=qy(n.state.value[t]);return pn(u,i,Object.keys(o||{}).reduce((h,d)=>(h[d]=$o(vt(()=>{Xo(n);const g=n._s.get(t);return o[d].call(g,g)})),h),{}))}return c=Sp(t,l,e,n,r,!0),c}function Sp(t,e,n={},r,s,i){let o;const a=pn({actions:{}},n),c={deep:!0};let l,u,h=[],d=[],g;const E=r.state.value[t];!i&&!E&&(r.state.value[t]={}),qo({});let R;function T(te){let ee;l=u=!1,typeof te=="function"?(te(r.state.value[t]),ee={type:Rs.patchFunction,storeId:t,events:g}):(Rc(r.state.value[t],te),ee={type:Rs.patchObject,payload:te,storeId:t,events:g});const _e=R=Symbol();Il().then(()=>{R===_e&&(l=!0)}),u=!0,_r(h,ee,r.state.value[t])}const P=i?function(){const{state:ee}=n,_e=ee?ee():{};this.$patch(We=>{pn(We,_e)})}:Rp;function M(){o.stop(),h=[],d=[],r._s.delete(t)}function F(te,ee){return function(){Xo(r);const _e=Array.from(arguments),We=[],ft=[];function _t(ce){We.push(ce)}function Bn(ce){ft.push(ce)}_r(d,{args:_e,name:te,store:Z,after:_t,onError:Bn});let yt;try{yt=ee.apply(this&&this.$id===t?this:Z,_e)}catch(ce){throw _r(ft,ce),ce}return yt instanceof Promise?yt.then(ce=>(_r(We,ce),ce)).catch(ce=>(_r(ft,ce),Promise.reject(ce))):(_r(We,yt),yt)}}const z={_p:r,$id:t,$onAction:Ph.bind(null,d),$patch:T,$reset:P,$subscribe(te,ee={}){const _e=Ph(h,te,ee.detached,()=>We()),We=o.run(()=>ws(()=>r.state.value[t],ft=>{(ee.flush==="sync"?u:l)&&te({storeId:t,type:Rs.direct,events:g},ft)},pn({},c,ee)));return _e},$dispose:M},Z=ai(z);r._s.set(t,Z);const de=(r._a&&r._a.runWithContext||CE)(()=>r._e.run(()=>(o=Cf()).run(e)));for(const te in de){const ee=de[te];if(Ne(ee)&&!DE(ee)||Rn(ee))i||(E&&kE(ee)&&(Ne(ee)?ee.value=E[te]:Rc(ee,E[te])),r.state.value[t][te]=ee);else if(typeof ee=="function"){const _e=F(te,ee);de[te]=_e,a.actions[te]=ee}}return pn(Z,de),pn(ae(Z),de),Object.defineProperty(Z,"$state",{get:()=>r.state.value[t],set:te=>{T(ee=>{pn(ee,te)})}}),r._p.forEach(te=>{pn(Z,o.run(()=>te({store:Z,app:r._a,pinia:r,options:a})))}),E&&i&&n.hydrate&&n.hydrate(Z.$state,E),l=!0,u=!0,Z}function Pp(t,e,n){let r,s;const i=typeof e=="function";typeof t=="string"?(r=t,s=i?n:e):(s=t,r=t.id);function o(a,c){const l=Cv();return a=a||(l?Ct(Ap,null):null),a&&Xo(a),a=Tp,a._s.has(r)||(i?Sp(r,e,s,a):OE(r,s,a)),a._s.get(r)}return o.$id=r,o}/*!
  * vue-router v4.2.5
  * (c) 2023 Eduardo San Martin Morote
  * @license MIT
  */const Er=typeof window<"u";function VE(t){return t.__esModule||t[Symbol.toStringTag]==="Module"}const fe=Object.assign;function qa(t,e){const n={};for(const r in e){const s=e[r];n[r]=bt(s)?s.map(t):t(s)}return n}const Ss=()=>{},bt=Array.isArray,NE=/\/$/,ME=t=>t.replace(NE,"");function Ha(t,e,n="/"){let r,s={},i="",o="";const a=e.indexOf("#");let c=e.indexOf("?");return a<c&&a>=0&&(c=-1),c>-1&&(r=e.slice(0,c),i=e.slice(c+1,a>-1?a:e.length),s=t(i)),a>-1&&(r=r||e.slice(0,a),o=e.slice(a,e.length)),r=UE(r??e,n),{fullPath:r+(i&&"?")+i+o,path:r,query:s,hash:o}}function xE(t,e){const n=e.query?t(e.query):"";return e.path+(n&&"?")+n+(e.hash||"")}function Ch(t,e){return!e||!t.toLowerCase().startsWith(e.toLowerCase())?t:t.slice(e.length)||"/"}function LE(t,e,n){const r=e.matched.length-1,s=n.matched.length-1;return r>-1&&r===s&&Fr(e.matched[r],n.matched[s])&&Cp(e.params,n.params)&&t(e.query)===t(n.query)&&e.hash===n.hash}function Fr(t,e){return(t.aliasOf||t)===(e.aliasOf||e)}function Cp(t,e){if(Object.keys(t).length!==Object.keys(e).length)return!1;for(const n in t)if(!FE(t[n],e[n]))return!1;return!0}function FE(t,e){return bt(t)?bh(t,e):bt(e)?bh(e,t):t===e}function bh(t,e){return bt(e)?t.length===e.length&&t.every((n,r)=>n===e[r]):t.length===1&&t[0]===e}function UE(t,e){if(t.startsWith("/"))return t;if(!t)return e;const n=e.split("/"),r=t.split("/"),s=r[r.length-1];(s===".."||s===".")&&r.push("");let i=n.length-1,o,a;for(o=0;o<r.length;o++)if(a=r[o],a!==".")if(a==="..")i>1&&i--;else break;return n.slice(0,i).join("/")+"/"+r.slice(o-(o===r.length?1:0)).join("/")}var Bs;(function(t){t.pop="pop",t.push="push"})(Bs||(Bs={}));var Ps;(function(t){t.back="back",t.forward="forward",t.unknown=""})(Ps||(Ps={}));function BE(t){if(!t)if(Er){const e=document.querySelector("base");t=e&&e.getAttribute("href")||"/",t=t.replace(/^\w+:\/\/[^\/]+/,"")}else t="/";return t[0]!=="/"&&t[0]!=="#"&&(t="/"+t),ME(t)}const jE=/^[^#]+#/;function $E(t,e){return t.replace(jE,"#")+e}function qE(t,e){const n=document.documentElement.getBoundingClientRect(),r=t.getBoundingClientRect();return{behavior:e.behavior,left:r.left-n.left-(e.left||0),top:r.top-n.top-(e.top||0)}}const Zo=()=>({left:window.pageXOffset,top:window.pageYOffset});function HE(t){let e;if("el"in t){const n=t.el,r=typeof n=="string"&&n.startsWith("#"),s=typeof n=="string"?r?document.getElementById(n.slice(1)):document.querySelector(n):n;if(!s)return;e=qE(s,t)}else e=t;"scrollBehavior"in document.documentElement.style?window.scrollTo(e):window.scrollTo(e.left!=null?e.left:window.pageXOffset,e.top!=null?e.top:window.pageYOffset)}function kh(t,e){return(history.state?history.state.position-e:-1)+t}const Sc=new Map;function KE(t,e){Sc.set(t,e)}function WE(t){const e=Sc.get(t);return Sc.delete(t),e}let zE=()=>location.protocol+"//"+location.host;function bp(t,e){const{pathname:n,search:r,hash:s}=e,i=t.indexOf("#");if(i>-1){let a=s.includes(t.slice(i))?t.slice(i).length:1,c=s.slice(a);return c[0]!=="/"&&(c="/"+c),Ch(c,"")}return Ch(n,t)+r+s}function GE(t,e,n,r){let s=[],i=[],o=null;const a=({state:d})=>{const g=bp(t,location),E=n.value,R=e.value;let T=0;if(d){if(n.value=g,e.value=d,o&&o===E){o=null;return}T=R?d.position-R.position:0}else r(g);s.forEach(P=>{P(n.value,E,{delta:T,type:Bs.pop,direction:T?T>0?Ps.forward:Ps.back:Ps.unknown})})};function c(){o=n.value}function l(d){s.push(d);const g=()=>{const E=s.indexOf(d);E>-1&&s.splice(E,1)};return i.push(g),g}function u(){const{history:d}=window;d.state&&d.replaceState(fe({},d.state,{scroll:Zo()}),"")}function h(){for(const d of i)d();i=[],window.removeEventListener("popstate",a),window.removeEventListener("beforeunload",u)}return window.addEventListener("popstate",a),window.addEventListener("beforeunload",u,{passive:!0}),{pauseListeners:c,listen:l,destroy:h}}function Dh(t,e,n,r=!1,s=!1){return{back:t,current:e,forward:n,replaced:r,position:window.history.length,scroll:s?Zo():null}}function QE(t){const{history:e,location:n}=window,r={value:bp(t,n)},s={value:e.state};s.value||i(r.value,{back:null,current:r.value,forward:null,position:e.length-1,replaced:!0,scroll:null},!0);function i(c,l,u){const h=t.indexOf("#"),d=h>-1?(n.host&&document.querySelector("base")?t:t.slice(h))+c:zE()+t+c;try{e[u?"replaceState":"pushState"](l,"",d),s.value=l}catch(g){console.error(g),n[u?"replace":"assign"](d)}}function o(c,l){const u=fe({},e.state,Dh(s.value.back,c,s.value.forward,!0),l,{position:s.value.position});i(c,u,!0),r.value=c}function a(c,l){const u=fe({},s.value,e.state,{forward:c,scroll:Zo()});i(u.current,u,!0);const h=fe({},Dh(r.value,c,null),{position:u.position+1},l);i(c,h,!1),r.value=c}return{location:r,state:s,push:a,replace:o}}function YE(t){t=BE(t);const e=QE(t),n=GE(t,e.state,e.location,e.replace);function r(i,o=!0){o||n.pauseListeners(),history.go(i)}const s=fe({location:"",base:t,go:r,createHref:$E.bind(null,t)},e,n);return Object.defineProperty(s,"location",{enumerable:!0,get:()=>e.location.value}),Object.defineProperty(s,"state",{enumerable:!0,get:()=>e.state.value}),s}function JE(t){return typeof t=="string"||t&&typeof t=="object"}function kp(t){return typeof t=="string"||typeof t=="symbol"}const dn={path:"/",name:void 0,params:{},query:{},hash:"",fullPath:"/",matched:[],meta:{},redirectedFrom:void 0},Dp=Symbol("");var Oh;(function(t){t[t.aborted=4]="aborted",t[t.cancelled=8]="cancelled",t[t.duplicated=16]="duplicated"})(Oh||(Oh={}));function Ur(t,e){return fe(new Error,{type:t,[Dp]:!0},e)}function Qt(t,e){return t instanceof Error&&Dp in t&&(e==null||!!(t.type&e))}const Vh="[^/]+?",XE={sensitive:!1,strict:!1,start:!0,end:!0},ZE=/[.+*?^${}()[\]/\\]/g;function eI(t,e){const n=fe({},XE,e),r=[];let s=n.start?"^":"";const i=[];for(const l of t){const u=l.length?[]:[90];n.strict&&!l.length&&(s+="/");for(let h=0;h<l.length;h++){const d=l[h];let g=40+(n.sensitive?.25:0);if(d.type===0)h||(s+="/"),s+=d.value.replace(ZE,"\\$&"),g+=40;else if(d.type===1){const{value:E,repeatable:R,optional:T,regexp:P}=d;i.push({name:E,repeatable:R,optional:T});const M=P||Vh;if(M!==Vh){g+=10;try{new RegExp(`(${M})`)}catch(z){throw new Error(`Invalid custom RegExp for param "${E}" (${M}): `+z.message)}}let F=R?`((?:${M})(?:/(?:${M}))*)`:`(${M})`;h||(F=T&&l.length<2?`(?:/${F})`:"/"+F),T&&(F+="?"),s+=F,g+=20,T&&(g+=-8),R&&(g+=-20),M===".*"&&(g+=-50)}u.push(g)}r.push(u)}if(n.strict&&n.end){const l=r.length-1;r[l][r[l].length-1]+=.7000000000000001}n.strict||(s+="/?"),n.end?s+="$":n.strict&&(s+="(?:/|$)");const o=new RegExp(s,n.sensitive?"":"i");function a(l){const u=l.match(o),h={};if(!u)return null;for(let d=1;d<u.length;d++){const g=u[d]||"",E=i[d-1];h[E.name]=g&&E.repeatable?g.split("/"):g}return h}function c(l){let u="",h=!1;for(const d of t){(!h||!u.endsWith("/"))&&(u+="/"),h=!1;for(const g of d)if(g.type===0)u+=g.value;else if(g.type===1){const{value:E,repeatable:R,optional:T}=g,P=E in l?l[E]:"";if(bt(P)&&!R)throw new Error(`Provided param "${E}" is an array but it is not repeatable (* or + modifiers)`);const M=bt(P)?P.join("/"):P;if(!M)if(T)d.length<2&&(u.endsWith("/")?u=u.slice(0,-1):h=!0);else throw new Error(`Missing required param "${E}"`);u+=M}}return u||"/"}return{re:o,score:r,keys:i,parse:a,stringify:c}}function tI(t,e){let n=0;for(;n<t.length&&n<e.length;){const r=e[n]-t[n];if(r)return r;n++}return t.length<e.length?t.length===1&&t[0]===80?-1:1:t.length>e.length?e.length===1&&e[0]===80?1:-1:0}function nI(t,e){let n=0;const r=t.score,s=e.score;for(;n<r.length&&n<s.length;){const i=tI(r[n],s[n]);if(i)return i;n++}if(Math.abs(s.length-r.length)===1){if(Nh(r))return 1;if(Nh(s))return-1}return s.length-r.length}function Nh(t){const e=t[t.length-1];return t.length>0&&e[e.length-1]<0}const rI={type:0,value:""},sI=/[a-zA-Z0-9_]/;function iI(t){if(!t)return[[]];if(t==="/")return[[rI]];if(!t.startsWith("/"))throw new Error(`Invalid path "${t}"`);function e(g){throw new Error(`ERR (${n})/"${l}": ${g}`)}let n=0,r=n;const s=[];let i;function o(){i&&s.push(i),i=[]}let a=0,c,l="",u="";function h(){l&&(n===0?i.push({type:0,value:l}):n===1||n===2||n===3?(i.length>1&&(c==="*"||c==="+")&&e(`A repeatable param (${l}) must be alone in its segment. eg: '/:ids+.`),i.push({type:1,value:l,regexp:u,repeatable:c==="*"||c==="+",optional:c==="*"||c==="?"})):e("Invalid state to consume buffer"),l="")}function d(){l+=c}for(;a<t.length;){if(c=t[a++],c==="\\"&&n!==2){r=n,n=4;continue}switch(n){case 0:c==="/"?(l&&h(),o()):c===":"?(h(),n=1):d();break;case 4:d(),n=r;break;case 1:c==="("?n=2:sI.test(c)?d():(h(),n=0,c!=="*"&&c!=="?"&&c!=="+"&&a--);break;case 2:c===")"?u[u.length-1]=="\\"?u=u.slice(0,-1)+c:n=3:u+=c;break;case 3:h(),n=0,c!=="*"&&c!=="?"&&c!=="+"&&a--,u="";break;default:e("Unknown state");break}}return n===2&&e(`Unfinished custom RegExp for param "${l}"`),h(),o(),s}function oI(t,e,n){const r=eI(iI(t.path),n),s=fe(r,{record:t,parent:e,children:[],alias:[]});return e&&!s.record.aliasOf==!e.record.aliasOf&&e.children.push(s),s}function aI(t,e){const n=[],r=new Map;e=Lh({strict:!1,end:!0,sensitive:!1},e);function s(u){return r.get(u)}function i(u,h,d){const g=!d,E=cI(u);E.aliasOf=d&&d.record;const R=Lh(e,u),T=[E];if("alias"in u){const F=typeof u.alias=="string"?[u.alias]:u.alias;for(const z of F)T.push(fe({},E,{components:d?d.record.components:E.components,path:z,aliasOf:d?d.record:E}))}let P,M;for(const F of T){const{path:z}=F;if(h&&z[0]!=="/"){const Z=h.record.path,$=Z[Z.length-1]==="/"?"":"/";F.path=h.record.path+(z&&$+z)}if(P=oI(F,h,R),d?d.alias.push(P):(M=M||P,M!==P&&M.alias.push(P),g&&u.name&&!xh(P)&&o(u.name)),E.children){const Z=E.children;for(let $=0;$<Z.length;$++)i(Z[$],P,d&&d.children[$])}d=d||P,(P.record.components&&Object.keys(P.record.components).length||P.record.name||P.record.redirect)&&c(P)}return M?()=>{o(M)}:Ss}function o(u){if(kp(u)){const h=r.get(u);h&&(r.delete(u),n.splice(n.indexOf(h),1),h.children.forEach(o),h.alias.forEach(o))}else{const h=n.indexOf(u);h>-1&&(n.splice(h,1),u.record.name&&r.delete(u.record.name),u.children.forEach(o),u.alias.forEach(o))}}function a(){return n}function c(u){let h=0;for(;h<n.length&&nI(u,n[h])>=0&&(u.record.path!==n[h].record.path||!Op(u,n[h]));)h++;n.splice(h,0,u),u.record.name&&!xh(u)&&r.set(u.record.name,u)}function l(u,h){let d,g={},E,R;if("name"in u&&u.name){if(d=r.get(u.name),!d)throw Ur(1,{location:u});R=d.record.name,g=fe(Mh(h.params,d.keys.filter(M=>!M.optional).map(M=>M.name)),u.params&&Mh(u.params,d.keys.map(M=>M.name))),E=d.stringify(g)}else if("path"in u)E=u.path,d=n.find(M=>M.re.test(E)),d&&(g=d.parse(E),R=d.record.name);else{if(d=h.name?r.get(h.name):n.find(M=>M.re.test(h.path)),!d)throw Ur(1,{location:u,currentLocation:h});R=d.record.name,g=fe({},h.params,u.params),E=d.stringify(g)}const T=[];let P=d;for(;P;)T.unshift(P.record),P=P.parent;return{name:R,path:E,params:g,matched:T,meta:uI(T)}}return t.forEach(u=>i(u)),{addRoute:i,resolve:l,removeRoute:o,getRoutes:a,getRecordMatcher:s}}function Mh(t,e){const n={};for(const r of e)r in t&&(n[r]=t[r]);return n}function cI(t){return{path:t.path,redirect:t.redirect,name:t.name,meta:t.meta||{},aliasOf:void 0,beforeEnter:t.beforeEnter,props:lI(t),children:t.children||[],instances:{},leaveGuards:new Set,updateGuards:new Set,enterCallbacks:{},components:"components"in t?t.components||null:t.component&&{default:t.component}}}function lI(t){const e={},n=t.props||!1;if("component"in t)e.default=n;else for(const r in t.components)e[r]=typeof n=="object"?n[r]:n;return e}function xh(t){for(;t;){if(t.record.aliasOf)return!0;t=t.parent}return!1}function uI(t){return t.reduce((e,n)=>fe(e,n.meta),{})}function Lh(t,e){const n={};for(const r in t)n[r]=r in e?e[r]:t[r];return n}function Op(t,e){return e.children.some(n=>n===t||Op(t,n))}const Vp=/#/g,hI=/&/g,dI=/\//g,fI=/=/g,pI=/\?/g,Np=/\+/g,gI=/%5B/g,mI=/%5D/g,Mp=/%5E/g,_I=/%60/g,xp=/%7B/g,yI=/%7C/g,Lp=/%7D/g,vI=/%20/g;function kl(t){return encodeURI(""+t).replace(yI,"|").replace(gI,"[").replace(mI,"]")}function EI(t){return kl(t).replace(xp,"{").replace(Lp,"}").replace(Mp,"^")}function Pc(t){return kl(t).replace(Np,"%2B").replace(vI,"+").replace(Vp,"%23").replace(hI,"%26").replace(_I,"`").replace(xp,"{").replace(Lp,"}").replace(Mp,"^")}function II(t){return Pc(t).replace(fI,"%3D")}function wI(t){return kl(t).replace(Vp,"%23").replace(pI,"%3F")}function TI(t){return t==null?"":wI(t).replace(dI,"%2F")}function go(t){try{return decodeURIComponent(""+t)}catch{}return""+t}function AI(t){const e={};if(t===""||t==="?")return e;const r=(t[0]==="?"?t.slice(1):t).split("&");for(let s=0;s<r.length;++s){const i=r[s].replace(Np," "),o=i.indexOf("="),a=go(o<0?i:i.slice(0,o)),c=o<0?null:go(i.slice(o+1));if(a in e){let l=e[a];bt(l)||(l=e[a]=[l]),l.push(c)}else e[a]=c}return e}function Fh(t){let e="";for(let n in t){const r=t[n];if(n=II(n),r==null){r!==void 0&&(e+=(e.length?"&":"")+n);continue}(bt(r)?r.map(i=>i&&Pc(i)):[r&&Pc(r)]).forEach(i=>{i!==void 0&&(e+=(e.length?"&":"")+n,i!=null&&(e+="="+i))})}return e}function RI(t){const e={};for(const n in t){const r=t[n];r!==void 0&&(e[n]=bt(r)?r.map(s=>s==null?null:""+s):r==null?r:""+r)}return e}const SI=Symbol(""),Uh=Symbol(""),ea=Symbol(""),Fp=Symbol(""),Cc=Symbol("");function us(){let t=[];function e(r){return t.push(r),()=>{const s=t.indexOf(r);s>-1&&t.splice(s,1)}}function n(){t=[]}return{add:e,list:()=>t.slice(),reset:n}}function yn(t,e,n,r,s){const i=r&&(r.enterCallbacks[s]=r.enterCallbacks[s]||[]);return()=>new Promise((o,a)=>{const c=h=>{h===!1?a(Ur(4,{from:n,to:e})):h instanceof Error?a(h):JE(h)?a(Ur(2,{from:e,to:h})):(i&&r.enterCallbacks[s]===i&&typeof h=="function"&&i.push(h),o())},l=t.call(r&&r.instances[s],e,n,c);let u=Promise.resolve(l);t.length<3&&(u=u.then(c)),u.catch(h=>a(h))})}function Ka(t,e,n,r){const s=[];for(const i of t)for(const o in i.components){let a=i.components[o];if(!(e!=="beforeRouteEnter"&&!i.instances[o]))if(PI(a)){const l=(a.__vccOpts||a)[e];l&&s.push(yn(l,n,r,i,o))}else{let c=a();s.push(()=>c.then(l=>{if(!l)return Promise.reject(new Error(`Couldn't resolve component "${o}" at "${i.path}"`));const u=VE(l)?l.default:l;i.components[o]=u;const d=(u.__vccOpts||u)[e];return d&&yn(d,n,r,i,o)()}))}}return s}function PI(t){return typeof t=="object"||"displayName"in t||"props"in t||"__vccOpts"in t}function Bh(t){const e=Ct(ea),n=Ct(Fp),r=vt(()=>e.resolve(xe(t.to))),s=vt(()=>{const{matched:c}=r.value,{length:l}=c,u=c[l-1],h=n.matched;if(!u||!h.length)return-1;const d=h.findIndex(Fr.bind(null,u));if(d>-1)return d;const g=jh(c[l-2]);return l>1&&jh(u)===g&&h[h.length-1].path!==g?h.findIndex(Fr.bind(null,c[l-2])):d}),i=vt(()=>s.value>-1&&DI(n.params,r.value.params)),o=vt(()=>s.value>-1&&s.value===n.matched.length-1&&Cp(n.params,r.value.params));function a(c={}){return kI(c)?e[xe(t.replace)?"replace":"push"](xe(t.to)).catch(Ss):Promise.resolve()}return{route:r,href:vt(()=>r.value.href),isActive:i,isExactActive:o,navigate:a}}const CI=Rl({name:"RouterLink",compatConfig:{MODE:3},props:{to:{type:[String,Object],required:!0},replace:Boolean,activeClass:String,exactActiveClass:String,custom:Boolean,ariaCurrentValue:{type:String,default:"page"}},useLink:Bh,setup(t,{slots:e}){const n=ai(Bh(t)),{options:r}=Ct(ea),s=vt(()=>({[$h(t.activeClass,r.linkActiveClass,"router-link-active")]:n.isActive,[$h(t.exactActiveClass,r.linkExactActiveClass,"router-link-exact-active")]:n.isExactActive}));return()=>{const i=e.default&&e.default(n);return t.custom?i:Ip("a",{"aria-current":n.isExactActive?t.ariaCurrentValue:null,href:n.href,onClick:n.navigate,class:s.value},i)}}}),bI=CI;function kI(t){if(!(t.metaKey||t.altKey||t.ctrlKey||t.shiftKey)&&!t.defaultPrevented&&!(t.button!==void 0&&t.button!==0)){if(t.currentTarget&&t.currentTarget.getAttribute){const e=t.currentTarget.getAttribute("target");if(/\b_blank\b/i.test(e))return}return t.preventDefault&&t.preventDefault(),!0}}function DI(t,e){for(const n in e){const r=e[n],s=t[n];if(typeof r=="string"){if(r!==s)return!1}else if(!bt(s)||s.length!==r.length||r.some((i,o)=>i!==s[o]))return!1}return!0}function jh(t){return t?t.aliasOf?t.aliasOf.path:t.path:""}const $h=(t,e,n)=>t??e??n,OI=Rl({name:"RouterView",inheritAttrs:!1,props:{name:{type:String,default:"default"},route:Object},compatConfig:{MODE:3},setup(t,{attrs:e,slots:n}){const r=Ct(Cc),s=vt(()=>t.route||r.value),i=Ct(Uh,0),o=vt(()=>{let l=xe(i);const{matched:u}=s.value;let h;for(;(h=u[l])&&!h.components;)l++;return l}),a=vt(()=>s.value.matched[o.value]);Yi(Uh,vt(()=>o.value+1)),Yi(SI,a),Yi(Cc,s);const c=qo();return ws(()=>[c.value,a.value,t.name],([l,u,h],[d,g,E])=>{u&&(u.instances[h]=l,g&&g!==u&&l&&l===d&&(u.leaveGuards.size||(u.leaveGuards=g.leaveGuards),u.updateGuards.size||(u.updateGuards=g.updateGuards))),l&&u&&(!g||!Fr(u,g)||!d)&&(u.enterCallbacks[h]||[]).forEach(R=>R(l))},{flush:"post"}),()=>{const l=s.value,u=t.name,h=a.value,d=h&&h.components[u];if(!d)return qh(n.default,{Component:d,route:l});const g=h.props[u],E=g?g===!0?l.params:typeof g=="function"?g(l):g:null,T=Ip(d,fe({},E,e,{onVnodeUnmounted:P=>{P.component.isUnmounted&&(h.instances[u]=null)},ref:c}));return qh(n.default,{Component:T,route:l})||T}}});function qh(t,e){if(!t)return null;const n=t(e);return n.length===1?n[0]:n}const Up=OI;function VI(t){const e=aI(t.routes,t),n=t.parseQuery||AI,r=t.stringifyQuery||Fh,s=t.history,i=us(),o=us(),a=us(),c=By(dn);let l=dn;Er&&t.scrollBehavior&&"scrollRestoration"in history&&(history.scrollRestoration="manual");const u=qa.bind(null,y=>""+y),h=qa.bind(null,TI),d=qa.bind(null,go);function g(y,x){let O,U;return kp(y)?(O=e.getRecordMatcher(y),U=x):U=y,e.addRoute(U,O)}function E(y){const x=e.getRecordMatcher(y);x&&e.removeRoute(x)}function R(){return e.getRoutes().map(y=>y.record)}function T(y){return!!e.getRecordMatcher(y)}function P(y,x){if(x=fe({},x||c.value),typeof y=="string"){const p=Ha(n,y,x.path),m=e.resolve({path:p.path},x),I=s.createHref(p.fullPath);return fe(p,m,{params:d(m.params),hash:go(p.hash),redirectedFrom:void 0,href:I})}let O;if("path"in y)O=fe({},y,{path:Ha(n,y.path,x.path).path});else{const p=fe({},y.params);for(const m in p)p[m]==null&&delete p[m];O=fe({},y,{params:h(p)}),x.params=h(x.params)}const U=e.resolve(O,x),he=y.hash||"";U.params=u(d(U.params));const we=xE(r,fe({},y,{hash:EI(he),path:U.path})),f=s.createHref(we);return fe({fullPath:we,hash:he,query:r===Fh?RI(y.query):y.query||{}},U,{redirectedFrom:void 0,href:f})}function M(y){return typeof y=="string"?Ha(n,y,c.value.path):fe({},y)}function F(y,x){if(l!==y)return Ur(8,{from:x,to:y})}function z(y){return de(y)}function Z(y){return z(fe(M(y),{replace:!0}))}function $(y){const x=y.matched[y.matched.length-1];if(x&&x.redirect){const{redirect:O}=x;let U=typeof O=="function"?O(y):O;return typeof U=="string"&&(U=U.includes("?")||U.includes("#")?U=M(U):{path:U},U.params={}),fe({query:y.query,hash:y.hash,params:"path"in U?{}:y.params},U)}}function de(y,x){const O=l=P(y),U=c.value,he=y.state,we=y.force,f=y.replace===!0,p=$(O);if(p)return de(fe(M(p),{state:typeof p=="object"?fe({},he,p.state):he,force:we,replace:f}),x||O);const m=O;m.redirectedFrom=x;let I;return!we&&LE(r,U,O)&&(I=Ur(16,{to:m,from:U}),Vt(U,U,!0,!1)),(I?Promise.resolve(I):_e(m,U)).catch(_=>Qt(_)?Qt(_,2)?_:un(_):ue(_,m,U)).then(_=>{if(_){if(Qt(_,2))return de(fe({replace:f},M(_.to),{state:typeof _.to=="object"?fe({},he,_.to.state):he,force:we}),x||m)}else _=ft(m,U,!0,f,he);return We(m,U,_),_})}function te(y,x){const O=F(y,x);return O?Promise.reject(O):Promise.resolve()}function ee(y){const x=gr.values().next().value;return x&&typeof x.runWithContext=="function"?x.runWithContext(y):y()}function _e(y,x){let O;const[U,he,we]=NI(y,x);O=Ka(U.reverse(),"beforeRouteLeave",y,x);for(const p of U)p.leaveGuards.forEach(m=>{O.push(yn(m,y,x))});const f=te.bind(null,y,x);return O.push(f),ze(O).then(()=>{O=[];for(const p of i.list())O.push(yn(p,y,x));return O.push(f),ze(O)}).then(()=>{O=Ka(he,"beforeRouteUpdate",y,x);for(const p of he)p.updateGuards.forEach(m=>{O.push(yn(m,y,x))});return O.push(f),ze(O)}).then(()=>{O=[];for(const p of we)if(p.beforeEnter)if(bt(p.beforeEnter))for(const m of p.beforeEnter)O.push(yn(m,y,x));else O.push(yn(p.beforeEnter,y,x));return O.push(f),ze(O)}).then(()=>(y.matched.forEach(p=>p.enterCallbacks={}),O=Ka(we,"beforeRouteEnter",y,x),O.push(f),ze(O))).then(()=>{O=[];for(const p of o.list())O.push(yn(p,y,x));return O.push(f),ze(O)}).catch(p=>Qt(p,8)?p:Promise.reject(p))}function We(y,x,O){a.list().forEach(U=>ee(()=>U(y,x,O)))}function ft(y,x,O,U,he){const we=F(y,x);if(we)return we;const f=x===dn,p=Er?history.state:{};O&&(U||f?s.replace(y.fullPath,fe({scroll:f&&p&&p.scroll},he)):s.push(y.fullPath,he)),c.value=y,Vt(y,x,O,f),un()}let _t;function Bn(){_t||(_t=s.listen((y,x,O)=>{if(!bi.listening)return;const U=P(y),he=$(U);if(he){de(fe(he,{replace:!0}),U).catch(Ss);return}l=U;const we=c.value;Er&&KE(kh(we.fullPath,O.delta),Zo()),_e(U,we).catch(f=>Qt(f,12)?f:Qt(f,2)?(de(f.to,U).then(p=>{Qt(p,20)&&!O.delta&&O.type===Bs.pop&&s.go(-1,!1)}).catch(Ss),Promise.reject()):(O.delta&&s.go(-O.delta,!1),ue(f,U,we))).then(f=>{f=f||ft(U,we,!1),f&&(O.delta&&!Qt(f,8)?s.go(-O.delta,!1):O.type===Bs.pop&&Qt(f,20)&&s.go(-1,!1)),We(U,we,f)}).catch(Ss)}))}let yt=us(),ce=us(),ge;function ue(y,x,O){un(y);const U=ce.list();return U.length?U.forEach(he=>he(y,x,O)):console.error(y),Promise.reject(y)}function Gt(){return ge&&c.value!==dn?Promise.resolve():new Promise((y,x)=>{yt.add([y,x])})}function un(y){return ge||(ge=!y,Bn(),yt.list().forEach(([x,O])=>y?O(y):x()),yt.reset()),y}function Vt(y,x,O,U){const{scrollBehavior:he}=t;if(!Er||!he)return Promise.resolve();const we=!O&&WE(kh(y.fullPath,0))||(U||!O)&&history.state&&history.state.scroll||null;return Il().then(()=>he(y,x,we)).then(f=>f&&HE(f)).catch(f=>ue(f,y,x))}const ct=y=>s.go(y);let pr;const gr=new Set,bi={currentRoute:c,listening:!0,addRoute:g,removeRoute:E,hasRoute:T,getRoutes:R,resolve:P,options:t,push:z,replace:Z,go:ct,back:()=>ct(-1),forward:()=>ct(1),beforeEach:i.add,beforeResolve:o.add,afterEach:a.add,onError:ce.add,isReady:Gt,install(y){const x=this;y.component("RouterLink",bI),y.component("RouterView",Up),y.config.globalProperties.$router=x,Object.defineProperty(y.config.globalProperties,"$route",{enumerable:!0,get:()=>xe(c)}),Er&&!pr&&c.value===dn&&(pr=!0,z(s.location).catch(he=>{}));const O={};for(const he in dn)Object.defineProperty(O,he,{get:()=>c.value[he],enumerable:!0});y.provide(ea,x),y.provide(Fp,$f(O)),y.provide(Cc,c);const U=y.unmount;gr.add(y),y.unmount=function(){gr.delete(y),gr.size<1&&(l=dn,_t&&_t(),_t=null,c.value=dn,pr=!1,ge=!1),U()}}};function ze(y){return y.reduce((x,O)=>x.then(()=>ee(O)),Promise.resolve())}return bi}function NI(t,e){const n=[],r=[],s=[],i=Math.max(e.matched.length,t.matched.length);for(let o=0;o<i;o++){const a=e.matched[o];a&&(t.matched.find(l=>Fr(l,a))?r.push(a):n.push(a));const c=t.matched[o];c&&(e.matched.find(l=>Fr(l,c))||s.push(c))}return[n,r,s]}function Bp(){return Ct(ea)}const MI=Rl({__name:"App",setup(t){return(e,n)=>(Xe(),mp(xe(Up)))}});var Hh={};/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ZI="FirebaseError";class ln extends Error{constructor(e,n,r){super(n),this.code=e,this.customData=r,this.name=ZI,Object.setPrototypeOf(this,ln.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,li.prototype.create)}}class li{constructor(e,n,r){this.service=e,this.serviceName=n,this.errors=r}create(e,...n){const r=n[0]||{},s=`${this.service}/${e}`,i=this.errors[e],o=i?ew(i,r):"Error",a=`${this.serviceName}: ${o} (${s}).`;return new ln(s,a,r)}}function ew(t,e){return t.replace(tw,(n,r)=>{const s=e[r];return s!=null?String(s):`<${r}?>`})}const tw=/\{\$([^}]+)}/g;function nw(t){for(const e in t)if(Object.prototype.hasOwnProperty.call(t,e))return!1;return!0}function _o(t,e){if(t===e)return!0;const n=Object.keys(t),r=Object.keys(e);for(const s of n){if(!r.includes(s))return!1;const i=t[s],o=e[s];if(Kh(i)&&Kh(o)){if(!_o(i,o))return!1}else if(i!==o)return!1}for(const s of r)if(!n.includes(s))return!1;return!0}function Kh(t){return t!==null&&typeof t=="object"}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var se;(function(t){t[t.DEBUG=0]="DEBUG",t[t.VERBOSE=1]="VERBOSE",t[t.INFO=2]="INFO",t[t.WARN=3]="WARN",t[t.ERROR=4]="ERROR",t[t.SILENT=5]="SILENT"})(se||(se={}));const uw={debug:se.DEBUG,verbose:se.VERBOSE,info:se.INFO,warn:se.WARN,error:se.ERROR,silent:se.SILENT},hw=se.INFO,dw={[se.DEBUG]:"log",[se.VERBOSE]:"log",[se.INFO]:"info",[se.WARN]:"warn",[se.ERROR]:"error"},fw=(t,e,...n)=>{if(e<t.logLevel)return;const r=new Date().toISOString(),s=dw[e];if(s)console[s](`[${r}]  ${t.name}:`,...n);else throw new Error(`Attempted to log a message with an invalid logType (value: ${e})`)};class Dl{constructor(e){this.name=e,this._logLevel=hw,this._logHandler=fw,this._userLogHandler=null}get logLevel(){return this._logLevel}set logLevel(e){if(!(e in se))throw new TypeError(`Invalid value "${e}" assigned to \`logLevel\``);this._logLevel=e}setLogLevel(e){this._logLevel=typeof e=="string"?uw[e]:e}get logHandler(){return this._logHandler}set logHandler(e){if(typeof e!="function")throw new TypeError("Value assigned to `logHandler` must be a function");this._logHandler=e}get userLogHandler(){return this._userLogHandler}set userLogHandler(e){this._userLogHandler=e}debug(...e){this._userLogHandler&&this._userLogHandler(this,se.DEBUG,...e),this._logHandler(this,se.DEBUG,...e)}log(...e){this._userLogHandler&&this._userLogHandler(this,se.VERBOSE,...e),this._logHandler(this,se.VERBOSE,...e)}info(...e){this._userLogHandler&&this._userLogHandler(this,se.INFO,...e),this._logHandler(this,se.INFO,...e)}warn(...e){this._userLogHandler&&this._userLogHandler(this,se.WARN,...e),this._logHandler(this,se.WARN,...e)}error(...e){this._userLogHandler&&this._userLogHandler(this,se.ERROR,...e),this._logHandler(this,se.ERROR,...e)}}const pw=(t,e)=>e.some(n=>t instanceof n);let Wh,zh;function gw(){return Wh||(Wh=[IDBDatabase,IDBObjectStore,IDBIndex,IDBCursor,IDBTransaction])}function mw(){return zh||(zh=[IDBCursor.prototype.advance,IDBCursor.prototype.continue,IDBCursor.prototype.continuePrimaryKey])}const Gp=new WeakMap,bc=new WeakMap,Qp=new WeakMap,za=new WeakMap,Ol=new WeakMap;function _w(t){const e=new Promise((n,r)=>{const s=()=>{t.removeEventListener("success",i),t.removeEventListener("error",o)},i=()=>{n(Pn(t.result)),s()},o=()=>{r(t.error),s()};t.addEventListener("success",i),t.addEventListener("error",o)});return e.then(n=>{n instanceof IDBCursor&&Gp.set(n,t)}).catch(()=>{}),Ol.set(e,t),e}function yw(t){if(bc.has(t))return;const e=new Promise((n,r)=>{const s=()=>{t.removeEventListener("complete",i),t.removeEventListener("error",o),t.removeEventListener("abort",o)},i=()=>{n(),s()},o=()=>{r(t.error||new DOMException("AbortError","AbortError")),s()};t.addEventListener("complete",i),t.addEventListener("error",o),t.addEventListener("abort",o)});bc.set(t,e)}let kc={get(t,e,n){if(t instanceof IDBTransaction){if(e==="done")return bc.get(t);if(e==="objectStoreNames")return t.objectStoreNames||Qp.get(t);if(e==="store")return n.objectStoreNames[1]?void 0:n.objectStore(n.objectStoreNames[0])}return Pn(t[e])},set(t,e,n){return t[e]=n,!0},has(t,e){return t instanceof IDBTransaction&&(e==="done"||e==="store")?!0:e in t}};function vw(t){kc=t(kc)}function Ew(t){return t===IDBDatabase.prototype.transaction&&!("objectStoreNames"in IDBTransaction.prototype)?function(e,...n){const r=t.call(Ga(this),e,...n);return Qp.set(r,e.sort?e.sort():[e]),Pn(r)}:mw().includes(t)?function(...e){return t.apply(Ga(this),e),Pn(Gp.get(this))}:function(...e){return Pn(t.apply(Ga(this),e))}}function Iw(t){return typeof t=="function"?Ew(t):(t instanceof IDBTransaction&&yw(t),pw(t,gw())?new Proxy(t,kc):t)}function Pn(t){if(t instanceof IDBRequest)return _w(t);if(za.has(t))return za.get(t);const e=Iw(t);return e!==t&&(za.set(t,e),Ol.set(e,t)),e}const Ga=t=>Ol.get(t);function ww(t,e,{blocked:n,upgrade:r,blocking:s,terminated:i}={}){const o=indexedDB.open(t,e),a=Pn(o);return r&&o.addEventListener("upgradeneeded",c=>{r(Pn(o.result),c.oldVersion,c.newVersion,Pn(o.transaction),c)}),n&&o.addEventListener("blocked",c=>n(c.oldVersion,c.newVersion,c)),a.then(c=>{i&&c.addEventListener("close",()=>i()),s&&c.addEventListener("versionchange",l=>s(l.oldVersion,l.newVersion,l))}).catch(()=>{}),a}const Tw=["get","getKey","getAll","getAllKeys","count"],Aw=["put","add","delete","clear"],Qa=new Map;function Gh(t,e){if(!(t instanceof IDBDatabase&&!(e in t)&&typeof e=="string"))return;if(Qa.get(e))return Qa.get(e);const n=e.replace(/FromIndex$/,""),r=e!==n,s=Aw.includes(n);if(!(n in(r?IDBIndex:IDBObjectStore).prototype)||!(s||Tw.includes(n)))return;const i=async function(o,...a){const c=this.transaction(o,s?"readwrite":"readonly");let l=c.store;return r&&(l=l.index(a.shift())),(await Promise.all([l[n](...a),s&&c.done]))[0]};return Qa.set(e,i),i}vw(t=>({...t,get:(e,n,r)=>Gh(e,n)||t.get(e,n,r),has:(e,n)=>!!Gh(e,n)||t.has(e,n)}));/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Rw{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(n=>{if(Sw(n)){const r=n.getImmediate();return`${r.library}/${r.version}`}else return null}).filter(n=>n).join(" ")}}function Sw(t){const e=t.getComponent();return(e==null?void 0:e.type)==="VERSION"}const Dc="@firebase/app",Qh="0.9.26";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const eT={"no-app":"No Firebase App '{$appName}' has been created - call initializeApp() first","bad-app-name":"Illegal App name: '{$appName}","duplicate-app":"Firebase App named '{$appName}' already exists with different options or config","app-deleted":"Firebase App named '{$appName}' already deleted","no-options":"Need to provide options, when not being deployed to hosting via source.","invalid-app-argument":"firebase.{$appName}() takes either no argument or a Firebase App instance.","invalid-log-argument":"First argument to `onLog` must be null or a function.","idb-open":"Error thrown when opening IndexedDB. Original error: {$originalErrorMessage}.","idb-get":"Error thrown when reading from IndexedDB. Original error: {$originalErrorMessage}.","idb-set":"Error thrown when writing to IndexedDB. Original error: {$originalErrorMessage}.","idb-delete":"Error thrown when deleting from IndexedDB. Original error: {$originalErrorMessage}."},Cn=new li("app","Firebase",eT);/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Zr=Jw;function Yp(t,e={}){let n=t;typeof e!="object"&&(e={name:e});const r=Object.assign({name:Oc,automaticDataCollectionEnabled:!1},e),s=r.name;if(typeof s!="string"||!s)throw Cn.create("bad-app-name",{appName:String(s)});if(n||(n=Kp()),!n)throw Cn.create("no-options");const i=yo.get(s);if(i){if(_o(n,i.options)&&_o(r,i.config))return i;throw Cn.create("duplicate-app",{appName:s})}const o=new lw(s);for(const c of Vc.values())o.addComponent(c);const a=new tT(n,r,o);return yo.set(s,a),a}function Jp(t=Oc){const e=yo.get(t);if(!e&&t===Oc&&Kp())return Yp();if(!e)throw Cn.create("no-app",{appName:t});return e}function bn(t,e,n){var r;let s=(r=Xw[t])!==null&&r!==void 0?r:t;n&&(s+=`-${n}`);const i=s.match(/\s|\//),o=e.match(/\s|\//);if(i||o){const a=[`Unable to register library "${s}" with version "${e}":`];i&&a.push(`library name "${s}" contains illegal characters (whitespace or "/")`),i&&o&&a.push("and"),o&&a.push(`version name "${e}" contains illegal characters (whitespace or "/")`),rr.warn(a.join(" "));return}Br(new nr(`${s}-version`,()=>({library:s,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const nT="firebase-heartbeat-database",rT=1,js="firebase-heartbeat-store";let Ya=null;function Xp(){return Ya||(Ya=ww(nT,rT,{upgrade:(t,e)=>{switch(e){case 0:try{t.createObjectStore(js)}catch(n){console.warn(n)}}}}).catch(t=>{throw Cn.create("idb-open",{originalErrorMessage:t.message})})),Ya}async function sT(t){try{return await(await Xp()).transaction(js).objectStore(js).get(Zp(t))}catch(e){if(e instanceof ln)rr.warn(e.message);else{const n=Cn.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});rr.warn(n.message)}}}async function Yh(t,e){try{const r=(await Xp()).transaction(js,"readwrite");await r.objectStore(js).put(e,Zp(t)),await r.done}catch(n){if(n instanceof ln)rr.warn(n.message);else{const r=Cn.create("idb-set",{originalErrorMessage:n==null?void 0:n.message});rr.warn(r.message)}}}function Zp(t){return`${t.name}!${t.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const iT=1024,oT=30*24*60*60*1e3;class aT{constructor(e){this.container=e,this._heartbeatsCache=null;const n=this.container.getProvider("app").getImmediate();this._storage=new lT(n),this._heartbeatsCachePromise=this._storage.read().then(r=>(this._heartbeatsCache=r,r))}async triggerHeartbeat(){var e,n;const s=this.container.getProvider("platform-logger").getImmediate().getPlatformInfoString(),i=Jh();if(!(((e=this._heartbeatsCache)===null||e===void 0?void 0:e.heartbeats)==null&&(this._heartbeatsCache=await this._heartbeatsCachePromise,((n=this._heartbeatsCache)===null||n===void 0?void 0:n.heartbeats)==null))&&!(this._heartbeatsCache.lastSentHeartbeatDate===i||this._heartbeatsCache.heartbeats.some(o=>o.date===i)))return this._heartbeatsCache.heartbeats.push({date:i,agent:s}),this._heartbeatsCache.heartbeats=this._heartbeatsCache.heartbeats.filter(o=>{const a=new Date(o.date).valueOf();return Date.now()-a<=oT}),this._storage.overwrite(this._heartbeatsCache)}async getHeartbeatsHeader(){var e;if(this._heartbeatsCache===null&&await this._heartbeatsCachePromise,((e=this._heartbeatsCache)===null||e===void 0?void 0:e.heartbeats)==null||this._heartbeatsCache.heartbeats.length===0)return"";const n=Jh(),{heartbeatsToSend:r,unsentEntries:s}=cT(this._heartbeatsCache.heartbeats),i=mo(JSON.stringify({version:2,heartbeats:r}));return this._heartbeatsCache.lastSentHeartbeatDate=n,s.length>0?(this._heartbeatsCache.heartbeats=s,await this._storage.overwrite(this._heartbeatsCache)):(this._heartbeatsCache.heartbeats=[],this._storage.overwrite(this._heartbeatsCache)),i}}function Jh(){return new Date().toISOString().substring(0,10)}function cT(t,e=iT){const n=[];let r=t.slice();for(const s of t){const i=n.find(o=>o.agent===s.agent);if(i){if(i.dates.push(s.date),Xh(n)>e){i.dates.pop();break}}else if(n.push({agent:s.agent,dates:[s.date]}),Xh(n)>e){n.pop();break}r=r.slice(1)}return{heartbeatsToSend:n,unsentEntries:r}}class lT{constructor(e){this.app=e,this._canUseIndexedDBPromise=this.runIndexedDBEnvironmentCheck()}async runIndexedDBEnvironmentCheck(){return zp()?XI().then(()=>!0).catch(()=>!1):!1}async read(){if(await this._canUseIndexedDBPromise){const n=await sT(this.app);return n!=null&&n.heartbeats?n:{heartbeats:[]}}else return{heartbeats:[]}}async overwrite(e){var n;if(await this._canUseIndexedDBPromise){const s=await this.read();return Yh(this.app,{lastSentHeartbeatDate:(n=e.lastSentHeartbeatDate)!==null&&n!==void 0?n:s.lastSentHeartbeatDate,heartbeats:e.heartbeats})}else return}async add(e){var n;if(await this._canUseIndexedDBPromise){const s=await this.read();return Yh(this.app,{lastSentHeartbeatDate:(n=e.lastSentHeartbeatDate)!==null&&n!==void 0?n:s.lastSentHeartbeatDate,heartbeats:[...s.heartbeats,...e.heartbeats]})}else return}}function Xh(t){return mo(JSON.stringify({version:2,heartbeats:t})).length}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const vo=new Dl("@firebase/auth");function dT(t,...e){vo.logLevel<=se.WARN&&vo.warn(`Auth (${Zr}): ${t}`,...e)}function Zi(t,...e){vo.logLevel<=se.ERROR&&vo.error(`Auth (${Zr}): ${t}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function kt(t,...e){throw Ml(t,...e)}function jt(t,...e){return Ml(t,...e)}function fT(t,e,n){const r=Object.assign(Object.assign({},hT()),{[e]:n});return new li("auth","Firebase",r).create(e,{appName:t.name})}function Ml(t,...e){if(typeof t!="string"){const n=e[0],r=[...e.slice(1)];return r[0]&&(r[0].appName=t.name),t._errorFactory.create(n,...r)}return tg.create(t,...e)}function H(t,e,...n){if(!t)throw Ml(e,...n)}function Yt(t){const e="INTERNAL ASSERTION FAILED: "+t;throw Zi(e),new Error(e)}function rn(t,e){t||Yt(e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Nc(){var t;return typeof self<"u"&&((t=self.location)===null||t===void 0?void 0:t.href)||""}function pT(){return Zh()==="http:"||Zh()==="https:"}function Zh(){var t;return typeof self<"u"&&((t=self.location)===null||t===void 0?void 0:t.protocol)||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class hi{constructor(e,n){this.shortDelay=e,this.longDelay=n,rn(n>e,"Short delay should be less than long delay!"),this.isMobile=WI()||QI()}get(){return gT()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function xl(t,e){rn(t.emulator,"Emulator should always be set here");const{url:n}=t.emulator;return e?`${n}${e.startsWith("/")?e.slice(1):e}`:n}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Cs(t){if(t)try{const e=new Date(Number(t));if(!isNaN(e.getTime()))return e.toUTCString()}catch{}}async function RT(t,e=!1){const n=nt(t),r=await n.getIdToken(e),s=Ll(r);H(s&&s.exp&&s.auth_time&&s.iat,n.auth,"internal-error");const i=typeof s.firebase=="object"?s.firebase:void 0,o=i==null?void 0:i.sign_in_provider;return{claims:s,token:r,authTime:Cs(Ja(s.auth_time)),issuedAtTime:Cs(Ja(s.iat)),expirationTime:Cs(Ja(s.exp)),signInProvider:o||null,signInSecondFactor:(i==null?void 0:i.sign_in_second_factor)||null}}function Ja(t){return Number(t)*1e3}function Ll(t){const[e,n,r]=t.split(".");if(e===void 0||n===void 0||r===void 0)return Zi("JWT malformed, contained fewer than 3 sections"),null;try{const s=qp(n);return s?JSON.parse(s):(Zi("Failed to decode base64 JWT payload"),null)}catch(s){return Zi("Caught error parsing JWT payload as JSON",s==null?void 0:s.toString()),null}}function ST(t){const e=Ll(t);return H(e,"internal-error"),H(typeof e.exp<"u","internal-error"),H(typeof e.iat<"u","internal-error"),Number(e.exp)-Number(e.iat)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function $s(t,e,n=!1){if(n)return e;try{return await e}catch(r){throw r instanceof ln&&PT(r)&&t.auth.currentUser===t&&await t.auth.signOut(),r}}function PT({code:t}){return t==="auth/user-disabled"||t==="auth/user-token-expired"}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const td=new Map;function Jt(t){rn(t instanceof Function,"Expected a class definition");let e=td.get(t);return e?(rn(e instanceof t,"Instance stored in cache mismatched with class"),e):(e=new t,td.set(t,e),e)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class og{constructor(){this.type="NONE",this.storage={}}async _isAvailable(){return!0}async _set(e,n){this.storage[e]=n}async _get(e){const n=this.storage[e];return n===void 0?null:n}async _remove(e){delete this.storage[e]}_addListener(e,n){}_removeListener(e,n){}}og.type="NONE";const nd=og;/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function eo(t,e,n){return`firebase:${t}:${e}:${n}`}class kr{constructor(e,n,r){this.persistence=e,this.auth=n,this.userKey=r;const{config:s,name:i}=this.auth;this.fullUserKey=eo(this.userKey,s.apiKey,i),this.fullPersistenceKey=eo("persistence",s.apiKey,i),this.boundEventHandler=n._onStorageEvent.bind(n),this.persistence._addListener(this.fullUserKey,this.boundEventHandler)}setCurrentUser(e){return this.persistence._set(this.fullUserKey,e.toJSON())}async getCurrentUser(){const e=await this.persistence._get(this.fullUserKey);return e?Zn._fromJSON(this.auth,e):null}removeCurrentUser(){return this.persistence._remove(this.fullUserKey)}savePersistenceForRedirect(){return this.persistence._set(this.fullPersistenceKey,this.persistence.type)}async setPersistence(e){if(this.persistence===e)return;const n=await this.getCurrentUser();if(await this.removeCurrentUser(),this.persistence=e,n)return this.setCurrentUser(n)}delete(){this.persistence._removeListener(this.fullUserKey,this.boundEventHandler)}static async create(e,n,r="authUser"){if(!n.length)return new kr(Jt(nd),e,r);const s=(await Promise.all(n.map(async l=>{if(await l._isAvailable())return l}))).filter(l=>l);let i=s[0]||Jt(nd);const o=eo(r,e.config.apiKey,e.name);let a=null;for(const l of n)try{const u=await l._get(o);if(u){const h=Zn._fromJSON(e,u);l!==i&&(a=h),i=l;break}}catch{}const c=s.filter(l=>l._shouldAllowMigration);return!i._shouldAllowMigration||!c.length?new kr(i,e,r):(i=c[0],a&&await i._set(o,a.toJSON()),await Promise.all(n.map(async l=>{if(l!==i)try{await l._remove(o)}catch{}})),new kr(i,e,r))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function rd(t){const e=t.toLowerCase();if(e.includes("opera/")||e.includes("opr/")||e.includes("opios/"))return"Opera";if(lg(e))return"IEMobile";if(e.includes("msie")||e.includes("trident/"))return"IE";if(e.includes("edge/"))return"Edge";if(ag(e))return"Firefox";if(e.includes("silk/"))return"Silk";if(hg(e))return"Blackberry";if(dg(e))return"Webos";if(Fl(e))return"Safari";if((e.includes("chrome/")||cg(e))&&!e.includes("edge/"))return"Chrome";if(ug(e))return"Android";{const n=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,r=t.match(n);if((r==null?void 0:r.length)===2)return r[1]}return"Other"}function ag(t=De()){return/firefox\//i.test(t)}function Fl(t=De()){const e=t.toLowerCase();return e.includes("safari/")&&!e.includes("chrome/")&&!e.includes("crios/")&&!e.includes("android")}function cg(t=De()){return/crios\//i.test(t)}function lg(t=De()){return/iemobile/i.test(t)}function ug(t=De()){return/android/i.test(t)}function hg(t=De()){return/blackberry/i.test(t)}function dg(t=De()){return/webos/i.test(t)}function na(t=De()){return/iphone|ipad|ipod/i.test(t)||/macintosh/i.test(t)&&/mobile/i.test(t)}function NT(t=De()){var e;return na(t)&&!!(!((e=window.navigator)===null||e===void 0)&&e.standalone)}function MT(){return YI()&&document.documentMode===10}function fg(t=De()){return na(t)||ug(t)||dg(t)||hg(t)||/windows phone/i.test(t)||lg(t)}function xT(){try{return!!(window&&window!==window.top)}catch{return!1}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function pg(t,e=[]){let n;switch(t){case"Browser":n=rd(De());break;case"Worker":n=`${rd(De())}-${t}`;break;default:n=t}const r=e.length?e.join(","):"FirebaseCore-web";return`${n}/JsCore/${Zr}/${r}`}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function GT(t,e){const n=Vl(t,"auth");if(n.isInitialized()){const s=n.getImmediate(),i=n.getOptions();if(_o(i,e??{}))return s;kt(s,"already-initialized")}return n.initialize({options:e})}function QT(t,e){const n=(e==null?void 0:e.persistence)||[],r=(Array.isArray(n)?n:[n]).map(Jt);e!=null&&e.errorMap&&t._updateErrorMap(e.errorMap),t._initializeWithPersistence(r,e==null?void 0:e.popupRedirectResolver)}function YT(t,e,n){const r=Ln(t);H(r._canInitEmulator,r,"emulator-config-failed"),H(/^https?:\/\//.test(e),r,"invalid-emulator-scheme");const s=!!(n!=null&&n.disableWarnings),i=mg(e),{host:o,port:a}=JT(e),c=a===null?"":`:${a}`;r.config.emulator={url:`${i}//${o}${c}/`},r.settings.appVerificationDisabledForTesting=!0,r.emulatorConfig=Object.freeze({host:o,port:a,protocol:i.replace(":",""),options:Object.freeze({disableWarnings:s})}),s||XT()}function mg(t){const e=t.indexOf(":");return e<0?"":t.substr(0,e+1)}function JT(t){const e=mg(t),n=/(\/\/)?([^?#/]+)/.exec(t.substr(e.length));if(!n)return{host:"",port:null};const r=n[2].split("@").pop()||"",s=/^(\[[^\]]+\])(:|$)/.exec(r);if(s){const i=s[1];return{host:i,port:od(r.substr(i.length+1))}}else{const[i,o]=r.split(":");return{host:i,port:od(o)}}}function od(t){if(!t)return null;const e=Number(t);return isNaN(e)?null:e}function XT(){function t(){const e=document.createElement("p"),n=e.style;e.innerText="Running in emulator mode. Do not use with production credentials.",n.position="fixed",n.width="100%",n.backgroundColor="#ffffff",n.border=".1em solid #000000",n.color="#b50000",n.bottom="0px",n.left="0px",n.margin="0px",n.zIndex="10000",n.textAlign="center",e.classList.add("firebase-emulator-warning"),document.body.appendChild(e)}typeof console<"u"&&typeof console.info=="function"&&console.info("WARNING: You are using the Auth Emulator, which is intended for local testing only.  Do not use with production credentials."),typeof window<"u"&&typeof document<"u"&&(document.readyState==="loading"?window.addEventListener("DOMContentLoaded",t):t())}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function sA(t){switch(t){case"recoverEmail":return"RECOVER_EMAIL";case"resetPassword":return"PASSWORD_RESET";case"signIn":return"EMAIL_SIGNIN";case"verifyEmail":return"VERIFY_EMAIL";case"verifyAndChangeEmail":return"VERIFY_AND_CHANGE_EMAIL";case"revertSecondFactorAddition":return"REVERT_SECOND_FACTOR_ADDITION";default:return null}}function iA(t){const e=gs(ms(t)).link,n=e?gs(ms(e)).deep_link_id:null,r=gs(ms(t)).deep_link_id;return(r?gs(ms(r)).link:null)||r||n||e||t}class Bl{constructor(e){var n,r,s,i,o,a;const c=gs(ms(e)),l=(n=c.apiKey)!==null&&n!==void 0?n:null,u=(r=c.oobCode)!==null&&r!==void 0?r:null,h=sA((s=c.mode)!==null&&s!==void 0?s:null);H(l&&u&&h,"argument-error"),this.apiKey=l,this.operation=h,this.code=u,this.continueUrl=(i=c.continueUrl)!==null&&i!==void 0?i:null,this.languageCode=(o=c.languageCode)!==null&&o!==void 0?o:null,this.tenantId=(a=c.tenantId)!==null&&a!==void 0?a:null}static parseLink(e){const n=iA(e);try{return new Bl(n)}catch{return null}}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function aA(t,e,n=!1){const{auth:r}=t,s="reauthenticate";try{const i=await $s(t,Eg(r,s,e,t),n);H(i.idToken,r,"internal-error");const o=Ll(i.idToken);H(o,r,"internal-error");const{sub:a}=o;return H(t.uid===a,r,"user-mismatch"),sn._forOperation(t,s,i)}catch(i){throw(i==null?void 0:i.code)==="auth/user-not-found"&&kt(r,"user-mismatch"),i}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ig(t,e,n=!1){const r="signIn",s=await Eg(t,r,e),i=await sn._fromIdTokenResponse(t,r,s);return n||await t._updateCurrentUser(i.user),i}async function cA(t,e){return Ig(Ln(t),e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ql extends Ul{constructor(e){super("custom","custom"),this.params=e}_getIdTokenResponse(e){return Dr(e,this._buildIdpRequest())}_linkToIdToken(e,n){return Dr(e,this._buildIdpRequest(n))}_getReauthenticationResolver(e){return Dr(e,this._buildIdpRequest())}_buildIdpRequest(e){const n={requestUri:this.params.requestUri,sessionId:this.params.sessionId,postBody:this.params.postBody,tenantId:this.params.tenantId,pendingToken:this.params.pendingToken,returnSecureToken:!0,returnIdpCredential:!0};return e&&(n.idToken=e),n}}function DA(t){return Ig(t.auth,new ql(t),t.bypassAuthState)}function OA(t){const{auth:e,user:n}=t;return H(n,e,"internal-error"),aA(n,new ql(t),t.bypassAuthState)}async function VA(t){const{auth:e,user:n}=t;return H(n,e,"internal-error"),oA(n,new ql(t),t.bypassAuthState)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Dg{constructor(e,n,r,s,i=!1){this.auth=e,this.resolver=r,this.user=s,this.bypassAuthState=i,this.pendingPromise=null,this.eventManager=null,this.filter=Array.isArray(n)?n:[n]}execute(){return new Promise(async(e,n)=>{this.pendingPromise={resolve:e,reject:n};try{this.eventManager=await this.resolver._initialize(this.auth),await this.onExecution(),this.eventManager.registerConsumer(this)}catch(r){this.reject(r)}})}async onAuthEvent(e){const{urlResponse:n,sessionId:r,postBody:s,tenantId:i,error:o,type:a}=e;if(o){this.reject(o);return}const c={auth:this.auth,requestUri:n,sessionId:r,tenantId:i||void 0,postBody:s||void 0,user:this.user,bypassAuthState:this.bypassAuthState};try{this.resolve(await this.getIdpTask(a)(c))}catch(l){this.reject(l)}}onError(e){this.reject(e)}getIdpTask(e){switch(e){case"signInViaPopup":case"signInViaRedirect":return DA;case"linkViaPopup":case"linkViaRedirect":return VA;case"reauthViaPopup":case"reauthViaRedirect":return OA;default:kt(this.auth,"internal-error")}}resolve(e){rn(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.resolve(e),this.unregisterAndCleanUp()}reject(e){rn(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.reject(e),this.unregisterAndCleanUp()}unregisterAndCleanUp(){this.eventManager&&this.eventManager.unregisterConsumer(this),this.pendingPromise=null,this.cleanUp()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const YA=new hi(3e4,6e4);function hd(){const t=$t().___jsl;if(t!=null&&t.H){for(const e of Object.keys(t.H))if(t.H[e].r=t.H[e].r||[],t.H[e].L=t.H[e].L||[],t.H[e].r=[...t.H[e].L],t.CP)for(let n=0;n<t.CP.length;n++)t.CP[n]=null}}function JA(t){return new Promise((e,n)=>{var r,s,i;function o(){hd(),gapi.load("gapi.iframes",{callback:()=>{e(gapi.iframes.getContext())},ontimeout:()=>{hd(),n(jt(t,"network-request-failed"))},timeout:YA.get()})}if(!((s=(r=$t().gapi)===null||r===void 0?void 0:r.iframes)===null||s===void 0)&&s.Iframe)e(gapi.iframes.getContext());else if(!((i=$t().gapi)===null||i===void 0)&&i.load)o();else{const a=qT("iframefcb");return $t()[a]=()=>{gapi.load?o():n(jt(t,"network-request-failed"))},gg(`https://apis.google.com/js/api.js?onload=${a}`).catch(c=>n(c))}}).catch(e=>{throw no=null,e})}let no=null;function XA(t){return no=no||JA(t),no}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const o0={location:"yes",resizable:"yes",statusbar:"yes",toolbar:"no"},a0=500,c0=600,l0="_blank",u0="http://localhost";class dd{constructor(e){this.window=e,this.associatedEvent=null}close(){if(this.window)try{this.window.close()}catch{}}}function h0(t,e,n,r=a0,s=c0){const i=Math.max((window.screen.availHeight-s)/2,0).toString(),o=Math.max((window.screen.availWidth-r)/2,0).toString();let a="";const c=Object.assign(Object.assign({},o0),{width:r.toString(),height:s.toString(),top:i,left:o}),l=De().toLowerCase();n&&(a=cg(l)?l0:n),ag(l)&&(e=e||u0,c.scrollbars="yes");const u=Object.entries(c).reduce((d,[g,E])=>`${d}${g}=${E},`,"");if(NT(l)&&a!=="_self")return d0(e||"",a),new dd(null);const h=window.open(e||"",a,u);H(h,t,"popup-blocked");try{h.focus()}catch{}return new dd(h)}function d0(t,e){const n=document.createElement("a");n.href=t,n.target=e;const r=document.createEvent("MouseEvent");r.initMouseEvent("click",!0,!0,window,1,0,0,0,0,!1,!1,!1,!1,1,null),n.dispatchEvent(r)}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const f0="__/auth/handler",p0="emulator/auth/handler",g0=encodeURIComponent("fac");async function fd(t,e,n,r,s,i){H(t.config.authDomain,t,"auth-domain-config-required"),H(t.config.apiKey,t,"invalid-api-key");const o={apiKey:t.config.apiKey,appName:t.name,authType:n,redirectUrl:r,v:Zr,eventId:s};if(e instanceof _g){e.setDefaultLanguage(t.languageCode),o.providerId=e.providerId||"",nw(e.getCustomParameters())||(o.customParameters=JSON.stringify(e.getCustomParameters()));for(const[u,h]of Object.entries(i||{}))o[u]=h}if(e instanceof fi){const u=e.getScopes().filter(h=>h!=="");u.length>0&&(o.scopes=u.join(","))}t.tenantId&&(o.tid=t.tenantId);const a=o;for(const u of Object.keys(a))a[u]===void 0&&delete a[u];const c=await t._getAppCheckToken(),l=c?`#${g0}=${encodeURIComponent(c)}`:"";return`${m0(t)}?${ui(a).slice(1)}${l}`}function m0({config:t}){return t.emulator?xl(t,p0):`https://${t.authDomain}/${f0}`}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ir=new Dl("@firebase/firestore");function fs(){return ir.logLevel}function k(t,...e){if(ir.logLevel<=se.DEBUG){const n=e.map(du);ir.debug(`Firestore (${rs}): ${t}`,...n)}}function Wt(t,...e){if(ir.logLevel<=se.ERROR){const n=e.map(du);ir.error(`Firestore (${rs}): ${t}`,...n)}}function qr(t,...e){if(ir.logLevel<=se.WARN){const n=e.map(du);ir.warn(`Firestore (${rs}): ${t}`,...n)}}function du(t){if(typeof t=="string")return t;try{/**
* @license
* Copyright 2020 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class gu{constructor(e,n){this.previousValue=e,n&&(n.sequenceNumberHandler=r=>this.se(r),this.oe=r=>n.writeSequenceNumber(r))}se(e){return this.previousValue=Math.max(e,this.previousValue),this.previousValue}next(){const e=++this.previousValue;return this.oe&&this.oe(e),e}}gu._e=-1;function wa(t){return t==null}function ko(t){return t===0&&1/t==-1/0}function cS(t){return typeof t=="number"&&Number.isInteger(t)&&!ko(t)&&t<=Number.MAX_SAFE_INTEGER&&t>=Number.MIN_SAFE_INTEGER}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Vd(t){let e=0;for(const n in t)Object.prototype.hasOwnProperty.call(t,n)&&e++;return e}function ss(t,e){for(const n in t)Object.prototype.hasOwnProperty.call(t,n)&&e(n,t[n])}function Fm(t){for(const e in t)if(Object.prototype.hasOwnProperty.call(t,e))return!1;return!0}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function mu(t){var e,n;return((n=(((e=t==null?void 0:t.mapValue)===null||e===void 0?void 0:e.fields)||{}).__type__)===null||n===void 0?void 0:n.stringValue)==="server_timestamp"}function _u(t){const e=t.mapValue.fields.__previous_value__;return mu(e)?_u(e):e}function ei(t){const e=Vn(t.mapValue.fields.__local_write_time__.timestampValue);return new Oe(e.seconds,e.nanos)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class is{constructor(e,n=null,r=[],s=[],i=null,o="F",a=null,c=null){this.path=e,this.collectionGroup=n,this.explicitOrderBy=r,this.filters=s,this.limit=i,this.limitType=o,this.startAt=a,this.endAt=c,this.le=null,this.he=null,this.Pe=null,this.startAt,this.endAt}}function wS(t,e,n,r,s,i,o,a){return new is(t,e,n,r,s,i,o,a)}function Ta(t){return new is(t)}function $d(t){return t.filters.length===0&&t.limit===null&&t.startAt==null&&t.endAt==null&&(t.explicitOrderBy.length===0||t.explicitOrderBy.length===1&&t.explicitOrderBy[0].field.isKeyField())}function zm(t){return t.collectionGroup!==null}function Os(t){const e=J(t);if(e.le===null){e.le=[];const n=new Set;for(const i of e.explicitOrderBy)e.le.push(i),n.add(i.field.canonicalString());const r=e.explicitOrderBy.length>0?e.explicitOrderBy[e.explicitOrderBy.length-1].dir:"asc";(function(o){let a=new He($e.comparator);return o.filters.forEach(c=>{c.getFlattenedFilters().forEach(l=>{l.isInequality()&&(a=a.add(l.field))})}),a})(e).forEach(i=>{n.has(i.canonicalString())||i.isKeyField()||e.le.push(new ri(i,r))}),n.has($e.keyField().canonicalString())||e.le.push(new ri($e.keyField(),r))}return e.le}function qt(t){const e=J(t);return e.he||(e.he=TS(e,Os(t))),e.he}function TS(t,e){if(t.limitType==="F")return jd(t.path,t.collectionGroup,e,t.filters,t.limit,t.startAt,t.endAt);{e=e.map(s=>{const i=s.dir==="desc"?"asc":"desc";return new ri(s.field,i)});const n=t.endAt?new Do(t.endAt.position,t.endAt.inclusive):null,r=t.startAt?new Do(t.startAt.position,t.startAt.inclusive):null;return jd(t.path,t.collectionGroup,e,t.filters,t.limit,n,r)}}function Zc(t,e){const n=t.filters.concat([e]);return new is(t.path,t.collectionGroup,t.explicitOrderBy.slice(),n,t.limit,t.limitType,t.startAt,t.endAt)}function el(t,e,n){return new is(t.path,t.collectionGroup,t.explicitOrderBy.slice(),t.filters.slice(),e,n,t.startAt,t.endAt)}function Aa(t,e){return Eu(qt(t),qt(e))&&t.limitType===e.limitType}function Gm(t){return`${vu(qt(t))}|lt:${t.limitType}`}function Ir(t){return`Query(target=${function(n){let r=n.path.canonicalString();return n.collectionGroup!==null&&(r+=" collectionGroup="+n.collectionGroup),n.filters.length>0&&(r+=`, filters: [${n.filters.map(s=>Km(s)).join(", ")}]`),wa(n.limit)||(r+=", limit: "+n.limit),n.orderBy.length>0&&(r+=`, orderBy: [${n.orderBy.map(s=>function(o){return`${o.field.canonicalString()} (${o.dir})`}(s)).join(", ")}]`),n.startAt&&(r+=", startAt: ",r+=n.startAt.inclusive?"b:":"a:",r+=n.startAt.position.map(s=>Wr(s)).join(",")),n.endAt&&(r+=", endAt: ",r+=n.endAt.inclusive?"a:":"b:",r+=n.endAt.position.map(s=>Wr(s)).join(",")),`Target(${r})`}(qt(t))}; limitType=${t.limitType})`}function Ra(t,e){return e.isFoundDocument()&&function(r,s){const i=s.key.path;return r.collectionGroup!==null?s.key.hasCollectionId(r.collectionGroup)&&r.path.isPrefixOf(i):j.isDocumentKey(r.path)?r.path.isEqual(i):r.path.isImmediateParentOf(i)}(t,e)&&function(r,s){for(const i of Os(r))if(!i.field.isKeyField()&&s.data.field(i.field)===null)return!1;return!0}(t,e)&&function(r,s){for(const i of r.filters)if(!i.matches(s))return!1;return!0}(t,e)&&function(r,s){return!(r.startAt&&!function(o,a,c){const l=Ud(o,a,c);return o.inclusive?l<=0:l<0}(r.startAt,Os(r),s)||r.endAt&&!function(o,a,c){const l=Ud(o,a,c);return o.inclusive?l>=0:l>0}(r.endAt,Os(r),s))}(t,e)}function AS(t){return t.collectionGroup||(t.path.length%2==1?t.path.lastSegment():t.path.get(t.path.length-2))}function Qm(t){return(e,n)=>{let r=!1;for(const s of Os(t)){const i=RS(s,e,n);if(i!==0)return i;r=r||s.field.isKeyField()}return 0}}function RS(t,e,n){const r=t.field.isKeyField()?j.comparator(e.key,n.key):function(i,o,a){const c=o.data.field(i),l=a.data.field(i);return c!==null&&l!==null?Kr(c,l):K()}(t.field,e,n);switch(t.dir){case"asc":return r;case"desc":return-1*r;default:return K()}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class wP{constructor(e,n){this.Lr={},this.overlays={},this.kr=new gu(0),this.qr=!1,this.qr=!0,this.referenceDelegate=e(this),this.Qr=new IP(this),this.indexManager=new hP,this.remoteDocumentCache=function(s){return new vP(s)}(r=>this.referenceDelegate.Kr(r)),this.serializer=new lP(n),this.$r=new mP(this.serializer)}start(){return Promise.resolve()}shutdown(){return this.qr=!1,Promise.resolve()}get started(){return this.qr}setDatabaseDeletedListener(){}setNetworkEnabled(){}getIndexManager(e){return this.indexManager}getDocumentOverlayCache(e){let n=this.overlays[e.toKey()];return n||(n=new _P,this.overlays[e.toKey()]=n),n}getMutationQueue(e,n){let r=this.Lr[e.toKey()];return r||(r=new yP(n,this.referenceDelegate),this.Lr[e.toKey()]=r),r}getTargetCache(){return this.Qr}getRemoteDocumentCache(){return this.remoteDocumentCache}getBundleCache(){return this.$r}runTransaction(e,n,r){k("MemoryPersistence","Starting transaction:",e);const s=new TP(this.kr.next());return this.referenceDelegate.Ur(),r(s).next(i=>this.referenceDelegate.Wr(s).next(()=>i)).toPromise().then(i=>(s.raiseOnCommittedEvent(),i))}Gr(e,n){return w.or(Object.values(this.Lr).map(r=>()=>r.containsKey(e,n)))}}class TP extends iS{constructor(e){super(),this.currentSequenceNumber=e}}class Ru{constructor(e){this.persistence=e,this.zr=new Au,this.jr=null}static Hr(e){return new Ru(e)}get Jr(){if(this.jr)return this.jr;throw K()}addReference(e,n,r){return this.zr.addReference(r,n),this.Jr.delete(r.toString()),w.resolve()}removeReference(e,n,r){return this.zr.removeReference(r,n),this.Jr.add(r.toString()),w.resolve()}markPotentiallyOrphaned(e,n){return this.Jr.add(n.toString()),w.resolve()}removeTarget(e,n){this.zr.Vr(n.targetId).forEach(s=>this.Jr.add(s.toString()));const r=this.persistence.getTargetCache();return r.getMatchingKeysForTargetId(e,n.targetId).next(s=>{s.forEach(i=>this.Jr.add(i.toString()))}).next(()=>r.removeTargetData(e,n))}Ur(){this.jr=new Set}Wr(e){const n=this.persistence.getRemoteDocumentCache().newChangeBuffer();return w.forEach(this.Jr,r=>{const s=j.fromPath(r);return this.Yr(e,s).next(i=>{i||n.removeEntry(s,Y.min())})}).next(()=>(this.jr=null,n.apply(e)))}updateLimboDocument(e,n){return this.Yr(e,n).next(r=>{r?this.Jr.delete(n.toString()):this.Jr.add(n.toString())})}Kr(e){return 0}Yr(e,n){return w.or([()=>w.resolve(this.zr.containsKey(n)),()=>this.persistence.getTargetCache().containsKey(e,n),()=>this.persistence.Gr(e,n)])}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Su{constructor(e,n,r,s){this.targetId=e,this.fromCache=n,this.qi=r,this.Qi=s}static Ki(e,n){let r=re(),s=re();for(const i of n.docChanges)switch(i.type){case 0:r=r.add(i.doc.key);break;case 1:s=s.add(i.doc.key)}return new Su(e,n.fromCache,r,s)}}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class tf{constructor(){this.so=()=>this.oo(),this._o=()=>this.ao(),this.uo=[],this.co()}io(e){this.uo.push(e)}shutdown(){window.removeEventListener("online",this.so),window.removeEventListener("offline",this._o)}co(){window.addEventListener("online",this.so),window.addEventListener("offline",this._o)}oo(){k("ConnectivityMonitor","Network connectivity changed: AVAILABLE");for(const e of this.uo)e(0)}ao(){k("ConnectivityMonitor","Network connectivity changed: UNAVAILABLE");for(const e of this.uo)e(1)}static D(){return typeof window<"u"&&window.addEventListener!==void 0&&window.removeEventListener!==void 0}}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class qP{constructor(e,n,r,s,i){this.localStore=e,this.datastore=n,this.asyncQueue=r,this.remoteSyncer={},this.D_=[],this.C_=new Map,this.v_=new Set,this.F_=[],this.M_=i,this.M_.io(o=>{r.enqueueAndForget(async()=>{dr(this)&&(k("RemoteStore","Restarting streams for network reachability change."),await async function(c){const l=J(c);l.v_.add(4),await Pi(l),l.x_.set("Unknown"),l.v_.delete(4),await ka(l)}(this))})}),this.x_=new $P(r,s)}}async function ka(t){if(dr(t))for(const e of t.F_)await e(!0)}async function Pi(t){for(const e of t.F_)await e(!1)}function w_(t,e){const n=J(t);n.C_.has(e.targetId)||(n.C_.set(e.targetId,e),bu(n)?Cu(n):as(n).Jo()&&Pu(n,e))}function T_(t,e){const n=J(t),r=as(n);n.C_.delete(e),r.Jo()&&A_(n,e),n.C_.size===0&&(r.Jo()?r.Xo():dr(n)&&n.x_.set("Unknown"))}function Pu(t,e){if(t.O_.Oe(e.targetId),e.resumeToken.approximateByteSize()>0||e.snapshotVersion.compareTo(Y.min())>0){const n=t.remoteSyncer.getRemoteKeysForTarget(e.targetId).size;e=e.withExpectedCount(n)}as(t).c_(e)}function A_(t,e){t.O_.Oe(e),as(t).l_(e)}function Cu(t){t.O_=new KS({getRemoteKeysForTarget:e=>t.remoteSyncer.getRemoteKeysForTarget(e),_t:e=>t.C_.get(e)||null,nt:()=>t.datastore.serializer.databaseId}),as(t).start(),t.x_.p_()}function bu(t){return dr(t)&&!as(t).Ho()&&t.C_.size>0}function dr(t){return J(t).v_.size===0}function R_(t){t.O_=void 0}async function HP(t){t.C_.forEach((e,n)=>{Pu(t,e)})}async function KP(t,e){R_(t),bu(t)?(t.x_.S_(e),Cu(t)):t.x_.set("Unknown")}async function WP(t,e,n){if(t.x_.set("Online"),e instanceof u_&&e.state===2&&e.cause)try{await async function(s,i){const o=i.cause;for(const a of i.targetIds)s.C_.has(a)&&(await s.remoteSyncer.rejectListen(a,o),s.C_.delete(a),s.O_.removeTarget(a))}(t,e)}catch(r){k("RemoteStore","Failed to remove targets %s: %s ",e.targetIds.join(","),r),await Mo(t,r)}else if(e instanceof io?t.O_.$e(e):e instanceof l_?t.O_.Je(e):t.O_.Ge(e),!n.isEqual(Y.min()))try{const r=await v_(t.localStore);n.compareTo(r)>=0&&await function(i,o){const a=i.O_.it(o);return a.targetChanges.forEach((c,l)=>{if(c.resumeToken.approximateByteSize()>0){const u=i.C_.get(l);u&&i.C_.set(l,u.withResumeToken(c.resumeToken,o))}}),a.targetMismatches.forEach((c,l)=>{const u=i.C_.get(c);if(!u)return;i.C_.set(c,u.withResumeToken(rt.EMPTY_BYTE_STRING,u.snapshotVersion)),A_(i,c);const h=new Tn(u.target,c,l,u.sequenceNumber);Pu(i,h)}),i.remoteSyncer.applyRemoteEvent(a)}(t,n)}catch(r){k("RemoteStore","Failed to raise snapshot:",r),await Mo(t,r)}}async function Mo(t,e,n){if(!Ai(e))throw e;t.v_.add(1),await Pi(t),t.x_.set("Offline"),n||(n=()=>v_(t.localStore)),t.asyncQueue.enqueueRetryable(async()=>{k("RemoteStore","Retrying IndexedDB access"),await n(),t.v_.delete(1),await ka(t)})}function S_(t,e){return e().catch(n=>Mo(t,n,e))}async function Da(t){const e=J(t),n=Nn(e);let r=e.D_.length>0?e.D_[e.D_.length-1].batchId:-1;for(;zP(e);)try{const s=await DP(e.localStore,r);if(s===null){e.D_.length===0&&n.Xo();break}r=s.batchId,GP(e,s)}catch(s){await Mo(e,s)}P_(e)&&C_(e)}function zP(t){return dr(t)&&t.D_.length<10}function GP(t,e){t.D_.push(e);const n=Nn(t);n.Jo()&&n.P_&&n.I_(e.mutations)}function P_(t){return dr(t)&&!Nn(t).Ho()&&t.D_.length>0}function C_(t){Nn(t).start()}async function QP(t){Nn(t).d_()}async function YP(t){const e=Nn(t);for(const n of t.D_)e.I_(n.mutations)}async function JP(t,e,n){const r=t.D_.shift(),s=Iu.from(r,e,n);await S_(t,()=>t.remoteSyncer.applySuccessfulWrite(s)),await Da(t)}async function XP(t,e){e&&Nn(t).P_&&await async function(r,s){if(function(o){return $S(o)&&o!==v.ABORTED}(s.code)){const i=r.D_.shift();Nn(r).Zo(),await S_(r,()=>r.remoteSyncer.rejectFailedWrite(i.batchId,s)),await Da(r)}}(t,e),P_(t)&&C_(t)}async function nf(t,e){const n=J(t);n.asyncQueue.verifyOperationInProgress(),k("RemoteStore","RemoteStore received new credentials");const r=dr(n);n.v_.add(3),await Pi(n),r&&n.x_.set("Unknown"),await n.remoteSyncer.handleCredentialChange(e),n.v_.delete(3),await ka(n)}async function ZP(t,e){const n=J(t);e?(n.v_.delete(2),await ka(n)):e||(n.v_.add(2),await Pi(n),n.x_.set("Unknown"))}function as(t){return t.N_||(t.N_=function(n,r,s){const i=J(n);return i.R_(),new UP(r,i.connection,i.authCredentials,i.appCheckCredentials,i.serializer,s)}(t.datastore,t.asyncQueue,{Po:HP.bind(null,t),To:KP.bind(null,t),u_:WP.bind(null,t)}),t.F_.push(async e=>{e?(t.N_.Zo(),bu(t)?Cu(t):t.x_.set("Unknown")):(await t.N_.stop(),R_(t))})),t.N_}function Nn(t){return t.B_||(t.B_=function(n,r,s){const i=J(n);return i.R_(),new BP(r,i.connection,i.authCredentials,i.appCheckCredentials,i.serializer,s)}(t.datastore,t.asyncQueue,{Po:QP.bind(null,t),To:XP.bind(null,t),E_:YP.bind(null,t),T_:JP.bind(null,t)}),t.F_.push(async e=>{e?(t.B_.Zo(),await Da(t)):(await t.B_.stop(),t.D_.length>0&&(k("RemoteStore",`Stopping write stream with ${t.D_.length} pending writes`),t.D_=[]))})),t.B_}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ku{constructor(e,n,r,s,i){this.asyncQueue=e,this.timerId=n,this.targetTimeMs=r,this.op=s,this.removalCallback=i,this.deferred=new tn,this.then=this.deferred.promise.then.bind(this.deferred.promise),this.deferred.promise.catch(o=>{})}get promise(){return this.deferred.promise}static createAndSchedule(e,n,r,s,i){const o=Date.now()+r,a=new ku(e,n,o,s,i);return a.start(r),a}start(e){this.timerHandle=setTimeout(()=>this.handleDelayElapsed(),e)}skipDelay(){return this.handleDelayElapsed()}cancel(e){this.timerHandle!==null&&(this.clearTimeout(),this.deferred.reject(new N(v.CANCELLED,"Operation cancelled"+(e?": "+e:""))))}handleDelayElapsed(){this.asyncQueue.enqueueAndForget(()=>this.timerHandle!==null?(this.clearTimeout(),this.op().then(e=>this.deferred.resolve(e))):Promise.resolve())}clearTimeout(){this.timerHandle!==null&&(this.removalCallback(this),clearTimeout(this.timerHandle),this.timerHandle=null)}}function Du(t,e){if(Wt("AsyncQueue",`${e}: ${t}`),Ai(t))return new N(v.UNAVAILABLE,`${e}: ${t}`);throw t}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class eC{constructor(){this.q_=void 0,this.Q_=[]}}class tC{constructor(){this.queries=new os(e=>Gm(e),Aa),this.onlineState="Unknown",this.K_=new Set}}async function b_(t,e){const n=J(t),r=e.query;let s=!1,i=n.queries.get(r);if(i||(s=!0,i=new eC),s)try{i.q_=await n.onListen(r)}catch(o){const a=Du(o,`Initialization of query '${Ir(e.query)}' failed`);return void e.onError(a)}n.queries.set(r,i),i.Q_.push(e),e.U_(n.onlineState),i.q_&&e.W_(i.q_)&&Ou(n)}async function k_(t,e){const n=J(t),r=e.query;let s=!1;const i=n.queries.get(r);if(i){const o=i.Q_.indexOf(e);o>=0&&(i.Q_.splice(o,1),s=i.Q_.length===0)}if(s)return n.queries.delete(r),n.onUnlisten(r)}function nC(t,e){const n=J(t);let r=!1;for(const s of e){const i=s.query,o=n.queries.get(i);if(o){for(const a of o.Q_)a.W_(s)&&(r=!0);o.q_=s}}r&&Ou(n)}function rC(t,e,n){const r=J(t),s=r.queries.get(e);if(s)for(const i of s.Q_)i.onError(n);r.queries.delete(e)}function Ou(t){t.K_.forEach(e=>{e.next()})}class D_{constructor(e,n,r){this.query=e,this.G_=n,this.z_=!1,this.j_=null,this.onlineState="Unknown",this.options=r||{}}W_(e){if(!this.options.includeMetadataChanges){const r=[];for(const s of e.docChanges)s.type!==3&&r.push(s);e=new Gr(e.query,e.docs,e.oldDocs,r,e.mutatedKeys,e.fromCache,e.syncStateChanged,!0,e.hasCachedResults)}let n=!1;return this.z_?this.H_(e)&&(this.G_.next(e),n=!0):this.J_(e,this.onlineState)&&(this.Y_(e),n=!0),this.j_=e,n}onError(e){this.G_.error(e)}U_(e){this.onlineState=e;let n=!1;return this.j_&&!this.z_&&this.J_(this.j_,e)&&(this.Y_(this.j_),n=!0),n}J_(e,n){if(!e.fromCache)return!0;const r=n!=="Offline";return(!this.options.Z_||!r)&&(!e.docs.isEmpty()||e.hasCachedResults||n==="Offline")}H_(e){if(e.docChanges.length>0)return!0;const n=this.j_&&this.j_.hasPendingWrites!==e.hasPendingWrites;return!(!e.syncStateChanged&&!n)&&this.options.includeMetadataChanges===!0}Y_(e){e=Gr.fromInitialDocuments(e.query,e.docs,e.mutatedKeys,e.fromCache,e.hasCachedResults),this.z_=!0,this.G_.next(e)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
`+o.stack),a}(r);throw Wt("INTERNAL UNHANDLED ERROR: ",s),r}).then(r=>(this.iu=!1,r))));return this.Xa=n,n}enqueueAfterDelay(e,n,r){this.au(),this.ou.indexOf(e)>-1&&(n=0);const s=ku.createAndSchedule(this,e,n,r,i=>this.lu(i));return this.nu.push(s),s}au(){this.ru&&K()}verifyOperationInProgress(){}async hu(){let e;do e=this.Xa,await e;while(e!==this.Xa)}Pu(e){for(const n of this.nu)if(n.timerId===e)return!0;return!1}Iu(e){return this.hu().then(()=>{this.nu.sort((n,r)=>n.targetTimeMs-r.targetTimeMs);for(const n of this.nu)if(n.skipDelay(),e!=="all"&&n.timerId===e)break;return this.hu()})}Tu(e){this.ou.push(e)}lu(e){const n=this.nu.indexOf(e);this.nu.splice(n,1)}}function pf(t){return function(n,r){if(typeof n!="object"||n===null)return!1;const s=n;for(const i of r)if(i in s&&typeof s[i]=="function")return!0;return!1}(t,["next","error","complete"])}class Qr extends Va{constructor(e,n,r,s){super(e,n,r,s),this.type="firestore",this._queue=function(){return new CC}(),this._persistenceKey=(s==null?void 0:s.name)||"[DEFAULT]"}_terminate(){return this._firestoreClient||$_(this),this._firestoreClient.terminate()}}function oo(t,e){const n=typeof t=="object"?t:Jp(),r=typeof t=="string"?t:e||"(default)",s=Vl(n,"firestore").getImmediate({identifier:r});if(!s._initialized){const i=qI("firestore");i&&PC(s,...i)}return s}function Nu(t){return t._firestoreClient||$_(t),t._firestoreClient.verifyNotTerminated(),t._firestoreClient}function $_(t){var e,n,r;const s=t._freezeSettings(),i=function(a,c,l,u){return new uS(a,c,l,u.host,u.ssl,u.experimentalForceLongPolling,u.experimentalAutoDetectLongPolling,B_(u.experimentalLongPollingOptions),u.useFetchStreams)}(t._databaseId,((e=t._app)===null||e===void 0?void 0:e.options.appId)||"",t._persistenceKey,s);t._firestoreClient=new IC(t._authCredentials,t._appCheckCredentials,t._queue,i),!((n=s.localCache)===null||n===void 0)&&n._offlineComponentProvider&&(!((r=s.localCache)===null||r===void 0)&&r._onlineComponentProvider)&&(t._firestoreClient._uninitializedComponentsProvider={_offlineKind:s.localCache.kind,_offline:s.localCache._offlineComponentProvider,_online:s.localCache._onlineComponentProvider})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Mu{constructor(...e){for(let n=0;n<e.length;++n)if(e[n].length===0)throw new N(v.INVALID_ARGUMENT,"Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new $e(e)}isEqual(e){return this._internalPath.isEqual(e._internalPath)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class xu{constructor(e,n){if(!isFinite(e)||e<-90||e>90)throw new N(v.INVALID_ARGUMENT,"Latitude must be a number between -90 and 90, but was: "+e);if(!isFinite(n)||n<-180||n>180)throw new N(v.INVALID_ARGUMENT,"Longitude must be a number between -180 and 180, but was: "+n);this._lat=e,this._long=n}get latitude(){return this._lat}get longitude(){return this._long}isEqual(e){return this._lat===e._lat&&this._long===e._long}toJSON(){return{latitude:this._lat,longitude:this._long}}_compareTo(e){return le(this._lat,e._lat)||le(this._long,e._long)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const bC=/^__.*__$/;class kC{constructor(e,n,r){this.data=e,this.fieldMask=n,this.fieldTransforms=r}toMutation(e,n){return this.fieldMask!==null?new hr(e,this.data,this.fieldMask,n,this.fieldTransforms):new Ri(e,this.data,n,this.fieldTransforms)}}function H_(t){switch(t){case 0:case 2:case 1:return!0;case 3:case 4:return!1;default:throw K()}}class Lu{constructor(e,n,r,s,i,o){this.settings=e,this.databaseId=n,this.serializer=r,this.ignoreUndefinedProperties=s,i===void 0&&this.Eu(),this.fieldTransforms=i||[],this.fieldMask=o||[]}get path(){return this.settings.path}get du(){return this.settings.du}Au(e){return new Lu(Object.assign(Object.assign({},this.settings),e),this.databaseId,this.serializer,this.ignoreUndefinedProperties,this.fieldTransforms,this.fieldMask)}Ru(e){var n;const r=(n=this.path)===null||n===void 0?void 0:n.child(e),s=this.Au({path:r,Vu:!1});return s.mu(e),s}fu(e){var n;const r=(n=this.path)===null||n===void 0?void 0:n.child(e),s=this.Au({path:r,Vu:!1});return s.Eu(),s}gu(e){return this.Au({path:void 0,Vu:!0})}pu(e){return Lo(e,this.settings.methodName,this.settings.yu||!1,this.path,this.settings.wu)}contains(e){return this.fieldMask.find(n=>e.isPrefixOf(n))!==void 0||this.fieldTransforms.find(n=>e.isPrefixOf(n.field))!==void 0}Eu(){if(this.path)for(let e=0;e<this.path.length;e++)this.mu(this.path.get(e))}mu(e){if(e.length===0)throw this.pu("Document fields must not be empty");if(H_(this.du)&&bC.test(e))throw this.pu('Document fields cannot begin and end with "__"')}}class DC{constructor(e,n,r){this.databaseId=e,this.ignoreUndefinedProperties=n,this.serializer=r||ba(e)}Su(e,n,r,s=!1){return new Lu({du:e,methodName:n,wu:r,path:$e.emptyPath(),Vu:!1,yu:s},this.databaseId,this.serializer,this.ignoreUndefinedProperties)}}function Fu(t){const e=t._freezeSettings(),n=ba(t._databaseId);return new DC(t._databaseId,!!e.ignoreUndefinedProperties,n)}function K_(t,e,n,r,s,i={}){const o=t.Su(i.merge||i.mergeFields?2:0,e,n,s);G_("Data must be an object, but it was:",o,r);const a=W_(r,o);let c,l;if(i.merge)c=new St(o.fieldMask),l=o.fieldTransforms;else if(i.mergeFields){const u=[];for(const h of i.mergeFields){const d=VC(e,h,n);if(!o.contains(d))throw new N(v.INVALID_ARGUMENT,`Field '${d}' is specified in your field mask but missing from your input data.`);MC(u,d)||u.push(d)}c=new St(u),l=o.fieldTransforms.filter(h=>c.covers(h.field))}else c=null,l=o.fieldTransforms;return new kC(new It(a),c,l)}function OC(t,e,n,r=!1){return Uu(n,t.Su(r?4:3,e))}function Uu(t,e){if(z_(t=nt(t)))return G_("Unsupported field value:",e,t),W_(t,e);if(t instanceof q_)return function(r,s){if(!H_(s.du))throw s.pu(`${r._methodName}() can only be used with update() and set()`);if(!s.path)throw s.pu(`${r._methodName}() is not currently supported inside arrays`);const i=r._toFieldTransform(s);i&&s.fieldTransforms.push(i)}(t,e),null;if(t===void 0&&e.ignoreUndefinedProperties)return null;if(e.path&&e.fieldMask.push(e.path),t instanceof Array){if(e.settings.Vu&&e.du!==4)throw e.pu("Nested arrays are not supported");return function(r,s){const i=[];let o=0;for(const a of r){let c=Uu(a,s.gu(o));c==null&&(c={nullValue:"NULL_VALUE"}),i.push(c),o++}return{arrayValue:{values:i}}}(t,e)}return function(r,s){if((r=nt(r))===null)return{nullValue:"NULL_VALUE"};if(typeof r=="number")return DS(s.serializer,r);if(typeof r=="boolean")return{booleanValue:r};if(typeof r=="string")return{stringValue:r};if(r instanceof Date){const i=Oe.fromDate(r);return{timestampValue:No(s.serializer,i)}}if(r instanceof Oe){const i=new Oe(r.seconds,1e3*Math.floor(r.nanoseconds/1e3));return{timestampValue:No(s.serializer,i)}}if(r instanceof xu)return{geoPointValue:{latitude:r.latitude,longitude:r.longitude}};if(r instanceof Yr)return{bytesValue:h_(s.serializer,r._byteString)};if(r instanceof at){const i=s.databaseId,o=r.firestore._databaseId;if(!o.isEqual(i))throw s.pu(`Document reference is for database ${o.projectId}/${o.database} but should be for database ${i.projectId}/${i.database}`);return{referenceValue:Tu(r.firestore._databaseId||s.databaseId,r._key.path)}}throw s.pu(`Unsupported field value: ${Oa(r)}`)}(t,e)}function W_(t,e){const n={};return Fm(t)?e.path&&e.path.length>0&&e.fieldMask.push(e.path):ss(t,(r,s)=>{const i=Uu(s,e.Ru(r));i!=null&&(n[r]=i)}),{mapValue:{fields:n}}}function z_(t){return!(typeof t!="object"||t===null||t instanceof Array||t instanceof Date||t instanceof Oe||t instanceof xu||t instanceof Yr||t instanceof at||t instanceof q_)}function G_(t,e,n){if(!z_(n)||!function(s){return typeof s=="object"&&s!==null&&(Object.getPrototypeOf(s)===Object.prototype||Object.getPrototypeOf(s)===null)}(n)){const r=Oa(n);throw r==="an object"?e.pu(t+" a custom object"):e.pu(t+" "+r)}}function VC(t,e,n){if((e=nt(e))instanceof Mu)return e._internalPath;if(typeof e=="string")return Q_(t,e);throw Lo("Field path arguments must be of type string or ",t,!1,void 0,n)}const NC=new RegExp("[~\\*/\\[\\]]");function Q_(t,e,n){if(e.search(NC)>=0)throw Lo(`Invalid field path (${e}). Paths must not contain '~', '*', '/', '[', or ']'`,t,!1,void 0,n);try{return new Mu(...e.split("."))._internalPath}catch{throw Lo(`Invalid field path (${e}). Paths must not be empty, begin with '.', end with '.', or contain '..'`,t,!1,void 0,n)}}function Lo(t,e,n,r,s){const i=r&&!r.isEmpty(),o=s!==void 0;let a=`Function ${e}() called with invalid data`;n&&(a+=" (via `toFirestore()`)"),a+=". ";let c="";return(i||o)&&(c+=" (found",i&&(c+=` in field ${r}`),o&&(c+=` in document ${s}`),c+=")"),new N(v.INVALID_ARGUMENT,a+t+c)}function MC(t,e){return t.some(n=>n.isEqual(e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function LC(t){if(t.limitType==="L"&&t.explicitOrderBy.length===0)throw new N(v.UNIMPLEMENTED,"limitToLast() queries require specifying at least one orderBy() clause")}class ju{}class J_ extends ju{}function FC(t,e,...n){let r=[];e instanceof ju&&r.push(e),r=r.concat(n),function(i){const o=i.filter(c=>c instanceof qu).length,a=i.filter(c=>c instanceof $u).length;if(o>1||o>0&&a>0)throw new N(v.INVALID_ARGUMENT,"InvalidQuery. When using composite filters, you cannot use more than one filter at the top level. Consider nesting the multiple filters within an `and(...)` statement. For example: change `query(query, where(...), or(...))` to `query(query, and(where(...), or(...)))`.")}(r);for(const s of r)t=s._apply(t);return t}class $u extends J_{constructor(e,n,r){super(),this._field=e,this._op=n,this._value=r,this.type="where"}static _create(e,n,r){return new $u(e,n,r)}_apply(e){const n=this._parse(e);return X_(e._query,n),new fr(e.firestore,e.converter,Zc(e._query,n))}_parse(e){const n=Fu(e.firestore);return function(i,o,a,c,l,u,h){let d;if(l.isKeyField()){if(u==="array-contains"||u==="array-contains-any")throw new N(v.INVALID_ARGUMENT,`Invalid Query. You can't perform '${u}' queries on documentId().`);if(u==="in"||u==="not-in"){mf(h,u);const g=[];for(const E of h)g.push(gf(c,i,E));d={arrayValue:{values:g}}}else d=gf(c,i,h)}else u!=="in"&&u!=="not-in"&&u!=="array-contains-any"||mf(h,u),d=OC(a,o,h,u==="in"||u==="not-in");return ke.create(l,u,d)}(e._query,"where",n,e.firestore._databaseId,this._field,this._op,this._value)}}class qu extends ju{constructor(e,n){super(),this.type=e,this._queryConstraints=n}static _create(e,n){return new qu(e,n)}_parse(e){const n=this._queryConstraints.map(r=>r._parse(e)).filter(r=>r.getFilters().length>0);return n.length===1?n[0]:Ot.create(n,this._getOperator())}_apply(e){const n=this._parse(e);return n.getFilters().length===0?e:(function(s,i){let o=s;const a=i.getFlattenedFilters();for(const c of a)X_(o,c),o=Zc(o,c)}(e._query,n),new fr(e.firestore,e.converter,Zc(e._query,n)))}_getQueryConstraints(){return this._queryConstraints}_getOperator(){return this.type==="and"?"and":"or"}}class Hu extends J_{constructor(e,n){super(),this._field=e,this._direction=n,this.type="orderBy"}static _create(e,n){return new Hu(e,n)}_apply(e){const n=function(s,i,o){if(s.startAt!==null)throw new N(v.INVALID_ARGUMENT,"Invalid query. You must not call startAt() or startAfter() before calling orderBy().");if(s.endAt!==null)throw new N(v.INVALID_ARGUMENT,"Invalid query. You must not call endAt() or endBefore() before calling orderBy().");return new ri(i,o)}(e._query,this._field,this._direction);return new fr(e.firestore,e.converter,function(s,i){const o=s.explicitOrderBy.concat([i]);return new is(s.path,s.collectionGroup,o,s.filters.slice(),s.limit,s.limitType,s.startAt,s.endAt)}(e._query,n))}}function UC(t,e="asc"){const n=e,r=Bu("orderBy",t);return Hu._create(r,n)}function gf(t,e,n){if(typeof(n=nt(n))=="string"){if(n==="")throw new N(v.INVALID_ARGUMENT,"Invalid query. When querying with documentId(), you must provide a valid document ID, but it was an empty string.");if(!zm(e)&&n.indexOf("/")!==-1)throw new N(v.INVALID_ARGUMENT,`Invalid query. When querying a collection by documentId(), you must provide a plain document ID, but '${n}' contains a '/' character.`);const r=e.path.child(Ie.fromString(n));if(!j.isDocumentKey(r))throw new N(v.INVALID_ARGUMENT,`Invalid query. When querying a collection group by documentId(), the value provided must result in a valid document path, but '${r}' is not because it has an odd number of segments (${r.length}).`);return xd(t,new j(r))}if(n instanceof at)return xd(t,n._key);throw new N(v.INVALID_ARGUMENT,`Invalid query. When querying with documentId(), you must provide a valid string or a DocumentReference, but it was: ${Oa(n)}.`)}function mf(t,e){if(!Array.isArray(t)||t.length===0)throw new N(v.INVALID_ARGUMENT,`Invalid Query. A non-empty array is required for '${e.toString()}' filters.`)}function X_(t,e){const n=function(s,i){for(const o of s)for(const a of o.getFlattenedFilters())if(i.indexOf(a.op)>=0)return a.op;return null}(t.filters,function(s){switch(s){case"!=":return["!=","not-in"];case"array-contains-any":case"in":return["not-in"];case"not-in":return["array-contains-any","in","not-in","!="];default:return[]}}(e.op));if(n!==null)throw n===e.op?new N(v.INVALID_ARGUMENT,`Invalid query. You cannot use more than one '${e.op.toString()}' filter.`):new N(v.INVALID_ARGUMENT,`Invalid query. You cannot use '${e.op.toString()}' filters with '${n.toString()}' filters.`)}class BC{convertValue(e,n="none"){switch(ar(e)){case 0:return null;case 1:return e.booleanValue;case 2:return be(e.integerValue||e.doubleValue);case 3:return this.convertTimestamp(e.timestampValue);case 4:return this.convertServerTimestamp(e,n);case 5:return e.stringValue;case 6:return this.convertBytes(or(e.bytesValue));case 7:return this.convertReference(e.referenceValue);case 8:return this.convertGeoPoint(e.geoPointValue);case 9:return this.convertArray(e.arrayValue,n);case 10:return this.convertObject(e.mapValue,n);default:throw K()}}convertObject(e,n){return this.convertObjectMap(e.fields,n)}convertObjectMap(e,n="none"){const r={};return ss(e,(s,i)=>{r[s]=this.convertValue(i,n)}),r}convertGeoPoint(e){return new xu(be(e.latitude),be(e.longitude))}convertArray(e,n){return(e.values||[]).map(r=>this.convertValue(r,n))}convertServerTimestamp(e,n){switch(n){case"previous":const r=_u(e);return r==null?null:this.convertValue(r,n);case"estimate":return this.convertTimestamp(ei(e));default:return null}}convertTimestamp(e){const n=Vn(e);return new Oe(n.seconds,n.nanos)}convertDocumentKey(e,n){const r=Ie.fromString(e);ye(__(r));const s=new ti(r.get(1),r.get(3)),i=new j(r.popFirst(5));return s.isEqual(n)||Wt(`Document ${i} contains a document reference within a different database (${s.projectId}/${s.database}) which is not supported. It will be treated as a reference in the current database (${n.projectId}/${n.database}) instead.`),i}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function _f(t){t=nn(t,at);const e=nn(t.firestore,Qr);return RC(Nu(e),t._key).then(n=>ry(e,t,n))}class ty extends BC{constructor(e){super(),this.firestore=e}convertBytes(e){return new Yr(e)}convertReference(e){const n=this.convertDocumentKey(e,this.firestore._databaseId);return new at(this.firestore,null,n)}}function qC(t,e,n){t=nn(t,at);const r=nn(t.firestore,Qr),s=Z_(t.converter,e,n);return ny(r,[K_(Fu(r),"setDoc",t._key,s,t.converter!==null,n).toMutation(t._key,Ht.none())])}function HC(t,e){const n=nn(t.firestore,Qr),r=xo(t),s=Z_(t.converter,e);return ny(n,[K_(Fu(t.firestore),"addDoc",r._key,s,t.converter!==null,{}).toMutation(r._key,Ht.exists(!1))]).then(()=>r)}function KC(t,...e){var n,r,s;t=nt(t);let i={includeMetadataChanges:!1},o=0;typeof e[o]!="object"||pf(e[o])||(i=e[o],o++);const a={includeMetadataChanges:i.includeMetadataChanges};if(pf(e[o])){const h=e[o];e[o]=(n=h.next)===null||n===void 0?void 0:n.bind(h),e[o+1]=(r=h.error)===null||r===void 0?void 0:r.bind(h),e[o+2]=(s=h.complete)===null||s===void 0?void 0:s.bind(h)}let c,l,u;if(t instanceof at)l=nn(t.firestore,Qr),u=Ta(t._key.path),c={next:h=>{e[o]&&e[o](ry(l,t,h))},error:e[o+1],complete:e[o+2]};else{const h=nn(t,fr);l=nn(h.firestore,Qr),u=h._query;const d=new ty(l);c={next:g=>{e[o]&&e[o](new jC(l,d,h,g))},error:e[o+1],complete:e[o+2]},LC(t._query)}return function(d,g,E,R){const T=new F_(R),P=new D_(g,T,E);return d.asyncQueue.enqueueAndForget(async()=>b_(await al(d),P)),()=>{T.La(),d.asyncQueue.enqueueAndForget(async()=>k_(await al(d),P))}}(Nu(l),u,a,c)}function ny(t,e){return function(r,s){const i=new tn;return r.asyncQueue.enqueueAndForget(async()=>hC(await AC(r),s,i)),i.promise}(Nu(t),e)}function ry(t,e,n){const r=n.docs.get(e._key),s=new ty(t);return new ey(t,s,e._key,r,new Is(n.hasPendingWrites,n.fromCache),e.converter)}(function(e,n=!0){(function(s){rs=s})(Zr),Br(new nr("firestore",(r,{instanceIdentifier:s,options:i})=>{const o=r.getProvider("app").getImmediate(),a=new Qr(new GR(r.getProvider("auth-internal")),new XR(r.getProvider("app-check-internal")),function(l,u){if(!Object.prototype.hasOwnProperty.apply(l.options,["projectId"]))throw new N(v.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new ti(l.options.projectId,u)}(o,s),o);return i=Object.assign({useFetchStreams:n},i),a._setSettings(i),a},"PUBLIC").setMultipleInstances(!0)),bn(Dd,"4.4.1",e),bn(Dd,"4.4.1","esm2017")})();const WC=Pp("chatStore",{state:()=>({chats:[{id:"cats",name:"Cats",about:"On the Cat Chat channel, fellow cat enthusiasts often share heartwarming stories of their feline friends"},{id:"dogs",name:"Dogs",about:"In the Dog Chat channel, members joyfully post photos of their dogs adventures, showcasing their playful and loyal nature."},{id:"books",name:"Books",about:"The Book Chat channel is a haven for bibliophiles, where they delve into discussions about their latest reads and timeless classics"},{id:"travel",name:"Travel",about:"The Travel Chat channel is filled with vibrant stories and tips from globetrotters sharing their experiences from different corners of the world"}],selectedChat:null,messages:[],currentUser:null,currentUserId:null,currentUserUsername:""}),actions:{selectChat(t){this.selectedChat=this.chats.find(e=>e.id===t),this.fetchMessages(t)},async fetchMessages(t){const e=oo(),n=ff(e,`chats/${t}/messages`),r=FC(n,UC("createdAt"));KC(r,s=>{this.messages=s.docs.map(i=>({id:i.id,...i.data(),createdAt:i.data().createdAt.toDate()}))})},async sendMessage(t){if(!t.trim()||!this.selectedChat)return;const e=oo(),r=jr().currentUser;if(!r)throw new Error("No authenticated user found.");const s=xo(e,"users",r.uid),i=await _f(s),o=i.exists()?i.data().username:"Anonymous";await HC(ff(e,`chats/${this.selectedChat.id}/messages`),{text:t,createdAt:new Date,userId:r.uid,username:o})},initializeAuthState(){const t=jr();jl(t,e=>{if(e){this.currentUserId=e.uid;const n=xo(oo(),"users",e.uid);_f(n).then(r=>{r.exists()&&(this.currentUserUsername=r.data().username)})}else this.currentUserId=null,this.currentUserUsername=""})},canSendMessage(){return this.currentUserUsername!=="Anonymous"&&this.currentUserUsername!==""}}}),zC={id:"chat-layout"},GC={class:"left"},QC={class:"right"},YC={key:0},JC={__name:"ChatView",setup(t){const e=Bp(),n=jr(),r=WC();r.initializeAuthState(),jl(n,i=>{i?r.currentUser=i:r.currentUser=null});const s=async()=>{try{await fA(n),e.push("/login")}catch(i){console.error("Logout failed:",i)}};return sp(()=>{r.chats.length>0&&r.selectChat(r.chats[0].id)}),Sl(()=>{unsubscribe&&unsubscribe()}),(i,o)=>{var a;return Xe(),ut("div",zC,[Ae("div",GC,[it(U0,{chats:xe(r).chats,selectedChatId:(a=xe(r).selectedChat)==null?void 0:a.id,onSelectChat:xe(r).selectChat},null,8,["chats","selectedChatId","onSelectChat"]),Ae("button",{onClick:s},"Logout")]),Ae("div",QC,[xe(r).selectedChat&&xe(r).currentUser?(Xe(),ut("h2",YC,Zt(xe(r).currentUser.email)+" | "+Zt(xe(r).selectedChat.name)+" Channel ",1)):Ar("",!0),it(D0,{messages:xe(r).messages,currentUserId:xe(r).currentUserId,onSendMessage:xe(r).sendMessage,canSendMessage:xe(r).canSendMessage()},null,8,["messages","currentUserId","onSendMessage","canSendMessage"])])])}}},XC=ia(JC,[["__scopeId","data-v-352bd76f"]]);var ZC="firebase",eb="10.7.2";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */bn(ZC,eb,"app");const tb={apiKey:"AIzaSyBIl-7WJ3mpH-ki6AcahjdSQpQSzp3G2RQ",authDomain:"chat-app-vue-9ca58.firebaseapp.com",projectId:"chat-app-vue-9ca58",storageBucket:"chat-app-vue-9ca58.appspot.com",messagingSenderId:"787531609366",appId:"1:787531609366:web:fc31d70b02c3cd25cdcc37"},sy=Yp(tb),nb=Pp("user",{state:()=>({email:"",password:"",username:"",isSignUp:!1,isGuest:!1}),actions:{updateEmail(t){this.email=t},updatePassword(t){this.password=t},updateUsername(t){this.username=t},toggleSignUp(){this.isSignUp=!this.isSignUp},async signInAsGuest(){const t=jr(sy);try{await vg(t),this.isGuest=!0}catch(e){console.error("Guest login error:",e),this.isGuest=!1}},setErrorMessage(t){this.errorMessage=t},clearErrorMessage(){this.errorMessage=""}}});function yf(t){switch(t){case"auth/invalid-email":return"The email address is invalid.";case"auth/user-disabled":return"This user has been disabled.";case"auth/user-not-found":return"User not found. Please sign up.";case"auth/wrong-password":return"Incorrect password. Please try again.";case"auth/invalid-credential":return"Invalid credential. Please try again.";default:return"An unexpected error occurred. Please try again later."}}const rb={name:"LoginView",setup(){const t=Bp(),e=jr(sy),n=nb();return{handleSubmit:async()=>{try{if(n.isSignUp){const i=await lA(e,n.email,n.password),o=xo(oo(),"users",i.user.uid);await qC(o,{username:n.username})}else await uA(e,n.email,n.password);t.push("/chat")}catch(i){console.error("Authentication error:",i);const o=yf(i.code);n.setErrorMessage(o)}},handleGuestLogin:async()=>{try{await vg(e),t.push("/chat")}catch(i){console.error("Guest login error:",i);const o=yf(i.code);n.setErrorMessage(o)}},userStore:n}}},sb=t=>(Tl("data-v-51a9112c"),t=t(),Al(),t),ib={id:"login"},ob=sb(()=>Ae("h1",{class:"title"},"WELCOME TO CHAT APP",-1)),ab={key:0},cb={key:1,class:"error-message"},lb={key:2,type:"submit"},ub={key:3,type:"submit"};function hb(t,e,n,r,s,i){return Xe(),ut("div",ib,[ob,Ae("form",{class:"form",onSubmit:e[5]||(e[5]=wp((...o)=>r.handleSubmit&&r.handleSubmit(...o),["prevent"]))},[r.userStore.isSignUp?(Xe(),ut("div",ab,[Gi(Ae("input",{placeholder:"username",type:"text",id:"username","onUpdate:modelValue":e[0]||(e[0]=o=>r.userStore.username=o),required:""},null,512),[[Xi,r.userStore.username]])])):Ar("",!0),Ae("div",null,[Gi(Ae("input",{placeholder:"email",type:"email",id:"email","onUpdate:modelValue":e[1]||(e[1]=o=>r.userStore.email=o),required:""},null,512),[[Xi,r.userStore.email]])]),Ae("div",null,[Gi(Ae("input",{placeholder:"password",type:"password",id:"password","onUpdate:modelValue":e[2]||(e[2]=o=>r.userStore.password=o),required:""},null,512),[[Xi,r.userStore.password]])]),r.userStore.errorMessage?(Xe(),ut("div",cb,Zt(r.userStore.errorMessage),1)):Ar("",!0),r.userStore.isSignUp?Ar("",!0):(Xe(),ut("button",lb,"Login")),r.userStore.isSignUp?(Xe(),ut("button",ub,"Sign Up")):Ar("",!0),Ae("button",{onClick:e[3]||(e[3]=(...o)=>r.userStore.toggleSignUp&&r.userStore.toggleSignUp(...o))},Zt(r.userStore.isSignUp?"Already have an account? Login":"Need an account? Sign Up"),1),Ae("button",{onClick:e[4]||(e[4]=(...o)=>r.handleGuestLogin&&r.handleGuestLogin(...o))},"Login as Guest")],32)])}const db=ia(rb,[["render",hb],["__scopeId","data-v-51a9112c"]]),fb=[{path:"/chat",name:"chat",component:XC,meta:{requiresAuth:!0}},{path:"/login",name:"login",component:db},{path:"/",redirect:"/login"}],iy=VI({history:YE("/chat-app/"),routes:fb});iy.beforeEach((t,e,n)=>{const r=t.matched.some(i=>i.meta.requiresAuth),s=jr();jl(s,i=>{r&&!i?n("/login"):!r&&i?n("/chat"):n()})});const Ku=TE(MI);Ku.use(PE());Ku.use(iy);Ku.mount("#app");
